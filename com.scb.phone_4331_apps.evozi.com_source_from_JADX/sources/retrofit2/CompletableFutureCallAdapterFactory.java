...
final class CompletableFutureCallAdapterFactory extends CallAdapter.Factory {
    ...
    static final class BodyCallAdapter<R> implements CallAdapter<R, CompletableFuture<R>> {
        ...
        public final CompletableFuture<R> adapt(final Call<R> call) {
            final C75681 r0 = new CompletableFuture<R>() {
    ...
    static final class ResponseCallAdapter<R> implements CallAdapter<R, CompletableFuture<Response<R>>> {
        ...
        public final CompletableFuture<Response<R>> adapt(final Call<R> call) {
            final C75701 r0 = new CompletableFuture<Response<R>>() {
                public boolean cancel(boolean z) {
                    if (z) {
                        call.cancel();
                    }
