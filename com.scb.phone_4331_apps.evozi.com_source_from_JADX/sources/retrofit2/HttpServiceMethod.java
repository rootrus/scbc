...
abstract class HttpServiceMethod<ResponseT, ReturnT> extends ServiceMethod<ReturnT> {
    ...
    static final class CallAdapted<ResponseT, ReturnT> extends HttpServiceMethod<ResponseT, ReturnT> {
        ...
        public final ReturnT adapt(retrofit2.Call<ResponseT> r1, java.lang.Object[] r2) {
            /*
                r0 = this;
    ...
    static final class SuspendForResponse<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
        ...
        public final Object adapt(Call<ResponseT> call, Object[] objArr) {
            ...
            HmlNTBPromptPayNotFoundActivity hmlNTBPromptPayNotFoundActivity = objArr[objArr.length - 1];
            try {
                return KotlinExtensions.awaitResponse(call2, hmlNTBPromptPayNotFoundActivity);
            } catch (Exception e) {
                return KotlinExtensions.yieldAndThrow(e, hmlNTBPromptPayNotFoundActivity);
            }
        }
    }
    ...
    static final class SuspendForBody<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
        ...
        public final Object adapt(Call<ResponseT> call, Object[] objArr) {
            ...
            try {
                if (this.isNullable) {
                    return KotlinExtensions.awaitNullable(call2, hmlNTBPromptPayNotFoundActivity);
                }
                return KotlinExtensions.await(call2, hmlNTBPromptPayNotFoundActivity);
            } catch (Exception e) {
                return KotlinExtensions.yieldAndThrow(e, hmlNTBPromptPayNotFoundActivity);
            }
        }
