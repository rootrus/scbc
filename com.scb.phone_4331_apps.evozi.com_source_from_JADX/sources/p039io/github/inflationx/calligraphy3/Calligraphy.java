...
class Calligraphy {
    ...
    protected static boolean isActionBarTitle(TextView textView) {
        ...
        if (parentIsToolbarV7(textView)) {
            return TextUtils.equals(((Toolbar) textView.getParent()).Keep, textView.getText());
        }
        return false;
    }
    ...
    protected static boolean isActionBarSubTitle(TextView textView) {
        ...
        if (parentIsToolbarV7(textView)) {
            return TextUtils.equals(((Toolbar) textView.getParent()).MediaSessionCompat$QueueItem, textView.getText());
        }
        return false;
    }
    ...
    public View onViewCreated(View view, Context context, AttributeSet attributeSet) {
        if (!(view == null || view.getTag(C6301R.C6302id.calligraphy_tag_id) == Boolean.TRUE)) {
            onViewCreatedInternal(view, context, attributeSet);
            view.setTag(C6301R.C6302id.calligraphy_tag_id, Boolean.TRUE);
        }
        return view;
    }
    ...
    static class ToolbarLayoutListener implements ViewTreeObserver.OnGlobalLayoutListener {
        static String BLANK = " ";
        ...
        private ToolbarLayoutListener(Calligraphy calligraphy, Context context, Toolbar toolbar) {
            ...
            this.originalSubTitle = toolbar.MediaSessionCompat$QueueItem;
