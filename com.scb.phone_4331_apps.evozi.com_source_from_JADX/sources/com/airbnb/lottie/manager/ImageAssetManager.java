        ...
        if (!fileName.startsWith("data:") || fileName.indexOf("base64,") <= 0) {
            try {
                if (!TextUtils.isEmpty(this.imagesFolder)) {
                    ...
                    sb.append(this.imagesFolder);
                    sb.append(fileName);
                    return putBitmap(str, Utils.resizeBitmapIfNeeded(BitmapFactory.decodeStream(assets.open(sb.toString()), (Rect) null, options), lottieImageAsset.getWidth(), lottieImageAsset.getHeight()));
                }
