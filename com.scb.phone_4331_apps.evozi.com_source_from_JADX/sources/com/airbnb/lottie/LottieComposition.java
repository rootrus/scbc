...
public class LottieComposition {
    private Rect bounds;
    private setButtonDrawable<FontCharacter> characters;
    private float endFrame;
    private Map<String, Font> fonts;
    private float frameRate;
    private boolean hasDashPattern;
    private Map<String, LottieImageAsset> images;
    private setAutoSizeTextTypeWithDefaults<Layer> layerMap;
    ...
    public void init(Rect rect, float f, float f2, float f3, List<Layer> list, setAutoSizeTextTypeWithDefaults<Layer> setautosizetexttypewithdefaults, Map<String, List<Layer>> map, Map<String, LottieImageAsset> map2, setButtonDrawable<FontCharacter> setbuttondrawable, Map<String, Font> map3, List<Marker> list2) {
        this.bounds = rect;
        this.startFrame = f;
        this.endFrame = f2;
        this.frameRate = f3;
        this.layers = list;
        this.layerMap = setautosizetexttypewithdefaults;
        this.precomps = map;
        this.images = map2;
        this.characters = setbuttondrawable;
        this.fonts = map3;
        this.markers = list2;
    }
    ...
    public Layer layerModelForId(long j) {
        return this.layerMap.MediaBrowserCompat$ItemReceiver(j, null);
    }
    ...
    public setButtonDrawable<FontCharacter> getCharacters() {
