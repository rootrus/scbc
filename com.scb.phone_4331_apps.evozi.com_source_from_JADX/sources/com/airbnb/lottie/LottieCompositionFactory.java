...
public class LottieCompositionFactory {
    ...
    public static LottieResult<LottieComposition> fromAssetSync(Context context, String str) {
        try {
            ...
            if (str.endsWith(".zip")) {
                return fromZipStreamSync(new ZipInputStream(context.getAssets().open(str)), obj);
            }
            return fromJsonInputStreamSync(context.getAssets().open(str), obj);
        } catch (IOException e) {
    ...
    private static LottieResult<LottieComposition> fromJsonInputStreamSync(InputStream inputStream, String str, boolean z) {
        try {
            return fromJsonReaderSync(JsonReader.m32of(onSubmit.read(onSubmit.IconCompatParcelizer(inputStream))), str);
        } finally {
            if (z) {
    ...
    public static LottieResult<LottieComposition> fromJsonStringSync(String str, String str2) {
        return fromJsonReaderSync(JsonReader.m32of(onSubmit.read(onSubmit.IconCompatParcelizer((InputStream) new ByteArrayInputStream(str.getBytes())))), str2);
    }
        ...
        try {
            ...
            while (nextEntry != null) {
                ...
                if (name.contains("__MACOSX")) {
                    ...
                    lottieComposition = fromJsonReaderSyncInternal(JsonReader.m32of(onSubmit.read(onSubmit.IconCompatParcelizer((InputStream) zipInputStream))), (String) null, false).getValue();
                } else {
            ...
            for (Map.Entry next : lottieComposition.getImages().entrySet()) {
                if (((LottieImageAsset) next.getValue()).getBitmap() == null) {
                    ...
                    sb.append(((LottieImageAsset) next.getValue()).getFileName());
