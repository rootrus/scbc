...
public abstract class BaseKeyframeAnimation<K, A> {
    ...
    public Keyframe<K> getCurrentKeyframe() {
        C0088L.beginSection("BaseKeyframeAnimation#getCurrentKeyframe");
        ...
        if (keyframe == null || !keyframe.containsProgress(this.progress)) {
            ...
            C0088L.endSection("BaseKeyframeAnimation#getCurrentKeyframe");
            return keyframe2;
        }
        C0088L.endSection("BaseKeyframeAnimation#getCurrentKeyframe");
    ...
    private float getStartDelayProgress() {
        if (this.cachedStartDelayProgress == -1.0f) {
            this.cachedStartDelayProgress = this.keyframes.isEmpty() ? BitmapDescriptorFactory.HUE_RED : ((Keyframe) this.keyframes.get(0)).getStartProgress();
        }
