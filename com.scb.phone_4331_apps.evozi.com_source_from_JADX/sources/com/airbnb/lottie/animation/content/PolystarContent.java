...
public class PolystarContent implements PathContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public Path getPath() {
        ...
        int i = C01271.$SwitchMap$com$airbnb$lottie$model$content$PolystarShape$Type[this.type.ordinal()];
        if (i == 1) {
            createStarPath();
        } else if (i == 2) {
            createPolygonPath();
    ...
    static /* synthetic */ class C01271 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.animation.content.PolystarContent.C01271.<clinit>():void");
        }
    }
    ...
    private void createPolygonPath() {
        ...
        while (((double) i2) < ceil) {
            ...
            if (floatValue != BitmapDescriptorFactory.HUE_RED) {
                ...
                this.path.cubicTo(cos - (cos3 * f), sin - (((float) Math.sin(atan2)) * f), cos2 + (cos4 * f), sin2 + (f * ((float) Math.sin(atan22))), cos2, sin2);
            } else {
                i = i2;
                d2 = d7;
                d3 = d5;
