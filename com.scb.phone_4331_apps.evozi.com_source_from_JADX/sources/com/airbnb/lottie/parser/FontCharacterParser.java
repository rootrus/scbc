...
class FontCharacterParser {
    private static final JsonReader.Options DATA_NAMES = JsonReader.Options.m33of("shapes");
    private static final JsonReader.Options NAMES = JsonReader.Options.m33of("ch", "size", "w", "style", "fFamily", "data");
