...
public class LayerParser {
    private static final JsonReader.Options EFFECTS_NAMES = JsonReader.Options.m33of("nm");
    private static final JsonReader.Options NAMES = JsonReader.Options.m33of("nm", "ind", "refId", "ty", "parent", "sw", "sh", "sc", "ks", "tt", "masksProperties", "shapes", "t", "ef", "sr", "st", "w", "h", "ip", "op", "tm", "cl", "hd");
    private static final JsonReader.Options TEXT_NAMES = JsonReader.Options.m33of(KtaJsonExactionHelper.OBJECT, "a");
    ...
    public static Layer parse(LottieComposition lottieComposition) {
        ...
        AnimatableTransform animatableTransform = r0;
        AnimatableTransform animatableTransform2 = new AnimatableTransform();
        return new Layer(emptyList, lottieComposition, "__container", -1, layerType, -1, (String) null, emptyList2, animatableTransform, 0, 0, 0, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, bounds.width(), bounds.height(), (AnimatableTextFrame) null, (AnimatableTextProperties) null, Collections.emptyList(), Layer.MatteType.NONE, (AnimatableFloatValue) null, false);
    }
    ...
    public static Layer parse(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
        ...
        if (f6 > BitmapDescriptorFactory.HUE_RED) {
            ...
            Keyframe keyframe2 = new Keyframe(lottieComposition, valueOf2, valueOf2, (Interpolator) null, BitmapDescriptorFactory.HUE_RED, Float.valueOf(f6));
        ...
        return new Layer(arrayList4, lottieComposition, str, j2, layerType, j, str2, arrayList, animatableTransform, i, i2, i3, f2, f5, i4, i5, animatableTextFrame, animatableTextProperties, arrayList2, matteType2, animatableFloatValue, z);
    }
}
