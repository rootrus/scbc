...
public class XVrsPhaseDetector {
    ...
    private native XVrsImage nativeGetImage();
    ...
    static {
        if (!nativeStaticInitializer()) {
            throw new RuntimeException("com.kofax.android.abc.xvrs.Detection.XVrsPhaseDetector: Static initializer failed.");
        }
    }
