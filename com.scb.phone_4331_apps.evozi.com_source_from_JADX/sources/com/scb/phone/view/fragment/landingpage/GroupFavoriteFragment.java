...
import p040o.ActivityBuilder_ContributeDebitCardPayOtpActivity;
import p040o.ActivityBuilder_ContributeDebitCardRequestInputActivity;
import p040o.ActivityBuilder_ContributeDirectDebitInputActivity;
import p040o.AlertController$RecycleListView;
import p040o.BulkTransferDeepLinkActivity;
import p040o.C3973aJ;
import p040o.HmlPinActivity;
import p040o.MyECouponActivity_ViewBinding;
import p040o.confirmDebitCard;
import p040o.debitCardTransaction;
...
import p040o.getDate;
import p040o.getNextTransition;
import p040o.getProductCatalog;
import p040o.getTargetFragment;
...
public class GroupFavoriteFragment extends BaseDragAndDropFragment implements getDate {
    ...
    private discardOldLogFiles$MediaBrowserCompat$ItemReceiver RatingCompat;
    @HmlPinActivity
    public C3973aJ groupFavoritePresenter;
    @BindView
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.f87722131493999, viewGroup, false);
        ButterKnife.IconCompatParcelizer(this, inflate);
        this.MediaDescriptionCompat = setChildDrawingOrderCallback.IconCompatParcelizer(getContext(), new IntentFilter("com.scb.phone/BROADCAST_ADD_TILE_TO_CHILD")).subscribe(new ActivityBuilder_ContributeDebitCardPayOtpActivity(this), ActivityBuilder_ContributeDirectDebitInputActivity.MediaBrowserCompat$CustomActionResultReceiver);
        this.MediaMetadataCompat = setChildDrawingOrderCallback.IconCompatParcelizer(getActivity(), new IntentFilter("com.scb.phone/BROADCAST_SHOW_QUICK_OPERATION_SNACK_BAR")).subscribe(new ActivityBuilder_ContributeDebitCardRequestInputActivity(this), ActivityBuilder_ContributeDirectDebitInputActivity.MediaBrowserCompat$CustomActionResultReceiver);
        ...
        this.RatingCompat = discardoldlogfiles_mediabrowsercompat_itemreceiver;
        if (discardoldlogfiles_mediabrowsercompat_itemreceiver == null) {
            getActivity().finish();
        }
        String IconCompatParcelizer = forEachDstOut.IconCompatParcelizer((int) this.RatingCompat.setBackgroundResource);
        if (IconCompatParcelizer != null) {
            ((BaseActivity) getActivity()).mo13676d_(IconCompatParcelizer);
        }
        super.setTransitioning();
        setActionBarVisibilityCallback();
        ActionBarContextView();
        ParcelableVolumeInfo(this.RatingCompat.ListMenuItemView);
        MediaBrowserCompat$ItemReceiver(this.mRecyclerView, this.mRemoveTileLayout, (TileAdapter$MediaBrowserCompat$MediaItem) null);
        C3973aJ aJVar = this.groupFavoritePresenter;
        aJVar.MediaBrowserCompat$ItemReceiver(this);
        aJVar.read = this;
        this.groupFavoritePresenter.MediaBrowserCompat$ItemReceiver(this.RatingCompat.setBackgroundResource);
        return inflate;
    }
    ...
    public void onDestroy() {
        ...
        this.groupFavoritePresenter.onDestroy();
        super.onDestroy();
    }
    ...
    public final void IconCompatParcelizer(boolean z) {
        Resources resources;
        int i;
        this.mTrashImageView.setColorFilter(setLastBaselineToBottomHeight.read(getContext(), z ? R.color.f66452131099801 : R.color.f71012131100257), PorterDuff.Mode.SRC_ATOP);
        ...
        textView.setTextSize(2, ((float) resources.getDimensionPixelSize(i)) / getResources().getDisplayMetrics().density);
    }

    public final void read(long j) {
        this.groupFavoritePresenter.MediaBrowserCompat$CustomActionResultReceiver(j);
    }
    ...
    public final void MediaBrowserCompat$CustomActionResultReceiver(long j) {
        this.groupFavoritePresenter.read(j);
    }

    public final void MediaBrowserCompat$ItemReceiver(long j, long j2) {
        this.groupFavoritePresenter.IconCompatParcelizer(j, j2);
    }
    ...
    public final void AppCompatDelegateImpl$ListMenuDecorView() {
        ...
        this.mEmptyTextView.setText(String.format(getString(R.string.empty_favorite), new Object[]{this.RatingCompat.ListMenuItemView}));
    }

    public final void IconCompatParcelizer(long j) {
        isSupportFragmentClass issupportfragmentclass;
        TileAdapter tileAdapter = this.MediaBrowserCompat$MediaItem;
        List list = (List) new show(tileAdapter.MediaDescriptionCompat).read(new confirmDebitCard(j)).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        int write = (int) (new show(show.write, new getTargetFragment(show.IconCompatParcelizer, getProductCatalog.read)).write() % 3);
        show show2 = new show(tileAdapter.MediaDescriptionCompat);
        show show3 = new show(show2.write, new getNextTransition(show2.IconCompatParcelizer, debitCardTransaction.MediaBrowserCompat$CustomActionResultReceiver));
        ...
        if (issupportfragmentclass.IconCompatParcelizer != null) {
            ...
            if (t != null) {
                ((discardOldLogFiles$MediaBrowserCompat$ItemReceiver) t).setPadding = 3 - write;
            } else {
                throw new NoSuchElementException("No value present");
            }
        }
        tileAdapter.MediaBrowserCompat$ItemReceiver((List<discardOldLogFiles$MediaBrowserCompat$ItemReceiver>) list);
        if (this.MediaBrowserCompat$MediaItem.IconCompatParcelizer() == 2) {
            AppCompatDelegateImpl$ListMenuDecorView();
        }
    }

    public static /* synthetic */ void write(GroupFavoriteFragment groupFavoriteFragment) {
        groupFavoriteFragment.MediaBrowserCompat$ItemReceiver(groupFavoriteFragment.mRecyclerView, groupFavoriteFragment.mRemoveTileLayout, (TileAdapter$MediaBrowserCompat$MediaItem) null);
        groupFavoriteFragment.groupFavoritePresenter.MediaBrowserCompat$ItemReceiver(groupFavoriteFragment.RatingCompat.setBackgroundResource);
    }

    public static /* synthetic */ void read(GroupFavoriteFragment groupFavoriteFragment, Intent intent) {
        ...
        if (booleanExtra && groupFavoriteFragment.getActivity() != null) {
            AlertController$RecycleListView.read(groupFavoriteFragment.getActivity(), R.id.view_group_root, booleanExtra2 ? R.drawable.ic_check_circle_white_24dp : R.drawable.ic_error_white_24dp, intent.getStringExtra("com.scb.phone.EXTRA_MESSAGE"), R.color.f71012131100257, booleanExtra2 ? R.color.f67402131099896 : R.color.f66062131099761, AlertController$RecycleListView.IconCompatParcelizer((Context) groupFavoriteFragment.getActivity()));
        }
    }
}
