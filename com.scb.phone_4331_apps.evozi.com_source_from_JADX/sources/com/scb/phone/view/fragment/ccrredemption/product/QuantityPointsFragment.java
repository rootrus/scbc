...
import p040o.getGenericSupertype;
import p040o.isEagerInDefaultApp;
import p040o.lambda$intoSet$2;
import p040o.setLastBaselineToBottomHeight;
import p040o.setTapText;

public class QuantityPointsFragment extends BaseFragment implements IdCaptureActivity_MembersInjector, getEkycRegistration {
    @BindView
    ...
    @HmlPinActivity
    public getGenericSupertype presenter;
    @BindView
    ...
    public static Fragment IconCompatParcelizer() {
        return new QuantityPointsFragment();
    }

    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.f89182131494145, viewGroup, false);
