...
import p040o.ActivityBuilder_ContributePrepaidTravelConversionLandingActivity;
import p040o.ActivityBuilder_ContributePrepaidTravelConversionSuccessActivity;
...
public class BaseRequestToPayFragment extends BaseFragment {
    protected MenuItem IconCompatParcelizer;
    protected List<ImmutableSortedMap.Builder> MediaBrowserCompat$CustomActionResultReceiver = new ArrayList();
    protected ArrayAdapter<ImmutableSortedMap.Builder> MediaDescriptionCompat;
    @BindView
    View container;
    @BindView
    ...
    protected static List<ImmutableSortedMap.Builder> read(ImmutableSortedMap.Builder builder) {
        ArrayList arrayList = new ArrayList();
        arrayList.add(builder);
        return arrayList;
    }

    public static /* synthetic */ ImmutableSortedMap.Builder MediaBrowserCompat$ItemReceiver(setSymbol setsymbol) {
        return new ImmutableSortedMap.Builder(setsymbol.write, setsymbol.MediaBrowserCompat$ItemReceiver);
    }

    public static /* synthetic */ ImmutableSortedMap.Builder MediaBrowserCompat$CustomActionResultReceiver(setSymbol setsymbol) {
        return new ImmutableSortedMap.Builder(setsymbol.read.MediaBrowserCompat$ItemReceiver, setsymbol.MediaBrowserCompat$ItemReceiver);
    }

    protected static List<ImmutableSortedMap.Builder> MediaBrowserCompat$ItemReceiver(List<setSymbol> list) {
        show show = new show(list);
        return (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, ActivityBuilder_ContributePrepaidTravelConversionSuccessActivity.MediaBrowserCompat$ItemReceiver)).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
    ...
    protected static List<ImmutableSortedMap.Builder> IconCompatParcelizer(List<setSymbol> list) {
        show show = new show(list);
        return (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, ActivityBuilder_ContributePrepaidTravelConversionLandingActivity.MediaBrowserCompat$ItemReceiver)).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
            /*  JADX ERROR: Method generation error
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: o.setupDialog.1.read():java.lang.Object, class status: UNLOADED
                	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
