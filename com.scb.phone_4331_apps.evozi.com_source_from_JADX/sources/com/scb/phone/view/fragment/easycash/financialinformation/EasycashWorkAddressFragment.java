...
public class EasycashWorkAddressFragment extends BaseBreadcrumbAddressFragment {
    ...
    public static EasycashWorkAddressFragment MediaBrowserCompat$ItemReceiver(AutoValue_CrashlyticsReport_CustomAttribute autoValue_CrashlyticsReport_CustomAttribute) {
        ...
        EasycashWorkAddressFragment easycashWorkAddressFragment = new EasycashWorkAddressFragment();
        easycashWorkAddressFragment.setArguments(bundle);
        return easycashWorkAddressFragment;
    }
    ...
    public void onNextClick() {
        ...
        this.MediaBrowserCompat$CustomActionResultReceiver.read(animatecamera);
    }

    public final String PlaybackStateCompat() {
        return getString(R.string.work_address_toolbar);
    }
