...
import p040o.RecognitionContext;
...
/* renamed from: com.scb.phone.view.fragment.easycash.issuer.EasycashIssuerSearchFragment$IconCompatParcelizer$MediaBrowserCompat$CustomActionResultReceiver */
class C5932x6d7fe24d extends AsyncTask<String, Void, List<convertMemInfoToBytes>> {
    private /* synthetic */ EasycashIssuerSearchFragment.IconCompatParcelizer MediaBrowserCompat$CustomActionResultReceiver;

    private C5932x6d7fe24d(EasycashIssuerSearchFragment.IconCompatParcelizer iconCompatParcelizer) {
        this.MediaBrowserCompat$CustomActionResultReceiver = iconCompatParcelizer;
    }

    /* synthetic */ C5932x6d7fe24d(EasycashIssuerSearchFragment.IconCompatParcelizer iconCompatParcelizer, byte b) {
    ...
    public final /* synthetic */ Object doInBackground(Object[] objArr) {
        ...
        BarCodeDirection barCodeDirection = EasycashIssuerSearchFragment.this.searchPresenter;
        if (str == null || str.length() == 0) {
            z = true;
        }
        if (z) {
            return barCodeDirection.IconCompatParcelizer;
        }
        show show = new show(barCodeDirection.IconCompatParcelizer);
        return (List) new show(show.write, new getNextTransition(show.IconCompatParcelizer, new RecognitionContext(str))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
    ...
    public final /* synthetic */ void onPostExecute(Object obj) {
        ...
        if (list == null || list.isEmpty()) {
            EasycashIssuerSearchFragment.this.MediaBrowserCompat$ItemReceiver();
            return;
        }
        EasycashIssuerSearchFragment.this.emptyContainer.setVisibility(8);
        EasycashIssuerSearchFragment.this.IconCompatParcelizer((List<convertMemInfoToBytes>) list);
    }
}
