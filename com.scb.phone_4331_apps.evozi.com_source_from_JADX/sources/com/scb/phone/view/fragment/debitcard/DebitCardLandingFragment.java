...
import p040o.FragmentBuilder_BindCurrentCycleInfoFragmentt;
import p040o.GoogleSigninService;
import p040o.HmlPinActivity;
import p040o.ensureAnimationInfo;
import p040o.getArguments;
import p040o.getMHMCDetail;
import p040o.getRows;
import p040o.getSharedElementEnterTransition;
import p040o.nativeGetTable;
import p040o.postCarCollateralDetail;
import p040o.proxyGetIIdDeserializerRtti;
import p040o.setupDialog;
import p040o.show;

public class DebitCardLandingFragment extends BaseFragment implements proxyGetIIdDeserializerRtti {
    @HmlPinActivity
    public FragmentBuilder_BindCurrentCycleInfoFragmentt mapper;
    @HmlPinActivity
    public getRows presenter;
    @BindView
    RecyclerView recyclerView;

    public static DebitCardLandingFragment MediaBrowserCompat$ItemReceiver() {
        return new DebitCardLandingFragment();
    }

    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.f86432131493870, viewGroup, false);
        ButterKnife.IconCompatParcelizer(this, inflate);
        this.presenter.MediaBrowserCompat$ItemReceiver(this);
        getRows getrows = this.presenter;
        nativeGetTable nativegettable = new nativeGetTable(getrows);
        if (getrows.RatingCompat != null) {
            nativegettable.IconCompatParcelizer(getrows.RatingCompat);
        }
    ...
    public final void IconCompatParcelizer() {
        DebitCardMarketConductActivity.write(getContext());
    }

    public final void read() {
        DebitCardActivationActivity.MediaBrowserCompat$ItemReceiver(getContext());
    }

    public final void MediaBrowserCompat$ItemReceiver(List<Integer> list) {
        show show = new show(list);
        this.recyclerView.setAdapter(new SelectionAdapter((List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new postCarCollateralDetail(this))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
