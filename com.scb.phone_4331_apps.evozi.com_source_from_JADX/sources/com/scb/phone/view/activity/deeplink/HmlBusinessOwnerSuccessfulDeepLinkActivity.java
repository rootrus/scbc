...
public final class HmlBusinessOwnerSuccessfulDeepLinkActivity extends HmlBaseDeepLinkActivity implements PassportCaptureModule_GetIParametersFactory {
    @HmlPinActivity
    ...
    public final void IconCompatParcelizer(Intent intent, String str) {
        ...
        if (str != null) {
            ...
            kofaxWebServiceResponseBase.MediaBrowserCompat$CustomActionResultReceiver(str, true);
        }
    }
