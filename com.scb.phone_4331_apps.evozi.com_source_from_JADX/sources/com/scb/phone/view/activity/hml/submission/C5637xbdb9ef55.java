...
/* renamed from: com.scb.phone.view.activity.hml.submission.HmlNTBDocumentSubmissionTutorialsActivity$MediaBrowserCompat$CustomActionResultReceiver */
public final class C5637xbdb9ef55 {
    private C5637xbdb9ef55() {
    }

    public /* synthetic */ C5637xbdb9ef55(byte b) {
        this();
    }

    public static Intent MediaBrowserCompat$ItemReceiver(Context context, String str, String str2, String str3, String str4) {
        Intent intent = new Intent(context, HmlNTBDocumentSubmissionTutorialsActivity.class);
