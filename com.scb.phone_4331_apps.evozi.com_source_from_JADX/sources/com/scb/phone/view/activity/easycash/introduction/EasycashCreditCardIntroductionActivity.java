...
public class EasycashCreditCardIntroductionActivity extends EasycashBaseIntroductionActivity implements CaptureData {
    @HmlPinActivity
    ...
    public static Intent read(Context context, getLegacySharedPrefs getlegacysharedprefs, Onboarding.C37171 r4) {
        Intent intent = new Intent(context, EasycashCreditCardIntroductionActivity.class);
    ...
    public void onCreate(Bundle bundle) {
        ...
        setTitle(R.string.easycash_introduction_credit_card_title);
    }
    ...
    public final void mo14347x50fd9e4a() {
        ...
        this.presenter.write("CREDIT_CARD", MediaSessionCompat$QueueItem());
    }
