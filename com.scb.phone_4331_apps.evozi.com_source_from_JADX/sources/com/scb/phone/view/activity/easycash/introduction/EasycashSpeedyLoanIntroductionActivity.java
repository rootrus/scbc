...
public class EasycashSpeedyLoanIntroductionActivity extends EasycashBaseIntroductionActivity implements RttiIdExtractor_Factory {
    @HmlPinActivity
    ...
    public static Intent write(Context context, getLegacySharedPrefs getlegacysharedprefs, Onboarding.C37171 r4) {
        Intent intent = new Intent(context, EasycashSpeedyLoanIntroductionActivity.class);
    ...
    public void onCreate(Bundle bundle) {
        ...
        setTitle(R.string.easycash_introduction_speedy_loan_title);
    }
    ...
    public final void mo14347x50fd9e4a() {
        ...
        this.presenter.write("SPEEDY_LOAN", MediaSessionCompat$QueueItem());
    }
