...
public final class WebImage extends AbstractSafeParcelable {
    ...
    public WebImage(JSONObject jSONObject) throws IllegalArgumentException {
        this(zaa(jSONObject), jSONObject.optInt(RttiJsonExactionHelper.WIDTH, 0), jSONObject.optInt(RttiJsonExactionHelper.HEIGHT, 0));
    }
    ...
    public final JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.put(RttiJsonExactionHelper.WIDTH, this.zanj);
            jSONObject.put(RttiJsonExactionHelper.HEIGHT, this.zank);
        } catch (JSONException unused) {
        }
        return jSONObject;
    }
