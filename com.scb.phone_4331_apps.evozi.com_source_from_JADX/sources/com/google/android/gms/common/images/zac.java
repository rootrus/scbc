...
public final class zac extends zab {
    ...
    public final boolean equals(Object obj) {
        ...
        zac zac = (zac) obj;
        ImageManager.OnImageLoadedListener onImageLoadedListener = (ImageManager.OnImageLoadedListener) this.zang.get();
        ImageManager.OnImageLoadedListener onImageLoadedListener2 = (ImageManager.OnImageLoadedListener) zac.zang.get();
    ...
    public final void zaa(Drawable drawable, boolean z, boolean z2, boolean z3) {
        ...
        if (!z2 && (onImageLoadedListener = (ImageManager.OnImageLoadedListener) this.zang.get()) != null) {
