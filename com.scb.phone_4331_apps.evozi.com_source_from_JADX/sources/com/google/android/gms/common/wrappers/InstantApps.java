...
public class InstantApps {
    ...
    public static boolean isInstantApp(android.content.Context r3) {
        /*
            ...
            android.content.Context r2 = zzim     // Catch:{ all -> 0x004f }
            if (r2 == 0) goto L_0x001b
            java.lang.Boolean r2 = zzin     // Catch:{ all -> 0x004f }
            if (r2 == 0) goto L_0x001b
            android.content.Context r2 = zzim     // Catch:{ all -> 0x004f }
            if (r2 != r1) goto L_0x001b
            java.lang.Boolean r3 = zzin     // Catch:{ all -> 0x004f }
            boolean r3 = r3.booleanValue()     // Catch:{ all -> 0x004f }
            monitor-exit(r0)
            return r3
        L_0x001b:
            r2 = 0
            zzin = r2     // Catch:{ all -> 0x004f }
        ...
        L_0x0033:
            ...
            zzin = r3     // Catch:{ ClassNotFoundException -> 0x0041 }
            goto L_0x0045
        L_0x0041:
            java.lang.Boolean r3 = java.lang.Boolean.FALSE     // Catch:{ all -> 0x004f }
            zzin = r3     // Catch:{ all -> 0x004f }
        L_0x0045:
            zzim = r1     // Catch:{ all -> 0x004f }
            java.lang.Boolean r3 = zzin     // Catch:{ all -> 0x004f }
            boolean r3 = r3.booleanValue()     // Catch:{ all -> 0x004f }
            monitor-exit(r0)
            return r3
