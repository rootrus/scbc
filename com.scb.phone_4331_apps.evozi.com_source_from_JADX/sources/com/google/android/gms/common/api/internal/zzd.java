...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    private Map<String, LifecycleCallback> zzbr = new setTextAppearance();
    ...
    public static zzd zza(FragmentActivity fragmentActivity) {
        ...
        try {
            ...
            if (zzd2 == null || zzd2.isRemoving()) {
                zzd2 = new zzd();
                fragmentActivity.getSupportFragmentManager().read().read(zzd2, "SupportLifecycleFragmentImpl").IconCompatParcelizer();
            }
