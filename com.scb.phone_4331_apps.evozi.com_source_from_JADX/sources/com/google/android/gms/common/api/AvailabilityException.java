...
public class AvailabilityException extends Exception {
    private final setTextAppearance<ApiKey<?>, ConnectionResult> zaba;

    public AvailabilityException(setTextAppearance<ApiKey<?>, ConnectionResult> settextappearance) {
        this.zaba = settextappearance;
    }
    ...
    public final setTextAppearance<ApiKey<?>, ConnectionResult> zaj() {
        return this.zaba;
    }
