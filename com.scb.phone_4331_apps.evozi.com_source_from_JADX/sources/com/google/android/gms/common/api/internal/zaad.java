...
public class zaad extends zak {
    ...
    private final setAutoSizeTextTypeUniformWithConfiguration<ApiKey<?>> zafs = new setAutoSizeTextTypeUniformWithConfiguration<>();
    ...
    public final setAutoSizeTextTypeUniformWithConfiguration<ApiKey<?>> zaah() {
        return this.zafs;
    }
