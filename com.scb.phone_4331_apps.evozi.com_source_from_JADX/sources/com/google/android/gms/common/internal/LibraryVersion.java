    ...
    public String getVersion(String str) {
        ...
        try {
            ...
            if (resourceAsStream != null) {
                ...
                gmsLogger2.mo4183w("LibraryVersion", valueOf.length() != 0 ? "Failed to get app version for libraryName: ".concat(valueOf) : new String("Failed to get app version for libraryName: "));
            }
        } catch (IOException e) {
        ...
        if (str2 == null) {
            zzfc.mo4172d("LibraryVersion", ".properties file is dropped during release process. Failure to read app version isexpected druing Google internal testing where locally-built libraries are used");
            str2 = "UNKNOWN";
        }
