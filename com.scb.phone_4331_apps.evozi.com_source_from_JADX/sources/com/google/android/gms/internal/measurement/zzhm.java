...
interface zzhm {
    ...
    <T> T zza(zzhp<T> zzhp, zzfb zzfb) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzhp<T> zzhp, zzfb zzfb) throws IOException;

    <K, V> void zza(Map<K, V> map, zzgr<K, V> zzgr, zzfb zzfb) throws IOException;

    int zzb();

    @Deprecated
    <T> T zzb(zzhp<T> zzhp, zzfb zzfb) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzhp<T> zzhp, zzfb zzfb) throws IOException;
