...
abstract class zzfn<T extends zzfb> {
    ...
    static <T extends zzfb> T zza(Class<T> cls) {
        String str;
        Class<zzfn> cls2 = zzfn.class;
        ...
        try {
            return (zzfb) cls.cast(((zzfn) Class.forName(str, true, classLoader).getConstructor(new Class[0]).newInstance(new Object[0])).zza());
