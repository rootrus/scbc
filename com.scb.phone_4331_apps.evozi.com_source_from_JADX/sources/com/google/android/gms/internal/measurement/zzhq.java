...
class zzhq<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    private final int zza;
    /* access modifiers changed from: private */
    public List<zzhz> zzb;
    /* access modifiers changed from: private */
    public Map<K, V> zzc;
    private boolean zzd;
    ...
    static <FieldDescriptorType extends zzfg<FieldDescriptorType>> zzhq<FieldDescriptorType, Object> zza(int i) {
        return new zzht(i);
    }
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.zze == null) {
            this.zze = new zzib(this, (zzht) null);
        }
        return this.zze;
    }
    ...
    public final Set<Map.Entry<K, V>> zze() {
        if (this.zzg == null) {
            this.zzg = new zzhv(this, (zzht) null);
        }
        return this.zzg;
    }
    ...
    public boolean equals(Object obj) {
        ...
        int zzc2 = zzc();
        if (zzc2 != zzhq.zzc()) {
            return entrySet().equals(zzhq.entrySet());
        }
        for (int i = 0; i < zzc2; i++) {
            if (!zzb(i).equals(zzhq.zzb(i))) {
                return false;
            }
        }
        if (zzc2 != size) {
            return this.zzc.equals(zzhq.zzc);
        }
        return true;
    }
    ...
    /* synthetic */ zzhq(int i, zzht zzht) {
        this(i);
    }
}
