...
interface zzja {
    ...
    void zza(int i, zzeg zzeg) throws IOException;

    <K, V> void zza(int i, zzgr<K, V> zzgr, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzhp zzhp) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzhp zzhp) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzhp zzhp) throws IOException;

    void zzb(int i, List<zzeg> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzhp zzhp) throws IOException;
