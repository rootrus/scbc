...
final class zzed extends zzec {
    ...
    public final int zzc(int r18, byte[] r19, int r20, int r21) {
        ...
        L_0x0052:
            ...
            byte r2 = com.google.android.gms.internal.places.zzdy.zzb(r0, r7)
        ...
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (r13 < i3) {
                ...
                if (zzdz.zze(zzb2)) {
                    ...
                    i5++;
                    while (r13 < i3) {
                        byte zzb3 = zzdy.zzb(bArr, (long) r13);
                        if (!zzdz.zze(zzb3)) {
                            break;
                        }
                        r13++;
                        zzdz.zzb(zzb3, cArr, i5);
                        i5++;
                    }
                } else {
                    if (zzdz.zzf(zzb2)) {
                        ...
                        if (i6 < i3 - 1) {
                            int i7 = i6 + 1;
                            zzdz.zzb(zzb2, zzdy.zzb(bArr, (long) i6), zzdy.zzb(bArr, (long) i7), cArr, i5);
                            r13 = i7 + 1;
                        } else {
                            throw zzbk.zzbu();
                        }
                        ...
                        int i8 = i6 + 1;
                        int i9 = i8 + 1;
                        zzdz.zzb(zzb2, zzdy.zzb(bArr, (long) i6), zzdy.zzb(bArr, (long) i8), zzdy.zzb(bArr, (long) i9), cArr, i5);
                        r13 = i9 + 1;
                        i5 = i5 + 1 + 1;
                    } else {
                        throw zzbk.zzbu();
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final int zzc(java.lang.CharSequence r20, byte[] r21, int r22, int r23) {
        /*
            r19 = this;
            r0 = r20
            r1 = r21
        ...
        L_0x004b:
            ...
            byte r11 = (byte) r11
            com.google.android.gms.internal.places.zzdy.zzb((byte[]) r1, (long) r4, (byte) r11)
            r4 = r13 & 63
            r4 = r4 | r3
            byte r4 = (byte) r4
            com.google.android.gms.internal.places.zzdy.zzb((byte[]) r1, (long) r14, (byte) r4)
            r4 = 1
            long r14 = r14 + r4
            r11 = r3
            r12 = r14
        ...
        L_0x0079:
            ...
            r5 = r5 | r14
            byte r5 = (byte) r5
            com.google.android.gms.internal.places.zzdy.zzb((byte[]) r1, (long) r11, (byte) r5)
            r5 = r13 & 63
            r5 = r5 | r14
            byte r5 = (byte) r5
