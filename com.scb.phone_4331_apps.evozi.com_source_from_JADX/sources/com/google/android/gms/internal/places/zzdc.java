...
final class zzdc {
    ...
    static int zze(List<Long> list) {
        ...
        if (list instanceof zzby) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzaj.zzf(list.get(i3).longValue());
            }
        }
        return i;
    }
    ...
    static int zzf(List<Long> list) {
        ...
        if (list instanceof zzby) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzaj.zzg(list.get(i3).longValue());
            }
        }
        return i;
    }
    ...
    static int zzg(List<Long> list) {
        ...
        if (list instanceof zzby) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzaj.zzh(list.get(i3).longValue());
            }
        }
        return i;
    }
    ...
    static int zzh(List<Integer> list) {
        ...
        if (list instanceof zzbe) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzaj.zzx(list.get(i3).intValue());
            }
        }
        return i;
    }
    ...
    static int zzi(List<Integer> list) {
        ...
        if (list instanceof zzbe) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzaj.zzs(list.get(i3).intValue());
            }
        }
        return i;
    }
    ...
    static int zzj(List<Integer> list) {
        ...
        if (list instanceof zzbe) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzaj.zzt(list.get(i3).intValue());
            }
        }
        return i;
    }
    ...
    static int zzk(List<Integer> list) {
        ...
        if (list instanceof zzbe) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzaj.zzu(list.get(i3).intValue());
            }
        }
        return i;
    }
