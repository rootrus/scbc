...
public abstract class zzbc<MessageType extends zzbc<MessageType, BuilderType>, BuilderType extends zzb<MessageType, BuilderType>> extends zzm<MessageType, BuilderType> {
    ...
    public static final class zzd<T extends zzbc<T, ?>> extends zzn<T> {
    ...
    public static final class zzf<ContainingType extends zzck, Type> extends zzan<ContainingType, Type> {
    }
    ...
    public static class zzb<MessageType extends zzbc<MessageType, BuilderType>, BuilderType extends zzb<MessageType, BuilderType>> extends zzo<MessageType, BuilderType> {
