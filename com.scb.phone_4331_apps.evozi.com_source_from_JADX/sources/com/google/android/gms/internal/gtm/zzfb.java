...
import com.google.android.gms.tagmanager.impl.C7599R;
...
public final class zzfb {
    ...
    public final void zzkq() {
        try {
            ...
            String string = this.zzaoo.getResources().getString(C7599R.string.tagmanager_preview_dialog_title);
            String string2 = this.zzaoo.getResources().getString(C7599R.string.tagmanager_preview_dialog_message);
            String string3 = this.zzaoo.getResources().getString(C7599R.string.tagmanager_preview_dialog_button);
