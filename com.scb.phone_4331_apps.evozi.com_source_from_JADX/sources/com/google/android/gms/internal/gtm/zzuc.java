            ...
            while (r13 < i3) {
                ...
                if (zzua.zzd(b2)) {
                    ...
                    if (zzua.zze(b2)) {
                        ...
                        if (i6 < i3 - 1) {
                            int i7 = i6 + 1;
                            zzua.zza(b2, bArr[i6], bArr[i7], cArr, i5);
                            r13 = i7 + 1;
                        } else {
                            throw zzrk.zzpw();
                        }
                        ...
                        int i8 = i6 + 1;
                        int i9 = i8 + 1;
                        zzua.zza(b2, bArr[i6], bArr[i8], bArr[i9], cArr, i5);
                        r13 = i9 + 1;
                        i5 = i5 + 1 + 1;
                    } else {
                        throw zzrk.zzpw();
    ...
    public final int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i7 < length) {
            ...
            if (charAt2 < 128 && i8 < i6) {
                ...
                int i10 = i8 + 1;
                bArr[i8] = (byte) ((charAt2 >>> 12) | C0608h.f1447Az);
                int i11 = i10 + 1;
