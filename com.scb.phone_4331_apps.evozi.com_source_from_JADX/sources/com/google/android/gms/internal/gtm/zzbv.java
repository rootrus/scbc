...
public final class zzbv extends zzan {
    ...
    private final AlarmManager zzyx = ((AlarmManager) getContext().getSystemService("alarm"));
    ...
    public final void zzfd() {
        ...
        if (zzeq > 0) {
            cancel();
            long elapsedRealtime = zzcn().elapsedRealtime();
            this.zzyw = true;
            ...
            this.zzyx.setInexactRepeating(2, elapsedRealtime + zzeq, zzeq, zzfe());
        }
    }
