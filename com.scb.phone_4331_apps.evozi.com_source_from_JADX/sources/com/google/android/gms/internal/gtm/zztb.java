...
final class zztb {
    ...
    static int zzw(List<Long> list) {
        ...
        if (list instanceof zzry) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzqj.zzs(list.get(i3).longValue());
            }
        }
        return i;
    }
    ...
    static int zzx(List<Long> list) {
        ...
        if (list instanceof zzry) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzqj.zzt(list.get(i3).longValue());
            }
        }
        return i;
    }
    ...
    static int zzy(List<Long> list) {
        ...
        if (list instanceof zzry) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzqj.zzu(list.get(i3).longValue());
            }
        }
        return i;
    }
    ...
    static int zzz(List<Integer> list) {
        ...
        if (list instanceof zzrd) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzqj.zzbh(list.get(i3).intValue());
            }
        }
        return i;
    }
    ...
    static int zzaa(List<Integer> list) {
        ...
        if (list instanceof zzrd) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzqj.zzbc(list.get(i3).intValue());
            }
        }
        return i;
    }
    ...
    static int zzab(List<Integer> list) {
        ...
        if (list instanceof zzrd) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzqj.zzbd(list.get(i3).intValue());
            }
        }
        return i;
    }
    ...
    static int zzac(List<Integer> list) {
        ...
        if (list instanceof zzrd) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzqj.zzbe(list.get(i3).intValue());
            }
        }
        return i;
    }
