...
final class zzay extends zzan implements Closeable {
    ...
    private final List<Long> zzc(long j) {
        ...
        try {
            ...
            String str = "hits2";
            Cursor query = sQLiteDatabase.query(str, new String[]{"hit_id"}, (String) null, (String[]) null, (String) null, (String) null, String.format("%s ASC", new Object[]{"hit_id"}), Long.toString(j));
