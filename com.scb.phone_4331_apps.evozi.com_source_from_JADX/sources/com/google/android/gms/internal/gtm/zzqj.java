...
public abstract class zzqj extends zzpr {
    ...
    static final class zze extends zzqj {
        ...
        zze(ByteBuffer byteBuffer) {
            ...
            this.zzawz = zzb;
            this.zzaxa = zzb + ((long) byteBuffer.position());
            long limit = this.zzawz + ((long) byteBuffer.limit());
            this.zzaxb = limit;
            this.zzaxc = limit - 10;
        }
        ...
        public final void zzc(byte b) throws IOException {
            ...
            throw new zzc(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(j), Long.valueOf(this.zzaxb), 1}));
        }
        ...
        public final void zzay(int i) throws IOException {
            ...
            while (true) {
                long j3 = this.zzaxd;
                if (j3 >= this.zzaxb) {
                    throw new zzc(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(j3), Long.valueOf(this.zzaxb), 1}));
                } else if ((i & -128) == 0) {
                    this.zzaxd = 1 + j3;
                    zztx.zza(j3, (byte) i);
                    return;
        ...
        public final void zzp(long j) throws IOException {
            ...
            while (true) {
                long j4 = this.zzaxd;
                if (j4 >= this.zzaxb) {
                    throw new zzc(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(j4), Long.valueOf(this.zzaxb), 1}));
                } else if ((j & -128) == 0) {
                    this.zzaxd = 1 + j4;
