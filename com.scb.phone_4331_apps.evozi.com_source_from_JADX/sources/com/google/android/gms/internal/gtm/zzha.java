...
public final class zzha {
    ...
    public static double zzc(zzoa<?> zzoa) {
        ...
        return (i == 0 || i == 0 || Double.isInfinite(zzb)) ? zzb : Math.signum(zzb) * Math.floor(Math.abs(zzb));
    }
    ...
    public static boolean zzb(zzoa<?> zzoa, zzoa<?> zzoa2) {
        ...
        if (zzf(zzoa)) {
            ...
            double zzb = zzb(zzoa);
            double zzb2 = zzb(zzoa2);
            if (Double.isNaN(zzb) || Double.isNaN(zzb2) || ((zzb == 0.0d && zzb2 == 0.0d) || ((i == 0 && zzb2 == 0.0d) || zzb == Double.POSITIVE_INFINITY))) {
                return false;
            }
            ...
            if (zzf(zzoa)) {
                ...
                if (zze.equals(zze2)) {
                    ...
                    if (c == 2) {
                        ...
                        return c != 4 ? c == 5 && zzoa == zzoa2 : ((Boolean) ((zzod) zzoa).value()) == ((Boolean) ((zzod) zzoa2).value());
                    } else {
    ...
    public static boolean zzd(zzoa<?> zzoa, zzoa<?> zzoa2) {
        ...
        if (zzf(zzoa)) {
            ...
            if (c != 2) {
                return c != 3 ? c != 4 ? zzoa == zzoa2 : ((Boolean) ((zzod) zzoa).value()) == ((Boolean) ((zzod) zzoa2).value()) : ((String) ((zzom) zzoa).value()).equals((String) ((zzom) zzoa2).value());
            }
            double doubleValue = ((Double) ((zzoe) zzoa).value()).doubleValue();
            double doubleValue2 = ((Double) ((zzoe) zzoa2).value()).doubleValue();
            return !Double.isNaN(doubleValue) && !Double.isNaN(doubleValue2) && doubleValue == doubleValue2;
