...
final class zzeh {
    ...
    static int zza(List<Long> list) {
        ...
        if (list instanceof zzdc) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzbn.zze(list.get(i3).longValue());
            }
        }
        return i;
    }
    ...
    static int zzb(List<Long> list) {
        ...
        if (list instanceof zzdc) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzbn.zzf(list.get(i3).longValue());
            }
        }
        return i;
    }
    ...
    static int zzc(List<Long> list) {
        ...
        if (list instanceof zzdc) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzbn.zzg(list.get(i3).longValue());
            }
        }
        return i;
    }
    ...
    static int zzd(List<Integer> list) {
        ...
        if (list instanceof zzch) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzbn.zzx(list.get(i3).intValue());
            }
        }
        return i;
    }
    ...
    static int zze(List<Integer> list) {
        ...
        if (list instanceof zzch) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzbn.zzs(list.get(i3).intValue());
            }
        }
        return i;
    }
    ...
    static int zzf(List<Integer> list) {
        ...
        if (list instanceof zzch) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzbn.zzt(list.get(i3).intValue());
            }
        }
        return i;
    }
    ...
    static int zzg(List<Integer> list) {
        ...
        if (list instanceof zzch) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                i += zzbn.zzu(list.get(i3).intValue());
            }
        }
        return i;
    }
