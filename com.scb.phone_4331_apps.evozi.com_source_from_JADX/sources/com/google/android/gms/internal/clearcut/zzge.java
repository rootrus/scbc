...
public final class zzge {
    ...
    public static final class zza extends zzcg<zza, C10794zza> implements zzdq {
        ...
        public static final class C10794zza extends zzcg.zza<zza, C10794zza> implements zzdq {
            private C10794zza() {
                super(zza.zzsm);
            }

            /* synthetic */ C10794zza(zzgf zzgf) {
                this();
            }
        }
        ...
        public final Object zza(int i, Object obj, Object obj2) {
            ...
            switch (zzgf.zzba[i - 1]) {
                case 1:
                    return new zza();
                case 2:
                    return new C10794zza((zzgf) null);
                case 3:
    ...
    public static final class zzq extends zzcg.zzd<zzq, zza> implements zzdq {
        ...
        public enum zzb implements zzcj {
            ...
            ANDROID_SNET_IDLE(EACTags.SECURITY_ENVIRONMENT_TEMPLATE),
            ANDROID_SNET_JAR(EACTags.DYNAMIC_AUTHENTIFICATION_TEMPLATE),
            CONTEXT_MANAGER(125),
            CLASSROOM(126),
            TAILORMADE(127),
            KEEP(128),
            ...
            ADWORDS_MOBILE(133),
            ADWORDS_MOBILE_ANDROID_PRIMES(PassportService.DEFAULT_MAX_BLOCKSIZE),
            ...
            SLIDES_ANDROID_PRIMES(CipherSuite.TLS_PSK_WITH_AES_128_GCM_SHA256),
            ...
            INBOX_ANDROID_PRIMES(CipherSuite.TLS_DHE_PSK_WITH_NULL_SHA256),
            ...
            PANCETTA_MOBILE_HOST(CipherSuite.TLS_PSK_WITH_RC4_128_SHA),
            PANCETTA_MOBILE_HOST_COUNTERS(CipherSuite.TLS_PSK_WITH_3DES_EDE_CBC_SHA),
            ...
            UNICORN_FAMILY_MANAGEMENT(CipherSuite.TLS_RSA_PSK_WITH_AES_128_GCM_SHA256),
            ...
            SIDELOADED_MUSIC(TitleChanger.DEFAULT_ANIMATION_DELAY),
            ...
            PIGEON_EXPERIMENTAL(C0608h.f1447Az),
            ...
            public static zzb zzax(int i) {
                switch (i) {
                    ...
                    case TitleChanger.DEFAULT_ANIMATION_DELAY:
