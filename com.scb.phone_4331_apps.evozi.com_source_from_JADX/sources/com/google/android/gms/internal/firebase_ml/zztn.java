...
final class zztn implements zzxr {
    ...
    public final <K, V> void zza(int i, zzvh<K, V> zzvh, Map<K, V> map) throws IOException {
        for (Map.Entry next : map.entrySet()) {
            this.zzbkr.zzg(i, 2);
            this.zzbkr.zzcr(zzvg.zza(zzvh, next.getKey(), next.getValue()));
            zzvg.zza(this.zzbkr, zzvh, next.getKey(), next.getValue());
        }
    }
}
