...
final class zzxj extends zzxg {
    ...
    public final int zzb(int r18, byte[] r19, int r20, int r21) {
        ...
        L_0x001e:
            ...
            byte r3 = com.google.android.gms.internal.firebase_ml.zzxc.zza(r0, r11)
        ...
        L_0x0030:
            ...
            long r2 = r7 + r9
            byte r7 = com.google.android.gms.internal.firebase_ml.zzxc.zza(r0, r7)
        ...
        L_0x0052:
            ...
            byte r2 = com.google.android.gms.internal.firebase_ml.zzxc.zza(r0, r7)
        ...
        L_0x0083:
            long r7 = r13 + r9
            byte r2 = com.google.android.gms.internal.firebase_ml.zzxc.zza(r0, r13)
        ...
        L_0x0093:
            int r1 = r1 + -3
            long r13 = r7 + r9
            byte r3 = com.google.android.gms.internal.firebase_ml.zzxc.zza(r0, r7)
            ...
            long r2 = r13 + r9
            byte r7 = com.google.android.gms.internal.firebase_ml.zzxc.zza(r0, r13)
            if (r7 > r11) goto L_0x00b6
            long r7 = r2 + r9
            byte r2 = com.google.android.gms.internal.firebase_ml.zzxc.zza(r0, r2)
            if (r2 <= r11) goto L_0x002f
        L_0x00b6:
            return r12
        L_0x00b7:
    ...
    public final String zzh(byte[] bArr, int i, int i2) throws zzuo {
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            int i4 = 0;
            while (r13 < i3) {
                byte zza = zzxc.zza(bArr, (long) r13);
                if (!zzxf.zze(zza)) {
                    break;
                }
                i = r13 + 1;
                zzxf.zza(zza, cArr, i4);
                i4++;
            }
            int i5 = i4;
            while (r13 < i3) {
                int i6 = r13 + 1;
                byte zza2 = zzxc.zza(bArr, (long) r13);
                if (zzxf.zze(zza2)) {
                    zzxf.zza(zza2, cArr, i5);
                    r13 = i6;
                    i5++;
                    while (r13 < i3) {
                        byte zza3 = zzxc.zza(bArr, (long) r13);
                        if (!zzxf.zze(zza3)) {
                            break;
                        }
                        r13++;
                        zzxf.zza(zza3, cArr, i5);
                        i5++;
                    }
                } else {
                    if (zzxf.zzf(zza2)) {
                        if (i6 < i3) {
                            zzxf.zza(zza2, zzxc.zza(bArr, (long) i6), cArr, i5);
                            r13 = i6 + 1;
                        } else {
                            throw zzuo.zzrr();
                        }
                        ...
                        if (i6 < i3 - 1) {
                            int i7 = i6 + 1;
                            zzxf.zza(zza2, zzxc.zza(bArr, (long) i6), zzxc.zza(bArr, (long) i7), cArr, i5);
                            r13 = i7 + 1;
                        } else {
                            throw zzuo.zzrr();
                        }
                        ...
                        int i8 = i6 + 1;
                        int i9 = i8 + 1;
                        zzxf.zza(zza2, zzxc.zza(bArr, (long) i6), zzxc.zza(bArr, (long) i8), zzxc.zza(bArr, (long) i9), cArr, i5);
                        r13 = i9 + 1;
                        i5 = i5 + 1 + 1;
                    } else {
                        throw zzuo.zzrr();
    ...
    public final int zzb(java.lang.CharSequence r20, byte[] r21, int r22, int r23) {
        ...
        L_0x001a:
            ...
            byte r3 = (byte) r13
            com.google.android.gms.internal.firebase_ml.zzxc.zza((byte[]) r1, (long) r4, (byte) r3)
            int r2 = r2 + 1
            long r4 = r4 + r11
            goto L_0x001a
        L_0x002e:
        ...
        L_0x0032:
            ...
            byte r13 = (byte) r13
            com.google.android.gms.internal.firebase_ml.zzxc.zza((byte[]) r1, (long) r4, (byte) r13)
            long r4 = r4 + r11
            r17 = r11
            r11 = r3
            r12 = r4
        ...
        L_0x004b:
            ...
            byte r11 = (byte) r11
            com.google.android.gms.internal.firebase_ml.zzxc.zza((byte[]) r1, (long) r4, (byte) r11)
            r4 = r13 & 63
            r4 = r4 | r3
            byte r4 = (byte) r4
            com.google.android.gms.internal.firebase_ml.zzxc.zza((byte[]) r1, (long) r14, (byte) r4)
            r4 = 1
            long r14 = r14 + r4
            r11 = r3
            r12 = r14
        ...
        L_0x0079:
            ...
            r5 = r5 | r14
            byte r5 = (byte) r5
            com.google.android.gms.internal.firebase_ml.zzxc.zza((byte[]) r1, (long) r11, (byte) r5)
            r5 = r13 & 63
            r5 = r5 | r14
            byte r5 = (byte) r5
            com.google.android.gms.internal.firebase_ml.zzxc.zza((byte[]) r1, (long) r3, (byte) r5)
            r11 = 1
            long r3 = r3 + r11
            r17 = r11
        ...
        L_0x00aa:
            ...
            byte r15 = (byte) r15
            com.google.android.gms.internal.firebase_ml.zzxc.zza((byte[]) r1, (long) r4, (byte) r15)
            long r4 = r13 + r11
            int r15 = r2 >>> 12
            r15 = r15 & 63
            r11 = 128(0x80, float:1.794E-43)
            ...
            byte r12 = (byte) r12
            com.google.android.gms.internal.firebase_ml.zzxc.zza((byte[]) r1, (long) r13, (byte) r12)
            r12 = 1
            long r14 = r4 + r12
            int r16 = r2 >>> 6
            r12 = r16 & 63
            r12 = r12 | r11
            byte r12 = (byte) r12
            com.google.android.gms.internal.firebase_ml.zzxc.zza((byte[]) r1, (long) r4, (byte) r12)
            r4 = 1
            long r12 = r14 + r4
            r2 = r2 & 63
            r2 = r2 | r11
            byte r2 = (byte) r2
            com.google.android.gms.internal.firebase_ml.zzxc.zza((byte[]) r1, (long) r14, (byte) r2)
            r2 = r3
        L_0x00f7:
            int r2 = r2 + 1
            r3 = r11
        ...
        L_0x0101:
            r2 = r3
        L_0x0102:
            com.google.android.gms.internal.firebase_ml.zzxi r0 = new com.google.android.gms.internal.firebase_ml.zzxi
            int r2 = r2 + -1
            r0.<init>(r2, r8)
            throw r0
        L_0x010a:
