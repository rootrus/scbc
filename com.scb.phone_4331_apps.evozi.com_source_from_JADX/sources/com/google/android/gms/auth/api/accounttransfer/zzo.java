...
public class zzo extends zzaz {
    ...
    private static final setTextAppearance<String, FastJsonResponse.Field<?, ?>> zzbe;
    ...
    static {
        setTextAppearance<String, FastJsonResponse.Field<?, ?>> settextappearance = new setTextAppearance<>();
        zzbe = settextappearance;
        settextappearance.put("registered", FastJsonResponse.Field.forStrings("registered", 2));
