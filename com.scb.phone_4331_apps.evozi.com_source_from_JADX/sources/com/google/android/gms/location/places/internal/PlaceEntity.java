...
public final class PlaceEntity extends AbstractSafeParcelable implements ReflectedParcelable, Place {
    ...
    PlaceEntity(String str, List<Integer> list, String str2, String str3, String str4, List<String> list2, LatLng latLng2, float f, LatLngBounds latLngBounds, String str5, Uri uri, boolean z, float f2, int i, zzal zzal, zzai zzai, String str6) {
        ...
        this.zzf = str3;
        this.zzh = str4;
        this.zzcd = list2 == null ? Collections.emptyList() : list2;
        this.latLng = latLng2;
        this.zzbx = f;
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add(Name.MARK, this.zzbw).add("placeTypes", this.zzg).add("locale", this.locale).add("name", this.name).add("address", this.zzf).add("phoneNumber", this.zzh).add("latlng", this.latLng).add("viewport", this.zzby).add("websiteUri", this.zzi).add("isPermanentlyClosed", Boolean.valueOf(this.zzca)).add("priceLevel", Integer.valueOf(this.zzcc)).toString();
    }
