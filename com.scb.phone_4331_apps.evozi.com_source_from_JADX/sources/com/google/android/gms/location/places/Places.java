...
@Deprecated
public class Places {
    public static final Api<PlacesOptions> GEO_DATA_API = new Api<>("Places.GEO_DATA_API", new zzs(), zzaq);
    @Deprecated
    public static final GeoDataApi GeoDataApi = new zzh();
    public static final Api<PlacesOptions> PLACE_DETECTION_API = new Api<>("Places.PLACE_DETECTION_API", new zzaf(), zzar);
    @Deprecated
    public static final PlaceDetectionApi PlaceDetectionApi = new zzz();
    private static final Api.ClientKey<zzq> zzaq = new Api.ClientKey<>();
    private static final Api.ClientKey<zzae> zzar = new Api.ClientKey<>();
