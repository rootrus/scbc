...
public class AdvertisingIdClient {
    ...
    private final boolean zza(Info info, boolean z, float f, long j, String str, Throwable th) {
        ...
        String str2 = "0";
        hashMap.put("app_context", z ? DiskLruCache.VERSION_1 : str2);
        if (info != null) {
    ...
    public final void finish() {
        /*
            ...
            com.google.android.gms.common.BlockingServiceConnection r0 = r3.zze     // Catch:{ all -> 0x0032 }
            if (r0 == 0) goto L_0x0030
        ...
        L_0x0026:
            r0 = 0
            r3.zzg = r0     // Catch:{ all -> 0x0032 }
            r0 = 0
            r3.zzf = r0     // Catch:{ all -> 0x0032 }
            r3.zze = r0     // Catch:{ all -> 0x0032 }
