...
import p040o.setShowDividers;
import p040o.setTextAppearance;

public class FirebaseApp {
    static final Map<String, FirebaseApp> INSTANCES = new setTextAppearance();
    ...
    public static FirebaseApp initializeApp(Context context, FirebaseOptions firebaseOptions, String str) {
        ...
        synchronized (LOCK) {
            ...
            Preconditions.checkState(!INSTANCES.containsKey(normalize), sb.toString());
    ...
    protected FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        componentArr[0] = Component.m97of(context, Context.class, new Class[0]);
        componentArr[1] = Component.m97of(this, FirebaseApp.class, new Class[0]);
        componentArr[2] = Component.m97of(firebaseOptions, FirebaseOptions.class, new Class[0]);
    ...
    public void initializeAllApis() {
        if (!setShowDividers.read(this.applicationContext)) {
