...
public class CompositeCreateReportSpiCall implements CreateReportSpiCall {
    ...
    static /* synthetic */ class C78421 {
        ...
        static final /* synthetic */ int[] f3272xc221d5a6;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f3272xc221d5a6     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.crashlytics.internal.report.network.CompositeCreateReportSpiCall.C78421.<clinit>():void");
        }
    }

    public boolean invoke(CreateReportRequest createReportRequest, boolean z) {
        int i = C78421.f3272xc221d5a6[createReportRequest.report.getType().ordinal()];
        if (i == 1) {
