...
public final class zzt {
    ...
    public final String zze(String str) {
        return zza(String.valueOf(str).concat("_loc_key"));
    }

    public final Object[] zzf(String str) {
        JSONArray zzg = zzg(String.valueOf(str).concat("_loc_args"));
        if (zzg == null) {
            return null;
        }
    ...
    private final String zzb(Resources resources, String str, String str2) {
        ...
        if (identifier == 0) {
            String zzh = zzh(String.valueOf(str2).concat("_loc_key"));
    ...
    public static boolean zza(Bundle bundle) {
        return DiskLruCache.VERSION_1.equals(bundle.getString("gcm.n.e")) || DiskLruCache.VERSION_1.equals(bundle.getString(zzi("gcm.n.e")));
    }
