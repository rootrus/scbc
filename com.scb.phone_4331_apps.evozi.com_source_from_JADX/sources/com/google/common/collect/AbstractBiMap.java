...
abstract class AbstractBiMap<K, V> extends ForwardingMap<K, V> implements BiMap<K, V>, Serializable {
    ...
    private V putInBothMaps(K k, V v, boolean z) {
        ...
        if (z) {
            ...
            Object[] objArr = {v};
            Preconditions.checkArgument(!containsValue(v), "value already present: %s", objArr);
        }
    ...
    class KeySet extends ForwardingSet<K> {
        ...
        public Iterator<K> iterator() {
            final Iterator it = AbstractBiMap.this.delegate.entrySet().iterator();
    ...
    class ValueSet extends ForwardingSet<V> {
        ...
        public Iterator<V> iterator() {
            final Iterator it = AbstractBiMap.this.delegate.values().iterator();
    ...
    class EntrySet extends ForwardingSet<Map.Entry<K, V>> {
        ...
        public boolean remove(Object obj) {
            ...
            AbstractBiMap.this.inverse.delegate.remove(((Map.Entry) obj).getValue());
            return true;
        }
        ...
        public Iterator<Map.Entry<K, V>> iterator() {
            ...
            return new Iterator<Map.Entry<K, V>>() {
                ...
                public Map.Entry<K, V> next() {
                    final Map.Entry<K, V> entry2 = (Map.Entry) it.next();
                    this.entry = entry2;
                    return new ForwardingMapEntry<K, V>() {
                        ...
                        public V setValue(V v) {
                            ...
                            Object[] objArr = {v};
                            Preconditions.checkArgument(!AbstractBiMap.this.containsValue(v), "value already present: %s", objArr);
