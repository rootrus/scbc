...
public class CursorWindow extends android.database.CursorWindow implements Parcelable {
    ...
    public boolean putBlob(byte[] bArr, int i, int i2) {
        acquireReference();
        try {
            return putBlob_native(bArr, i - this.read, i2);
        } finally {
            releaseReference();
        }
    }
    ...
    public boolean putString(String str, int i, int i2) {
        acquireReference();
        try {
            return putString_native(str, i - this.read, i2);
        } finally {
            releaseReference();
        }
    }
    ...
    public boolean putLong(long j, int i, int i2) {
        acquireReference();
        try {
            return putLong_native(j, i - this.read, i2);
        } finally {
            releaseReference();
        }
    }
    ...
    public boolean putDouble(double d, int i, int i2) {
        acquireReference();
        try {
            return putDouble_native(d, i - this.read, i2);
        } finally {
            releaseReference();
        }
    }
    ...
    public boolean putNull(int i, int i2) {
        acquireReference();
        try {
            return putNull_native(i - this.read, i2);
        } finally {
            releaseReference();
        }
    }
    ...
    public boolean isNull(int i, int i2) {
        acquireReference();
        try {
            return isNull_native(i - this.read, i2);
        } finally {
            releaseReference();
        }
    }
    ...
    public byte[] getBlob(int i, int i2) {
        acquireReference();
        try {
            return getBlob_native(i - this.read, i2);
        } finally {
            releaseReference();
        }
    }
    ...
    public int getType(int i, int i2) {
        acquireReference();
        try {
            return getType_native(i - this.read, i2);
        } finally {
            releaseReference();
        }
    }
    ...
    public boolean isBlob(int i, int i2) {
        acquireReference();
        try {
            return isBlob_native(i - this.read, i2);
        } finally {
            releaseReference();
        }
    }
    ...
    public boolean isLong(int i, int i2) {
        acquireReference();
        try {
            return isInteger_native(i - this.read, i2);
        } finally {
            releaseReference();
        }
    }
    ...
    public boolean isFloat(int i, int i2) {
        acquireReference();
        try {
            return isFloat_native(i - this.read, i2);
        } finally {
            releaseReference();
        }
    }
    ...
    public boolean isString(int i, int i2) {
        acquireReference();
        try {
            return isString_native(i - this.read, i2);
        } finally {
            releaseReference();
        }
    }
    ...
    public String getString(int i, int i2) {
        acquireReference();
        try {
            return getString_native(i - this.read, i2);
        } finally {
            releaseReference();
        }
    }
    ...
    public void copyStringToBuffer(int i, int i2, CharArrayBuffer charArrayBuffer) {
        if (charArrayBuffer != null) {
            ...
            acquireReference();
            try {
                char[] copyStringToBuffer_native = copyStringToBuffer_native(i - this.read, i2, charArrayBuffer.data.length, charArrayBuffer);
    ...
    public long getLong(int i, int i2) {
        acquireReference();
        try {
            return getLong_native(i - this.read, i2);
        } finally {
            releaseReference();
        }
    }
    ...
    public double getDouble(int i, int i2) {
        acquireReference();
        try {
            return getDouble_native(i - this.read, i2);
        } finally {
            releaseReference();
        }
    }
    ...
    public short getShort(int i, int i2) {
        acquireReference();
        try {
            return (short) ((int) getLong_native(i - this.read, i2));
        } finally {
            releaseReference();
        }
    }
    ...
    public int getInt(int i, int i2) {
        acquireReference();
        try {
            return (int) getLong_native(i - this.read, i2);
        } finally {
            releaseReference();
        }
    }
    ...
    public float getFloat(int i, int i2) {
        acquireReference();
        try {
            return (float) getDouble_native(i - this.read, i2);
        } finally {
            releaseReference();
        }
    }
