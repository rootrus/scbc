...
public class ISO9796d2Signer implements SignerWithRecovery {
    ...
    public byte[] generateSignature() throws CryptoException {
        ...
        int i6 = ((((digestSize + i5) << 3) + i2) + 4) - this.keyBits;
        if (i6 > 0) {
            int i7 = i5 - ((i6 + 7) / 8);
            i3 = i - i7;
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (this.trailer == 188) {
            this.mBuf = new byte[((i - this.digest.getDigestSize()) - 2)];
        } else {
            this.mBuf = new byte[((i - this.digest.getDigestSize()) - 3)];
        }
        reset();
    }
        ...
        if (((processBlock[0] & ISO7816.INS_GET_RESPONSE) ^ 64) != 0) {
            ...
            if (length > 0) {
                if ((processBlock[0] & 32) == 0) {
                    ...
                    System.arraycopy(processBlock, i3, bArr3, 0, length);
                }
                this.preSig = bArr;
