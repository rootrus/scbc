...
public class PSSSigner implements Signer {
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (bitLength >= (this.hLen << 3) + (this.sLen << 3) + 9) {
    ...
    public boolean verifySignature(byte[] bArr) {
        ...
        try {
            ...
            bArr5[0] = (byte) (bArr5[0] & (255 >> ((bArr5.length << 3) - this.emBits)));
            int i3 = 0;
            while (true) {
                byte[] bArr6 = this.block;
                int length2 = bArr6.length;
                ...
                if (i3 != ((length2 - i4) - i5) - 2) {
                    ...
                    if (this.sSet) {
                        ...
                        System.arraycopy(bArr6, ((length3 - i5) - i4) - 1, bArr9, bArr9.length - i5, i5);
                    }
                    Digest digest2 = this.contentDigest;
