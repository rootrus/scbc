...
public class DESExample {
    ...
    /* renamed from: in */
    private BufferedInputStream f5934in;
    private byte[] key;
    ...
    public DESExample(java.lang.String r7, java.lang.String r8, java.lang.String r9, boolean r10) {
        /*
            ...
            r6.f5934in = r3     // Catch:{ FileNotFoundException -> 0x0020 }
            goto L_0x003c
        L_0x0020:
    ...
    private void performDecrypt(byte[] bArr) {
        ...
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(this.f5934in));
        byte[] bArr2 = null;
        while (true) {
            try {
    ...
    private void performEncrypt(byte[] bArr) {
        ...
        while (true) {
            try {
                int read = this.f5934in.read(bArr2, 0, 47);
                if (read > 0) {
