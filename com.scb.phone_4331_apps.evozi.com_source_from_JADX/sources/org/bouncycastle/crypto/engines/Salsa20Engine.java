...
public class Salsa20Engine implements SkippingStreamCipher {
    ...
    public static void salsaCore(int i, int[] iArr, int[] iArr2) {
        ...
        if (iArr3.length != 16) {
            ...
            while (i36 > 0) {
                ...
                int rotl21 = rotl(i24 + rotl12, 9) ^ rotl2;
                i26 = rotl5 ^ rotl(rotl21 + i24, 13);
                i25 = rotl12 ^ rotl(i26 + rotl21, 18);
    ...
    public void generateKeyStream(byte[] bArr) {
        salsaCore(this.rounds, this.engineState, this.f5916x);
        Pack.intToLittleEndian(this.f5916x, bArr, 0);
    }
    ...
    public long getPosition() {
        return (getCounter() << 6) + ((long) this.index);
    }
