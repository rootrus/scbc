...
public class Shacal2Engine implements BlockCipher {
    ...
    private void byteBlockToInts(byte[] bArr, int[] iArr, int i, int i2) {
        while (i2 < 8) {
            ...
            int i4 = i3 + 1;
            int i5 = i4 + 1;
            iArr[i2] = ((bArr[i] & 255) << Ascii.CAN) | ((bArr[i3] & 255) << 16) | ((bArr[i4] & 255) << 8) | (bArr[i5] & 255);
            i2++;
            i = i5 + 1;
        }
    }
    ...
    private void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i3 = 63; i3 >= 0; i3--) {
            ...
            iArr[6] = iArr[7];
            int i5 = f5921K[i3];
            iArr[7] = (((i4 - i5) - this.workingKey[i3]) - ((((iArr[4] >>> 6) | (iArr[4] << -6)) ^ ((iArr[4] >>> 11) | (iArr[4] << -11))) ^ ((iArr[4] >>> 25) | (iArr[4] << -25)))) - (((~iArr[4]) & iArr[6]) ^ (iArr[5] & iArr[4]));
        }
    ...
    private void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i3 = 0; i3 < 64; i3++) {
            int i4 = ((((iArr[4] >>> 6) | (iArr[4] << -6)) ^ ((iArr[4] >>> 11) | (iArr[4] << -11))) ^ ((iArr[4] >>> 25) | (iArr[4] << -25))) + ((iArr[4] & iArr[5]) ^ ((~iArr[4]) & iArr[6])) + iArr[7] + f5921K[i3] + this.workingKey[i3];
            iArr[7] = iArr[6];
            iArr[6] = iArr[5];
            iArr[5] = iArr[4];
            iArr[4] = iArr[3] + i4;
        ...
        if (bArr.length != 0 && bArr.length <= 64) {
            if (bArr.length >= 16 && bArr.length % 8 == 0) {
                ...
                for (int i = 16; i < 64; i++) {
                    ...
                    int i6 = iArr[i2];
                    int i7 = i - 15;
                    iArr[i] = ((iArr[i2] >>> 10) ^ (((i3 >>> 17) | (i4 << -17)) ^ ((i5 >>> 19) | (i6 << -19)))) + iArr[i - 7] + ((iArr[i7] >>> 3) ^ (((iArr[i7] >>> 7) | (iArr[i7] << -7)) ^ ((iArr[i7] >>> 18) | (iArr[i7] << -18)))) + iArr[i - 16];
                }
                return;
            }
        }
