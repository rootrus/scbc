...
public class CamelliaEngine implements BlockCipher {
    ...
    /* renamed from: ke */
    private int[] f5875ke = new int[12];

    /* renamed from: kw */
    private int[] f5876kw = new int[8];
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i) {
        ...
        int i4 = iArr4[(i2 >>> 8) & 255];
        int[] iArr5 = SBOX2_0222;
        int i5 = iArr5[(i2 >>> 16) & 255];
        int[] iArr6 = SBOX1_1110;
        int i6 = iArr6[i2 >>> 24] ^ ((i3 ^ i4) ^ i5);
        int i7 = iArr[1] ^ iArr2[i + 1];
        int i8 = iArr6[i7 & 255];
        int i9 = iArr3[(i7 >>> 8) & 255];
        int i10 = iArr4[(i7 >>> 16) & 255];
        int i11 = (((i9 ^ i8) ^ i10) ^ iArr5[i7 >>> 24]) ^ i6;
        iArr[2] = iArr[2] ^ i11;
        iArr[3] = (rightRotate(i6, 8) ^ i11) ^ iArr[3];
        int i12 = iArr[2] ^ iArr2[i + 2];
        int[] iArr7 = SBOX4_4404;
        int i13 = iArr7[i12 & 255];
        int[] iArr8 = SBOX3_3033;
        int i14 = iArr8[(i12 >>> 8) & 255];
        int[] iArr9 = SBOX2_0222;
        int i15 = iArr9[(i12 >>> 16) & 255];
        int[] iArr10 = SBOX1_1110;
        int i16 = iArr10[i12 >>> 24] ^ ((i13 ^ i14) ^ i15);
        int i17 = iArr2[i + 3] ^ iArr[3];
        int i18 = iArr10[i17 & 255];
        int i19 = iArr7[(i17 >>> 8) & 255];
        int i20 = iArr8[(i17 >>> 16) & 255];
        int i21 = (iArr9[i17 >>> 24] ^ ((i18 ^ i19) ^ i20)) ^ i16;
        iArr[0] = iArr[0] ^ i21;
        iArr[1] = (i21 ^ rightRotate(i16, 8)) ^ iArr[1];
    }
    ...
    private int processBlock192or256(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        camelliaF2(this.state, this.subkey, 28);
        camelliaF2(this.state, this.subkey, 32);
        camelliaFLs(this.state, this.f5875ke, 8);
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (this._keyIs128) {
            ...
            if (z) {
                ...
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                roldq(17, iArr, 0, this.f5875ke, 4);
                ...
                roldq(15, iArr2, 0, this.f5875ke, 0);
                ...
                roldq(17, iArr2, 0, this.f5876kw, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            ...
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f5875ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f5875ke, 4);
            ...
            roldq(17, iArr2, 0, this.f5876kw, 0);
            return;
        }
        for (int i3 = 0; i3 < 4; i3++) {
        ...
        if (z) {
            ...
            roldqo32(51, iArr3, 0, this.f5876kw, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        ...
        roldqo32(51, iArr3, 0, this.f5876kw, 0);
    }
