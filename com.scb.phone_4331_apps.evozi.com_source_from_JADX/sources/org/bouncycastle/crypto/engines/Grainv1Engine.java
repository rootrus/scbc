...
public class Grainv1Engine implements StreamCipher {
    ...
    private int getOutput() {
        ...
        int i20 = i18 & i19;
        int i21 = i16 & i18;
        return (((((((((i15 & i20) ^ ((i15 & (i17 & i18)) ^ ((i21 & i15) ^ ((i19 & i21) ^ (((i16 & i17) & i18) ^ ((((i17 ^ i15) ^ (i16 & i19)) ^ i20) ^ (i19 & i15))))))) ^ ((i >>> 1) | (i2 << 15))) ^ ((i3 >>> 2) | (i4 << 14))) ^ ((i5 >>> 4) | (i6 << 12))) ^ ((i7 >>> 10) | (i8 << 6))) ^ ((i9 >>> 15) | (i10 << 1))) ^ ((i11 >>> 11) | (i12 << 5))) ^ ((i13 >>> 8) | (i14 << 8))) & Settings.DEFAULT_INITIAL_WINDOW_SIZE;
    }
    ...
    private int getOutputLFSR() {
        ...
        int i8 = iArr[3];
        int i9 = iArr[4];
        return (((iArr[4] << 2) | (iArr[3] >>> 14)) ^ ((((((i2 >>> 13) | (i3 << 3)) ^ i) ^ ((i4 >>> 7) | (i5 << 9))) ^ ((i6 >>> 6) | (i7 << 10))) ^ ((i8 >>> 3) | (i9 << 13)))) & Settings.DEFAULT_INITIAL_WINDOW_SIZE;
    }
    ...
    private int getOutputNFSR() {
        ...
        int i17 = i12 & i11;
        int i18 = i8 & i7 & i6;
        return (((((((((i15 & i10) & i7) & i2) ^ ((((((i ^ (((((((((((i13 >>> 14) | (i14 << 2)) ^ i12) ^ i11) ^ i10) ^ i9) ^ i8) ^ i7) ^ i6) ^ ((i3 >>> 14) | (i4 << 2))) ^ i2)) ^ i16) ^ (i9 & i8)) ^ (i5 & i2)) ^ (i17 & i10)) ^ i18)) ^ ((i17 & i9) & i8)) ^ ((i16 & i6) & i5)) ^ (((i16 & i11) & i10) & i9)) ^ ((i5 & i18) & i2)) ^ (((((i11 & i10) & i9) & i8) & i7) & i6)) & Settings.DEFAULT_INITIAL_WINDOW_SIZE;
    }
