...
public class DSAParametersGenerator {
                ...
                if (isProbablePrime(bigInteger)) {
                    ...
                    while (i7 < 4096) {
                        for (int i8 = i6; i8 <= i3; i8++) {
                            inc(clone);
                            hash(this.digest, clone, bArr5, i4 - (i8 * 20));
                        }
                        int i9 = i4 - (i3 * 20);
                        inc(clone);
                        ...
                        if (subtract.bitLength() == this.f5939L && isProbablePrime(subtract)) {
    ...
    private org.bouncycastle.crypto.params.DSAParameters generateParameters_FIPS186_3() {
        ...
        L_0x00b9:
            ...
            java.security.SecureRandom r2 = r0.random
            java.math.BigInteger r2 = calculateGenerator_FIPS186_3_Unverifiable(r8, r9, r2)
            org.bouncycastle.crypto.params.DSAValidationParameters r4 = new org.bouncycastle.crypto.params.DSAValidationParameters
            r4.<init>(r3, r13)
            r1.<init>(r8, r9, r2, r4)
            return r1
    ...
    public void init(int i, int i2, SecureRandom secureRandom) {
        this.f5939L = i;
        this.f5940N = getDefaultN(i);
        this.certainty = i2;
        this.iterations = Math.max(getMinimumIterations(this.f5939L), (i2 + 1) / 2);
    ...
    public void init(DSAParameterGenerationParameters dSAParameterGenerationParameters) {
        ...
        } else if ((this.digest.getDigestSize() << 3) >= n) {
            this.f5939L = l;
            this.f5940N = n;
