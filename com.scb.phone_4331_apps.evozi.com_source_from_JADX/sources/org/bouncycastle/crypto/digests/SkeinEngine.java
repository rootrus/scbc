...
public class SkeinEngine implements Memoable {
    ...
    class UBI {
        ...
        private void processBlock(long[] jArr) {
            ...
            while (true) {
                ...
                jArr2[i] = ThreefishEngine.bytesToWord(this.currentBlock, i << 3);
                i++;
            }
    ...
    static {
        ...
        initialState(256, PassportService.DEFAULT_MAX_BLOCKSIZE, new long[]{-4176654842910610933L, -8688192972455077604L, -7364642305011795836L, 4056579644589979102L});
        ...
        initialState(512, PassportService.DEFAULT_MAX_BLOCKSIZE, new long[]{-3688341020067007964L, -3772225436291745297L, -8300862168937575580L, 4146387520469897396L, 1106145742801415120L, 7455425944880474941L, -7351063101234211863L, -7048981346965512457L});
    ...
    public SkeinEngine(SkeinEngine skeinEngine) {
        this(skeinEngine.getBlockSize() << 3, skeinEngine.getOutputSize() << 3);
        copyIn(skeinEngine);
    }
    ...
    private void createInitialState() {
        ...
        if (this.key != null || jArr == null) {
            ...
            ubiComplete(4, new Configuration((long) (this.outputSizeBytes << 3)).getBytes());
        } else {
