                        ...
                        if (receive < 0) {
                            ...
                            if (receive != readUint24 + 12) {
                                ...
                                if (readUint16 <= this.next_receive_seq + 10) {
                                    ...
                                    } else if (!(this.previousInboundFlight == null || (dTLSReassembler = (DTLSReassembler) this.previousInboundFlight.get(Integers.valueOf(readUint16))) == null)) {
