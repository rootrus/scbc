...
public class TlsAEADCipher implements TlsCipher {
    ...
    TlsAEADCipher(TlsContext tlsContext, AEADBlockCipher aEADBlockCipher, AEADBlockCipher aEADBlockCipher2, int i, int i2, int i3) throws IOException {
        ...
        if (TlsUtils.isTLSv12(tlsContext)) {
            ...
            KeyParameter keyParameter2 = new KeyParameter(calculateKeyBlock, i5, i5);
            int i9 = i5 + i5;
            int i10 = i9 + i4;
            byte[] copyOfRange = Arrays.copyOfRange(calculateKeyBlock, i9, i10);
            int i11 = i10 + i4;
            byte[] copyOfRange2 = Arrays.copyOfRange(calculateKeyBlock, i10, i11);
            if (i11 == i8) {
                ...
                int i12 = i6 << 3;
                this.encryptCipher.init(true, new AEADParameters(keyParameter, i12, bArr));
                this.decryptCipher.init(false, new AEADParameters(keyParameter2, i12, bArr));
                return;
            }
            throw new TlsFatalAlert(80);
        }
    ...
    public byte[] decodeCiphertext(long j, short s, byte[] bArr, int i, int i2) throws IOException {
        ...
        if (getPlaintextLimit(i4) >= 0) {
            ...
            try {
                this.decryptCipher.init(false, new AEADParameters((KeyParameter) null, this.macSize << 3, bArr3, getAdditionalData(j2, s, outputSize)));
                int processBytes = this.decryptCipher.processBytes(bArr, i3 + i8, i9, bArr6, 0);
    ...
    public byte[] encodePlaintext(long j, short s, byte[] bArr, int i, int i2) throws IOException {
        ...
        int i8 = this.record_iv_length;
        try {
            this.encryptCipher.init(true, new AEADParameters((KeyParameter) null, this.macSize << 3, bArr3, getAdditionalData(j, s, i3)));
