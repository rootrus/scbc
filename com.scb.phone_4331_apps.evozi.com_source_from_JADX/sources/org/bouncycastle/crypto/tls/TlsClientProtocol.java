...
public class TlsClientProtocol extends TlsProtocol {
    ...
    public void handleHandshakeMessage(short r10, byte[] r11) throws java.io.IOException {
        ...
        L_0x0030:
            ...
            r7 = 14
            r8 = 4
            if (r10 == r8) goto L_0x0221
            if (r10 == r2) goto L_0x01ff
            r1 = 22
            r2 = 5
        ...
        L_0x010a:
            ...
            r1.<init>(r11, r10)
            r9.sendCertificateVerifyMessage(r1)
            r10 = 12
            r9.connection_state = r10
        L_0x011a:
        ...
        L_0x0168:
            ...
            if (r10 == r7) goto L_0x017c
            if (r10 == r8) goto L_0x0183
            if (r10 != r2) goto L_0x0173
            goto L_0x0183
        L_0x0173:
            org.bouncycastle.crypto.tls.TlsFatalAlert r10 = new org.bouncycastle.crypto.tls.TlsFatalAlert
            r10.<init>(r6)
                ...
                if (Arrays.contains(this.offeredCompressionMethods, readUint8)) {
                    ...
                    if (this.serverExtensions != null) {
                        ...
                        while (keys.hasMoreElements()) {
                            ...
                            if (!num.equals(EXT_RenegotiationInfo) && TlsUtils.getExtensionData(this.clientExtensions, num) == null) {
    ...
    public void sendClientHelloMessage() throws IOException {
        ...
        if (!clientVersion.isDTLS()) {
            ...
            boolean contains = Arrays.contains(this.offeredCipherSuites, 255);
            if (z && (!contains)) {
