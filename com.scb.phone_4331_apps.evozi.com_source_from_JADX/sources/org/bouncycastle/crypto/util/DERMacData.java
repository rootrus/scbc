...
public final class DERMacData {
    ...
    static /* synthetic */ class C104481 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.crypto.util.DERMacData.C104481.<clinit>():void");
        }
    }
    ...
    public static final class Builder {
        ...
        public final DERMacData build() {
            int i = C104481.$SwitchMap$org$bouncycastle$crypto$util$DERMacData$Type[this.type.ordinal()];
            if (i == 1 || i == 2) {
                return new DERMacData(concatenate(this.type.getHeader(), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.ephemDataU), DerUtil.toByteArray(this.ephemDataV), this.text), (C104481) null);
            } else if (i == 3 || i == 4) {
                return new DERMacData(concatenate(this.type.getHeader(), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.ephemDataV), DerUtil.toByteArray(this.ephemDataU), this.text), (C104481) null);
            } else {
    ...
    /* synthetic */ DERMacData(byte[] bArr, C104481 r2) {
        this(bArr);
    }
