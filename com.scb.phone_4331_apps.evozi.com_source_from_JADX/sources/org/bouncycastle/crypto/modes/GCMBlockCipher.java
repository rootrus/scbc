...
public class GCMBlockCipher implements AEADBlockCipher {
    ...
    private void initCipher() {
        ...
        if (this.atLengthPre > 0) {
            System.arraycopy(this.S_atPre, 0, this.f5994S, 0, 16);
        }
    }
    ...
    private void reset(boolean z) {
        ...
        this.atLength = 0;
        this.atLengthPre = 0;
        this.counter = Arrays.clone(this.f5993J0);
    ...
    public int doFinal(byte[] bArr, int i) throws IllegalStateException, InvalidCipherTextException {
        ...
        if (j2 > this.atLengthPre) {
            ...
            if (this.exp == null) {
                ...
                tables1kGCMExponentiator.init(this.f5992H);
            }
            this.exp.exponentiateX(((j3 << 3) + 127) >>> 7, bArr2);
            GCMUtil.multiply(this.S_at, bArr2);
            GCMUtil.xor(this.f5994S, this.S_at);
        }
        byte[] bArr3 = new byte[16];
        Pack.longToBigEndian(this.atLength << 3, bArr3, 0);
        Pack.longToBigEndian(this.totalLength << 3, bArr3, 8);
        gHASHBlock(this.f5994S, bArr3);
        byte[] bArr4 = new byte[16];
        this.cipher.processBlock(this.f5993J0, 0, bArr4, 0);
        GCMUtil.xor(bArr4, this.f5994S);
        int i5 = this.macSize;
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (keyParameter != null) {
            ...
            this.multiplier.init(this.f5992H);
            this.exp = null;
        } else if (this.f5992H == null) {
        ...
        if (bArr4.length == 12) {
            ...
            Pack.longToBigEndian(((long) this.nonce.length) << 3, bArr5, 8);
            gHASHBlock(this.f5993J0, bArr5);
        }
        this.f5994S = new byte[16];
        this.S_at = new byte[16];
        this.S_atPre = new byte[16];
