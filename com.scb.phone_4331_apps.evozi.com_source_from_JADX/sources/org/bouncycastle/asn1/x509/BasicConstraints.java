...
public class BasicConstraints extends ASN1Object {
    ...
    public BasicConstraints(int i) {
        this.f3201cA = ASN1Boolean.getInstance(false);
        this.pathLenConstraint = null;
        this.f3201cA = ASN1Boolean.getInstance(true);
    ...
    private BasicConstraints(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.getObjectAt(0) instanceof ASN1Boolean) {
            this.f3201cA = ASN1Boolean.getInstance((Object) aSN1Sequence.getObjectAt(0));
        } else {
            this.f3201cA = null;
    ...
    public static BasicConstraints getInstance(Object obj) {
        while (!(obj instanceof BasicConstraints)) {
            if (obj instanceof X509Extension) {
                obj = X509Extension.convertValueToObject((X509Extension) obj);
            } else if (obj != null) {
    ...
    public boolean isCA() {
        ASN1Boolean aSN1Boolean = this.f3201cA;
