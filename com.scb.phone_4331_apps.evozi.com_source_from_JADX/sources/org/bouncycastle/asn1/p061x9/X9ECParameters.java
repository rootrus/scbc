...
public class X9ECParameters extends ASN1Object implements X9ObjectIdentifiers {
    ...
    /* renamed from: g */
    private X9ECPoint f5628g;

    /* renamed from: h */
    private BigInteger f5629h;

    /* renamed from: n */
    private BigInteger f5630n;
    private byte[] seed;
    ...
    private X9ECParameters(ASN1Sequence aSN1Sequence) {
        ...
        if (objectAt instanceof X9ECPoint) {
            this.f5628g = (X9ECPoint) objectAt;
        } else {
            this.f5628g = new X9ECPoint(this.curve, (ASN1OctetString) objectAt);
        }
        this.f5630n = ((ASN1Integer) aSN1Sequence.getObjectAt(4)).getValue();
        this.seed = x9Curve.getSeed();
        if (aSN1Sequence.size() == 6) {
            this.f5629h = ((ASN1Integer) aSN1Sequence.getObjectAt(5)).getValue();
        }
    }
    ...
    public X9ECParameters(ECCurve eCCurve, X9ECPoint x9ECPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        X9FieldID x9FieldID;
        this.curve = eCCurve;
        this.f5628g = x9ECPoint;
        this.f5630n = bigInteger;
        this.f5629h = bigInteger2;
        this.seed = bArr;
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f5628g);
        aSN1EncodableVector.add(new ASN1Integer(this.f5630n));
        BigInteger bigInteger = this.f5629h;
        if (bigInteger != null) {
