...
public class ASN1OutputStream {
    ...
    public ASN1OutputStream getDERSubStream() {
        return new DEROutputStream(this.f2665os);
    }

    /* access modifiers changed from: package-private */
    public ASN1OutputStream getDLSubStream() {
        return new DLOutputStream(this.f2665os);
    }

    /* access modifiers changed from: package-private */
    public void write(int i) throws IOException {
        this.f2665os.write(i);
    }

    /* access modifiers changed from: package-private */
    public void write(byte[] bArr) throws IOException {
        this.f2665os.write(bArr);
    }

    /* access modifiers changed from: package-private */
    public void write(byte[] bArr, int i, int i2) throws IOException {
        this.f2665os.write(bArr, i, i2);
    }
    ...
    public void writeImplicitObject(ASN1Primitive aSN1Primitive) throws IOException {
        if (aSN1Primitive != null) {
            aSN1Primitive.encode(new ImplicitOutputStream(this.f2665os));
            return;
        }
    ...
    public void writeNull() throws IOException {
        this.f2665os.write(5);
        this.f2665os.write(0);
    }
