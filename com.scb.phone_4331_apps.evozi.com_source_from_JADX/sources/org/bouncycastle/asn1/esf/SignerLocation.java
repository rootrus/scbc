    ...
    private SignerLocation(ASN1Sequence aSN1Sequence) {
        ...
        while (objects.hasMoreElements()) {
            ...
            if (tagNo == 0) {
                ...
                ASN1Sequence instance = aSN1TaggedObject.isExplicit() ? ASN1Sequence.getInstance(aSN1TaggedObject, true) : ASN1Sequence.getInstance(aSN1TaggedObject, false);
                this.postalAddress = instance;
                if (instance != null && instance.size() > 6) {
