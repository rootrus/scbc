...
public class BCECPublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    /* renamed from: q */
    private transient ECPoint f6115q;
    ...
    public BCECPublicKey(String str, ECPublicKeySpec eCPublicKeySpec, ProviderConfiguration providerConfiguration) {
        ...
        this.ecSpec = params;
        this.f6115q = EC5Util.convertPoint(params, eCPublicKeySpec.getW(), false);
    ...
    public BCECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters, ECParameterSpec eCParameterSpec, ProviderConfiguration providerConfiguration) {
        ...
        this.algorithm = str;
        this.f6115q = eCPublicKeyParameters.getQ();
    ...
    public BCECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters, org.bouncycastle.jce.spec.ECParameterSpec eCParameterSpec, ProviderConfiguration providerConfiguration) {
        ECDomainParameters parameters = eCPublicKeyParameters.getParameters();
        this.algorithm = str;
        ECParameterSpec createSpec = eCParameterSpec == null ? createSpec(EC5Util.convertCurve(parameters.getCurve(), parameters.getSeed()), parameters) : EC5Util.convertSpec(EC5Util.convertCurve(eCParameterSpec.getCurve(), eCParameterSpec.getSeed()), eCParameterSpec);
        this.ecSpec = createSpec;
        this.f6115q = EC5Util.convertCurve(createSpec.getCurve()).createPoint(eCPublicKeyParameters.getQ().getAffineXCoord().toBigInteger(), eCPublicKeyParameters.getQ().getAffineYCoord().toBigInteger());
        this.configuration = providerConfiguration;
    }

    public BCECPublicKey(String str, BCECPublicKey bCECPublicKey) {
        this.algorithm = str;
        this.f6115q = bCECPublicKey.f6115q;
    ...
    public BCECPublicKey(String str, org.bouncycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec, ProviderConfiguration providerConfiguration) {
        ...
        this.algorithm = str;
        this.f6115q = eCPublicKeySpec.getQ();
        if (eCPublicKeySpec.getParams() != null) {
            EllipticCurve convertCurve = EC5Util.convertCurve(eCPublicKeySpec.getParams().getCurve(), eCPublicKeySpec.getParams().getSeed());
            this.f6115q = EC5Util.convertCurve(convertCurve).createPoint(eCPublicKeySpec.getQ().getAffineXCoord().toBigInteger(), eCPublicKeySpec.getQ().getAffineYCoord().toBigInteger());
            eCParameterSpec = EC5Util.convertSpec(convertCurve, eCPublicKeySpec.getParams());
        } else {
            if (this.f6115q.getCurve() == null) {
                this.f6115q = providerConfiguration.getEcImplicitlyCa().getCurve().createPoint(this.f6115q.getXCoord().toBigInteger(), this.f6115q.getYCoord().toBigInteger(), false);
            }
    ...
    public BCECPublicKey(ECPublicKey eCPublicKey, ProviderConfiguration providerConfiguration) {
        ...
        this.ecSpec = params;
        this.f6115q = EC5Util.convertPoint(params, eCPublicKey.getW(), false);
    }
    ...
    private void populateFromPubKeyInfo(org.bouncycastle.asn1.x509.SubjectPublicKeyInfo r6) {
        ...
        L_0x003f:
            ...
            r2.<init>()
            int r2 = r2.getByteLength((org.bouncycastle.math.p099ec.ECCurve) r1)
            int r4 = r6.length
            int r4 = r4 - r3
        ...
        L_0x005c:
            ...
            r6.<init>((org.bouncycastle.math.p099ec.ECCurve) r1, (org.bouncycastle.asn1.ASN1OctetString) r0)
            org.bouncycastle.math.ec.ECPoint r6 = r6.getPoint()
            r5.f6115q = r6
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.jcajce.provider.asymmetric.p097ec.BCECPublicKey.populateFromPubKeyInfo(org.bouncycastle.asn1.x509.SubjectPublicKeyInfo):void");
    }
    ...
    public ECPoint getQ() {
        return this.ecSpec == null ? this.f6115q.getDetachedPoint() : this.f6115q;
    }

    public java.security.spec.ECPoint getW() {
        return new java.security.spec.ECPoint(this.f6115q.getAffineXCoord().toBigInteger(), this.f6115q.getAffineYCoord().toBigInteger());
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f6115q.getAffineXCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f6115q.getAffineYCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
