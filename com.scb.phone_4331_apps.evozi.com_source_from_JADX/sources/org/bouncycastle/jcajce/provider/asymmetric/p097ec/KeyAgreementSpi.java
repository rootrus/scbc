...
import org.bouncycastle.asn1.p061x9.X9IntegerConverter;
...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public static class C10455DH extends KeyAgreementSpi {
        public C10455DH() {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r6v16, resolved type: org.bouncycastle.crypto.params.ECPrivateKeyParameters} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r6v17, resolved type: org.bouncycastle.crypto.params.MQVPrivateParameters} */
    ...
    private void initFromKey(java.security.Key r6, java.security.spec.AlgorithmParameterSpec r7) throws java.security.InvalidKeyException {
        ...
        L_0x0016:
            ...
            r6.<init>()
            java.lang.String r7 = r5.kaAlgorithm
            r6.append(r7)
            r6.append(r2)
        ...
        L_0x00c1:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.jcajce.provider.asymmetric.p097ec.KeyAgreementSpi.initFromKey(java.security.Key, java.security.spec.AlgorithmParameterSpec):void");
    }
    ...
    public Key engineDoPhase(Key key, boolean z) throws InvalidKeyException, IllegalStateException {
        ...
        if (this.parameters == null) {
            ...
            if (this.agreement instanceof ECMQVBasicAgreement) {
                ...
                sb2.append(getSimpleName(ECPublicKey.class));
