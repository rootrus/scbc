...
public class DSASigner extends SignatureSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
    ...
    public static class detDSASha3_224 extends DSASigner {
        public detDSASha3_224() {
            super(new SHA3Digest((int) PassportService.DEFAULT_MAX_BLOCKSIZE), new org.bouncycastle.crypto.signers.DSASigner(new HMacDSAKCalculator(new SHA3Digest((int) PassportService.DEFAULT_MAX_BLOCKSIZE))));
        }
    }
    ...
    public static class dsaSha3_224 extends DSASigner {
        public dsaSha3_224() {
            super(new SHA3Digest((int) PassportService.DEFAULT_MAX_BLOCKSIZE), new org.bouncycastle.crypto.signers.DSASigner());
        }
    }
    ...
    public void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        ...
        if (publicKey instanceof DSAKey) {
            ...
            try {
                asymmetricKeyParameter = DSAUtil.generatePublicKeyParameter(new BCDSAPublicKey(SubjectPublicKeyInfo.getInstance(publicKey.getEncoded())));
