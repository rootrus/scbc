...
class X509CertificateObject extends X509Certificate implements PKCS12BagAttributeCarrier {
        ...
        try {
            ...
            try {
                ...
                if (extensionBytes2 != null) {
                    ...
                    int length = (bytes.length << 3) - instance.getPadBits();
    ...
    private void checkSignature(PublicKey publicKey, Signature signature) throws CertificateException, NoSuchAlgorithmException, SignatureException, InvalidKeyException {
        if (isAlgIdEqual(this.f3217c.getSignatureAlgorithm(), this.f3217c.getTBSCertificate().getSignature())) {
            X509SignatureUtil.setSignatureParameters(signature, this.f3217c.getSignatureAlgorithm().getParameters());
        ...
        try {
            ...
            while (objects.hasMoreElements()) {
                ...
                switch (instance.getTagNo()) {
                    ...
                    case 2:
                    case 6:
                        str = ((ASN1String) instance.getName()).getString();
                        break;
                    case 4:
                        str = X500Name.getInstance(RFC4519Style.INSTANCE, (Object) instance.getName()).toString();
                        break;
                    case 7:
                        try {
                            str = InetAddress.getByAddress(DEROctetString.getInstance(instance.getName()).getOctets()).getHostAddress();
                            break;
                        } catch (UnknownHostException unused) {
                            break;
                        }
                    case 8:
                        str = ASN1ObjectIdentifier.getInstance(instance.getName()).getId();
                        break;
                    default:
                        StringBuilder sb = new StringBuilder();
    ...
    private byte[] getExtensionBytes(String str) {
        Extension extension;
        Extensions extensions = this.f3217c.getTBSCertificate().getExtensions();
    ...
    public void checkValidity(Date date) throws CertificateExpiredException, CertificateNotYetValidException {
        if (date.getTime() > getNotAfter().getTime()) {
            ...
            sb.append(this.f3217c.getEndDate().getTime());
            ...
            sb2.append(this.f3217c.getStartDate().getTime());
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.hashValueSet || !x509CertificateObject.hashValueSet || this.hashValue == x509CertificateObject.hashValue) {
            return this.f3217c.equals(x509CertificateObject.f3217c);
        }
        return false;
    }
    ...
    public byte[] getEncoded() throws CertificateEncodingException {
        try {
            return this.f3217c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public Principal getIssuerDN() {
        try {
            return new X509Principal(X500Name.getInstance(this.f3217c.getIssuer().getEncoded()));
    ...
    public boolean[] getIssuerUniqueID() {
        DERBitString issuerUniqueId = this.f3217c.getTBSCertificate().getIssuerUniqueId();
    ...
    public X500Principal getIssuerX500Principal() {
        try {
            ...
            new ASN1OutputStream(byteArrayOutputStream).writeObject(this.f3217c.getIssuer());
    ...
    public Date getNotAfter() {
        return this.f3217c.getEndDate().getDate();
    }

    public Date getNotBefore() {
        return this.f3217c.getStartDate().getDate();
    }

    public PublicKey getPublicKey() {
        try {
            return BouncyCastleProvider.getPublicKey(this.f3217c.getSubjectPublicKeyInfo());
        } catch (IOException unused) {
            return null;
        }
    }
    ...
    public BigInteger getSerialNumber() {
        return this.f3217c.getSerialNumber().getValue();
    }

    public String getSigAlgName() {
        return X509SignatureUtil.getSignatureName(this.f3217c.getSignatureAlgorithm());
    }

    public String getSigAlgOID() {
        return this.f3217c.getSignatureAlgorithm().getAlgorithm().getId();
    }

    public byte[] getSigAlgParams() {
        if (this.f3217c.getSignatureAlgorithm().getParameters() == null) {
            return null;
        }
        try {
            return this.f3217c.getSignatureAlgorithm().getParameters().toASN1Primitive().getEncoded(ASN1Encoding.DER);
        } catch (IOException unused) {
            return null;
        }
    }
    ...
    public byte[] getSignature() {
        return this.f3217c.getSignature().getOctets();
    }
    ...
    public Principal getSubjectDN() {
        return new X509Principal(X500Name.getInstance(this.f3217c.getSubject().toASN1Primitive()));
    }

    public boolean[] getSubjectUniqueID() {
        DERBitString subjectUniqueId = this.f3217c.getTBSCertificate().getSubjectUniqueId();
    ...
    public X500Principal getSubjectX500Principal() {
        try {
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            new ASN1OutputStream(byteArrayOutputStream).writeObject(this.f3217c.getSubject());
            return new X500Principal(byteArrayOutputStream.toByteArray());
        } catch (IOException unused) {
            throw new IllegalStateException("can't encode issuer DN");
        }
    ...
    public byte[] getTBSCertificate() throws CertificateEncodingException {
        try {
            return this.f3217c.getTBSCertificate().getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            throw new CertificateEncodingException(e.toString());
        }
    }
    ...
    public int getVersion() {
        return this.f3217c.getVersionNumber();
    }

    public boolean hasUnsupportedCriticalExtension() {
        Extensions extensions;
        if (getVersion() != 3 || (extensions = this.f3217c.getTBSCertificate().getExtensions()) == null) {
            return false;
        }
        Enumeration oids = extensions.oids();
        while (oids.hasMoreElements()) {
    ...
    public final void verify(PublicKey publicKey) throws CertificateException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException {
        Signature signature;
        String signatureName = X509SignatureUtil.getSignatureName(this.f3217c.getSignatureAlgorithm());
        try {
