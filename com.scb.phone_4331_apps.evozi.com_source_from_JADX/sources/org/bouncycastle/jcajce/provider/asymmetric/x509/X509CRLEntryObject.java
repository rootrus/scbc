...
class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Extension getExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Extensions extensions = this.f3215c.getExtensions();
        if (extensions != null) {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f3215c.equals(((X509CRLEntryObject) obj).f3215c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f3215c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public Date getRevocationDate() {
        return this.f3215c.getRevocationDate().getDate();
    }

    public BigInteger getSerialNumber() {
        return this.f3215c.getUserCertificate().getValue();
    }

    public boolean hasExtensions() {
        return this.f3215c.getExtensions() != null;
    }
