...
public class DigestSignatureSpi extends SignatureSpi {
    ...
    public static class SHA3_224 extends DigestSignatureSpi {
        public SHA3_224() {
            super(NISTObjectIdentifiers.id_sha3_224, new SHA3Digest((int) PassportService.DEFAULT_MAX_BLOCKSIZE), new PKCS1Encoding(new RSABlindedEngine()));
        }
    }
    ...
    public static class SHA512_224 extends DigestSignatureSpi {
        public SHA512_224() {
            super(NISTObjectIdentifiers.id_sha512_224, new SHA512tDigest((int) PassportService.DEFAULT_MAX_BLOCKSIZE), new PKCS1Encoding(new RSABlindedEngine()));
        }
    }
        ...
        try {
            ...
            if (processBlock.length == derEncode.length - 2) {
                ...
                for (int i = 0; i < digestSize; i++) {
                    b |= processBlock[length + i] ^ derEncode[((length2 - digestSize) - 2) + i];
                }
