...
public class BCECGOST3410PrivateKey implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    /* renamed from: d */
    private transient BigInteger f6116d;
    ...
    public BCECGOST3410PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters) {
        this.algorithm = str;
        this.f6116d = eCPrivateKeyParameters.getD();
        this.ecSpec = null;
    }
    ...
    public BCECGOST3410PrivateKey(ECPrivateKey eCPrivateKey) {
        this.f6116d = eCPrivateKey.getS();
        this.algorithm = eCPrivateKey.getAlgorithm();
        this.ecSpec = eCPrivateKey.getParams();
    }

    public BCECGOST3410PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        this.f6116d = eCPrivateKeySpec.getS();
    ...
    public BCECGOST3410PrivateKey(BCECGOST3410PrivateKey bCECGOST3410PrivateKey) {
        this.f6116d = bCECGOST3410PrivateKey.f6116d;
    ...
    public BCECGOST3410PrivateKey(org.bouncycastle.jce.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        this.f6116d = eCPrivateKeySpec.getD();
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v18, resolved type: org.bouncycastle.jce.spec.ECNamedCurveSpec} */
    ...
    public byte[] getEncoded() {
        /*
            ...
            org.bouncycastle.asn1.cryptopro.GOST3410PublicKeyAlgParameters r6 = r11.gostParams     // Catch:{ IOException -> 0x002b }
        ...
        L_0x0051:
            ...
            r0.<init>((org.bouncycastle.asn1.ASN1Null) r3)
        ...
        L_0x0063:
            ...
            r0.<init>((org.bouncycastle.asn1.p061x9.X9ECParameters) r9)
            r3 = r0
        L_0x009e:
            java.security.spec.ECParameterSpec r0 = r11.ecSpec
        ...
        L_0x00bf:
            org.bouncycastle.asn1.sec.ECPrivateKey r4 = new org.bouncycastle.asn1.sec.ECPrivateKey
            java.math.BigInteger r5 = r11.getS()
            r4.<init>((int) r3, (java.math.BigInteger) r5, (org.bouncycastle.asn1.ASN1Encodable) r0)
        L_0x00c8:
            org.bouncycastle.asn1.pkcs.PrivateKeyInfo r3 = new org.bouncycastle.asn1.pkcs.PrivateKeyInfo     // Catch:{ IOException -> 0x00e1 }
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r5 = new org.bouncycastle.asn1.x509.AlgorithmIdentifier     // Catch:{ IOException -> 0x00e1 }
            org.bouncycastle.asn1.ASN1ObjectIdentifier r6 = org.bouncycastle.asn1.cryptopro.CryptoProObjectIdentifiers.gostR3410_2001     // Catch:{ IOException -> 0x00e1 }
            org.bouncycastle.asn1.ASN1Primitive r0 = r0.toASN1Primitive()     // Catch:{ IOException -> 0x00e1 }
            r5.<init>(r6, r0)     // Catch:{ IOException -> 0x00e1 }
            org.bouncycastle.asn1.ASN1Primitive r0 = r4.toASN1Primitive()     // Catch:{ IOException -> 0x00e1 }
            r3.<init>(r5, r0)     // Catch:{ IOException -> 0x00e1 }
            byte[] r0 = r3.getEncoded(r1)     // Catch:{ IOException -> 0x00e1 }
            return r0
        L_0x00e1:
            return r2
        */
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f6116d.toString(16));
        stringBuffer.append(lineSeparator);
