...
public class BCECGOST3410PublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public BCECGOST3410PublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f6117q = EC5Util.convertPoint(params, eCPublicKey.getW(), false);
    }

    public BCECGOST3410PublicKey(ECPublicKeySpec eCPublicKeySpec) {
        ECParameterSpec params = eCPublicKeySpec.getParams();
        this.ecSpec = params;
        this.f6117q = EC5Util.convertPoint(params, eCPublicKeySpec.getW(), false);
    }
    ...
    public BCECGOST3410PublicKey(BCECGOST3410PublicKey bCECGOST3410PublicKey) {
        this.f6117q = bCECGOST3410PublicKey.f6117q;
    ...
    public BCECGOST3410PublicKey(org.bouncycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.f6117q = eCPublicKeySpec.getQ();
        if (eCPublicKeySpec.getParams() != null) {
            ...
            if (this.f6117q.getCurve() == null) {
                this.f6117q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f6117q.getAffineXCoord().toBigInteger(), this.f6117q.getAffineYCoord().toBigInteger());
            }
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            this.f6117q = curve.createPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
    ...
    public byte[] getEncoded() {
        ...
        BigInteger bigInteger = this.f6117q.getAffineXCoord().toBigInteger();
        BigInteger bigInteger2 = this.f6117q.getAffineYCoord().toBigInteger();
    ...
    public ECPoint getQ() {
        return this.ecSpec == null ? this.f6117q.getDetachedPoint() : this.f6117q;
    }

    public java.security.spec.ECPoint getW() {
        return new java.security.spec.ECPoint(this.f6117q.getAffineXCoord().toBigInteger(), this.f6117q.getAffineYCoord().toBigInteger());
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f6117q.getAffineXCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f6117q.getAffineYCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
