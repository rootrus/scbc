...
import org.bouncycastle.asn1.p092ua.DSTU4145Params;
import org.bouncycastle.asn1.p092ua.DSTU4145PointEncoder;
import org.bouncycastle.asn1.p092ua.UAObjectIdentifiers;
...
public class BCDSTU4145PublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    /* renamed from: q */
    private transient ECPoint f6113q;
    private boolean withCompression;

    public BCDSTU4145PublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters) {
        this.algorithm = str;
        this.f6113q = eCPublicKeyParameters.getQ();
        this.ecSpec = null;
    }
    ...
    public BCDSTU4145PublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f6113q = EC5Util.convertPoint(params, eCPublicKey.getW(), false);
    }

    public BCDSTU4145PublicKey(ECPublicKeySpec eCPublicKeySpec) {
        ECParameterSpec params = eCPublicKeySpec.getParams();
        this.ecSpec = params;
        this.f6113q = EC5Util.convertPoint(params, eCPublicKeySpec.getW(), false);
    }
    ...
    public BCDSTU4145PublicKey(BCDSTU4145PublicKey bCDSTU4145PublicKey) {
        this.f6113q = bCDSTU4145PublicKey.f6113q;
    ...
    public BCDSTU4145PublicKey(org.bouncycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.f6113q = eCPublicKeySpec.getQ();
        if (eCPublicKeySpec.getParams() != null) {
            ...
            if (this.f6113q.getCurve() == null) {
                this.f6113q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f6113q.getAffineXCoord().toBigInteger(), this.f6113q.getAffineYCoord().toBigInteger());
            }
    ...
    private void populateFromPubKeyInfo(org.bouncycastle.asn1.x509.SubjectPublicKeyInfo r13) {
        /*
            ...
            org.bouncycastle.asn1.ASN1ObjectIdentifier r2 = org.bouncycastle.asn1.p092ua.UAObjectIdentifiers.dstu4145le
        ...
        L_0x0029:
            ...
            org.bouncycastle.asn1.ua.DSTU4145Params r1 = org.bouncycastle.asn1.p092ua.DSTU4145Params.getInstance(r1)
            r12.dstuParams = r1
            ...
            org.bouncycastle.crypto.params.ECDomainParameters r1 = org.bouncycastle.asn1.p092ua.DSTU4145NamedCurves.getByOID(r13)
        ...
        L_0x0068:
            ...
            org.bouncycastle.asn1.ASN1ObjectIdentifier r4 = org.bouncycastle.asn1.p092ua.UAObjectIdentifiers.dstu4145le
        ...
        L_0x0085:
            ...
            org.bouncycastle.asn1.ASN1ObjectIdentifier r3 = org.bouncycastle.asn1.p092ua.UAObjectIdentifiers.dstu4145le
            boolean r13 = r13.equals(r3)
            if (r13 == 0) goto L_0x00c0
            r12.reverseBytes(r2)
        L_0x00c0:
            org.bouncycastle.jce.spec.ECParameterSpec r9 = new org.bouncycastle.jce.spec.ECParameterSpec
            org.bouncycastle.math.ec.ECPoint r13 = org.bouncycastle.asn1.p092ua.DSTU4145PointEncoder.decodePoint(r11, r2)
        ...
        L_0x00cd:
            ...
            org.bouncycastle.math.ec.ECPoint r13 = org.bouncycastle.asn1.p092ua.DSTU4145PointEncoder.decodePoint(r13, r0)
            r12.f6113q = r13
            org.bouncycastle.asn1.ua.DSTU4145Params r13 = r12.dstuParams
    ...
    public byte[] getEncoded() {
        ...
        try {
            return KeyUtil.getEncodedSubjectPublicKeyInfo(new SubjectPublicKeyInfo(new AlgorithmIdentifier(UAObjectIdentifiers.dstu4145be, aSN1Encodable), (ASN1Encodable) new DEROctetString(DSTU4145PointEncoder.encodePoint(this.f6113q))));
    ...
    public ECPoint getQ() {
        return this.ecSpec == null ? this.f6113q.getDetachedPoint() : this.f6113q;
    }
    ...
    public java.security.spec.ECPoint getW() {
        return new java.security.spec.ECPoint(this.f6113q.getAffineXCoord().toBigInteger(), this.f6113q.getAffineYCoord().toBigInteger());
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f6113q.getAffineXCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f6113q.getAffineYCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
