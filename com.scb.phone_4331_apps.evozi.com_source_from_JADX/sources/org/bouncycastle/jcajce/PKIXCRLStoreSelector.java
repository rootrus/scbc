...
public class PKIXCRLStoreSelector<T extends CRL> implements Selector<T> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x0061, code lost:
        if (org.bouncycastle.util.Arrays.areEqual(r0, r1) == false) goto L_0x006b;
     */
    ...
    public boolean match(java.security.cert.CRL r5) {
        ...
        L_0x0005:
            ...
            r1 = 0
            r2 = 0
            org.bouncycastle.asn1.ASN1ObjectIdentifier r3 = org.bouncycastle.asn1.x509.Extension.deltaCRLIndicator     // Catch:{ Exception -> 0x006b }
            java.lang.String r3 = r3.getId()     // Catch:{ Exception -> 0x006b }
            byte[] r3 = r0.getExtensionValue(r3)     // Catch:{ Exception -> 0x006b }
            if (r3 == 0) goto L_0x0022
            org.bouncycastle.asn1.ASN1OctetString r1 = org.bouncycastle.asn1.ASN1OctetString.getInstance(r3)     // Catch:{ Exception -> 0x006b }
            byte[] r1 = r1.getOctets()     // Catch:{ Exception -> 0x006b }
            org.bouncycastle.asn1.ASN1Integer r1 = org.bouncycastle.asn1.ASN1Integer.getInstance(r1)     // Catch:{ Exception -> 0x006b }
        L_0x0022:
