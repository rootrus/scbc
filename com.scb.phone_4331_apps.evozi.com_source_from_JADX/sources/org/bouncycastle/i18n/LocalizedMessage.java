...
public class LocalizedMessage {
    ...
    /* renamed from: id */
    protected final String f6103id;
    ...
    public String getEntry(String str, Locale locale, TimeZone timeZone) throws MissingEntryException {
        ...
        try {
            ...
            throw new MissingEntryException(obj, str4, str3, locale, classLoader);
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f6103id);
        stringBuffer.append("\"");
