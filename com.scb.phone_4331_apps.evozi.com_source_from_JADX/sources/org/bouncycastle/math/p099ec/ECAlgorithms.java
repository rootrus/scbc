    ...
    public static ECPoint sumOfTwoMultiplies(ECPoint eCPoint, BigInteger bigInteger, ECPoint eCPoint2, BigInteger bigInteger2) {
        ...
        if (!(curve instanceof ECCurve.AbstractF2m) || !((ECCurve.AbstractF2m) curve).isKoblitz()) {
            ...
            if (endomorphism instanceof GLVEndomorphism) {
                eCPoint3 = implSumOfMultipliesGLV(new ECPoint[]{eCPoint, importPoint}, new BigInteger[]{bigInteger, bigInteger2}, (GLVEndomorphism) endomorphism);
            } else {
                eCPoint3 = implShamirsTrickWNaf(eCPoint, bigInteger, importPoint, bigInteger2);
            }
        } else {
            eCPoint3 = eCPoint.multiply(bigInteger).add(importPoint.multiply(bigInteger2));
        }
        return validatePoint(eCPoint3);
    }
