...
class Tnaf {
    ...
    public static BigInteger norm(byte b, ZTauElement zTauElement) {
        BigInteger bigInteger;
        BigInteger multiply = zTauElement.f6181u.multiply(zTauElement.f6181u);
        BigInteger multiply2 = zTauElement.f6181u.multiply(zTauElement.f6182v);
        BigInteger shiftLeft = zTauElement.f6182v.multiply(zTauElement.f6182v).shiftLeft(1);
        if (b == 1) {
    ...
    public static SimpleBigDecimal norm(byte b, SimpleBigDecimal simpleBigDecimal, SimpleBigDecimal simpleBigDecimal2) {
        ...
        if (b == 1) {
            simpleBigDecimal3 = multiply.add(multiply2);
        } else if (b == -1) {
            simpleBigDecimal3 = multiply.subtract(multiply2);
        } else {
            throw new IllegalArgumentException("mu must be 1 or -1");
        }
        return simpleBigDecimal3.add(shiftLeft);
    }
    ...
    public static ZTauElement partModReduction(BigInteger bigInteger, int i, byte b, BigInteger[] bigIntegerArr, byte b2, byte b3) {
        ...
        return new ZTauElement(bigInteger.subtract(add.multiply(round.f6181u)).subtract(BigInteger.valueOf(2).multiply(bigIntegerArr[1]).multiply(round.f6182v)), bigIntegerArr[1].multiply(round.f6181u).subtract(bigIntegerArr[0].multiply(round.f6182v)));
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0083, code lost:
        if (r5.compareTo(org.bouncycastle.math.p099ec.ECConstants.ONE) >= 0) goto L_0x008e;
     */
    ...
    public static org.bouncycastle.math.p099ec.ZTauElement round(org.bouncycastle.math.p099ec.SimpleBigDecimal r7, org.bouncycastle.math.p099ec.SimpleBigDecimal r8, byte r9) {
        /*
            int r0 = r7.getScale()
            int r1 = r8.getScale()
        ...
        L_0x0019:
            ...
            org.bouncycastle.math.ec.SimpleBigDecimal r4 = r7.add((org.bouncycastle.math.p099ec.SimpleBigDecimal) r7)
            if (r9 != r1) goto L_0x0034
            org.bouncycastle.math.ec.SimpleBigDecimal r4 = r4.add((org.bouncycastle.math.p099ec.SimpleBigDecimal) r8)
            goto L_0x0038
        L_0x0034:
            org.bouncycastle.math.ec.SimpleBigDecimal r4 = r4.subtract((org.bouncycastle.math.p099ec.SimpleBigDecimal) r8)
        L_0x0038:
            org.bouncycastle.math.ec.SimpleBigDecimal r5 = r8.add((org.bouncycastle.math.p099ec.SimpleBigDecimal) r8)
            org.bouncycastle.math.ec.SimpleBigDecimal r5 = r5.add((org.bouncycastle.math.p099ec.SimpleBigDecimal) r8)
            org.bouncycastle.math.ec.SimpleBigDecimal r8 = r5.add((org.bouncycastle.math.p099ec.SimpleBigDecimal) r8)
            if (r9 != r1) goto L_0x004f
            org.bouncycastle.math.ec.SimpleBigDecimal r5 = r7.subtract((org.bouncycastle.math.p099ec.SimpleBigDecimal) r5)
            org.bouncycastle.math.ec.SimpleBigDecimal r7 = r7.add((org.bouncycastle.math.p099ec.SimpleBigDecimal) r8)
            goto L_0x0057
        L_0x004f:
            org.bouncycastle.math.ec.SimpleBigDecimal r5 = r7.add((org.bouncycastle.math.p099ec.SimpleBigDecimal) r5)
            org.bouncycastle.math.ec.SimpleBigDecimal r7 = r7.subtract((org.bouncycastle.math.p099ec.SimpleBigDecimal) r8)
        L_0x0057:
            java.math.BigInteger r8 = org.bouncycastle.math.p099ec.ECConstants.ONE
            ...
            goto L_0x0071
        L_0x0069:
            java.math.BigInteger r8 = org.bouncycastle.math.p099ec.ECConstants.TWO
        ...
        L_0x0075:
            ...
            java.math.BigInteger r7 = org.bouncycastle.math.p099ec.ECConstants.ONE
        ...
        L_0x00a9:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.math.p099ec.Tnaf.round(org.bouncycastle.math.ec.SimpleBigDecimal, org.bouncycastle.math.ec.SimpleBigDecimal, byte):org.bouncycastle.math.ec.ZTauElement");
    }
    ...
    public static byte[] tauAdicNaf(byte b, ZTauElement zTauElement) {
        ...
        if (b == 1 || b == -1) {
            ...
            BigInteger bigInteger2 = zTauElement.f6181u;
            BigInteger bigInteger3 = zTauElement.f6182v;
            int i = 0;
            int i2 = 0;
            while (true) {
                if (!bigInteger.equals(ECConstants.ZERO) || !bigInteger3.equals(ECConstants.ZERO)) {
                    if (bigInteger.testBit(0)) {
                        bArr[i] = (byte) ECConstants.TWO.subtract(bigInteger.subtract(bigInteger3.shiftLeft(1)).mod(ECConstants.FOUR)).intValue();
    ...
    public static byte[] tauAdicWNaf(byte b, ZTauElement zTauElement, byte b2, BigInteger bigInteger, BigInteger bigInteger2, ZTauElement[] zTauElementArr) {
        ...
        if (b == 1 || b == -1) {
            int bitLength = norm(b, zTauElement).bitLength();
            byte[] bArr = new byte[(bitLength > 30 ? bitLength + 4 + b2 : b2 + ISO7816.INS_MSE)];
            BigInteger shiftRight = bigInteger.shiftRight(1);
            BigInteger bigInteger3 = zTauElement.f6181u;
            BigInteger bigInteger4 = zTauElement.f6182v;
            int i = 0;
            while (true) {
                ...
                if (bigInteger3.testBit(0)) {
                    ...
                    if (z) {
                        bigInteger3 = bigInteger3.subtract(zTauElementArr[intValue].f6181u);
                        bigInteger4 = bigInteger4.subtract(zTauElementArr[intValue].f6182v);
                    } else {
                        bigInteger3 = bigInteger3.add(zTauElementArr[intValue].f6181u);
                        bigInteger4 = bigInteger4.add(zTauElementArr[intValue].f6182v);
                    }
                } else {
                    bArr[i] = 0;
                }
