...
import org.bouncycastle.math.p099ec.endo.ECEndomorphism;
import org.bouncycastle.math.p099ec.endo.GLVEndomorphism;
...
public abstract class ECCurve {
    ...
    /* renamed from: a */
    public ECFieldElement f6163a;

    /* renamed from: b */
    public ECFieldElement f6164b;
    ...
    public static abstract class AbstractF2m extends ECCurve {
        ...
        /* renamed from: si */
        private BigInteger[] f6165si = null;
        ...
        public BigInteger[] getSi() {
            ...
            synchronized (this) {
                if (this.f6165si == null) {
                    this.f6165si = Tnaf.getSi(this);
                }
                bigIntegerArr = this.f6165si;
            }
            return bigIntegerArr;
        }

        public boolean isKoblitz() {
            return this.order != null && this.cofactor != null && this.f6164b.isOne() && (this.f6163a.isZero() || this.f6163a.isOne());
        }
    ...
    public static abstract class AbstractFp extends ECCurve {
        ...
        public ECPoint decompressPoint(int i, BigInteger bigInteger) {
            ECFieldElement fromBigInteger = fromBigInteger(bigInteger);
            ECFieldElement sqrt = fromBigInteger.square().add(this.f6163a).multiply(fromBigInteger).add(this.f6164b).sqrt();
            if (sqrt != null) {
    ...
    public static class F2m extends AbstractF2m {
        ...
        public F2m(int i, int i2, int i3, int i4, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
            ...
            this.f6163a = fromBigInteger(bigInteger);
            this.f6164b = fromBigInteger(bigInteger2);
            this.coord = 6;
        }
        ...
        protected F2m(int i, int i2, int i3, int i4, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger, BigInteger bigInteger2) {
            ...
            this.infinity = new ECPoint.F2m(this, (ECFieldElement) null, (ECFieldElement) null);
            this.f6163a = eCFieldElement;
            this.f6164b = eCFieldElement2;
            this.coord = 6;
        }
        ...
        public ECCurve cloneCurve() {
            return new F2m(this.f6169m, this.f6166k1, this.f6167k2, this.f6168k3, this.f6163a, this.f6164b, this.order, this.cofactor);
        }
        ...
        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.F2m(this.f6169m, this.f6166k1, this.f6167k2, this.f6168k3, bigInteger);
        }
        ...
        public boolean isTrinomial() {
            return this.f6167k2 == 0 && this.f6168k3 == 0;
        }
    ...
    public static class C10477Fp extends AbstractFp {
        private static final int FP_DEFAULT_COORDS = 4;
        ECPoint.C10479Fp infinity;
        ...
        public C10477Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3) {
            this(bigInteger, bigInteger2, bigInteger3, (BigInteger) null, (BigInteger) null);
        }

        public C10477Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, BigInteger bigInteger5) {
            super(bigInteger);
            this.f6170q = bigInteger;
            this.f6171r = ECFieldElement.C10478Fp.calculateResidue(bigInteger);
            this.infinity = new ECPoint.C10479Fp(this, (ECFieldElement) null, (ECFieldElement) null);
            this.f6163a = fromBigInteger(bigInteger2);
            this.f6164b = fromBigInteger(bigInteger3);
            this.order = bigInteger4;
            this.cofactor = bigInteger5;
            this.coord = 4;
        }

        protected C10477Fp(BigInteger bigInteger, BigInteger bigInteger2, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2) {
            this(bigInteger, bigInteger2, eCFieldElement, eCFieldElement2, (BigInteger) null, (BigInteger) null);
        }

        protected C10477Fp(BigInteger bigInteger, BigInteger bigInteger2, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger3, BigInteger bigInteger4) {
            super(bigInteger);
            this.f6170q = bigInteger;
            this.f6171r = bigInteger2;
            this.infinity = new ECPoint.C10479Fp(this, (ECFieldElement) null, (ECFieldElement) null);
            this.f6163a = eCFieldElement;
            this.f6164b = eCFieldElement2;
            this.order = bigInteger3;
        ...
        /* access modifiers changed from: protected */
        public ECCurve cloneCurve() {
            return new C10477Fp(this.f6170q, this.f6171r, this.f6163a, this.f6164b, this.order, this.cofactor);
        }

        /* access modifiers changed from: protected */
        public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, boolean z) {
            return new ECPoint.C10479Fp(this, eCFieldElement, eCFieldElement2, z);
        }

        /* access modifiers changed from: protected */
        public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z) {
            return new ECPoint.C10479Fp(this, eCFieldElement, eCFieldElement2, eCFieldElementArr, z);
        }

        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.C10478Fp(this.f6170q, this.f6171r, bigInteger);
        }

        public int getFieldSize() {
            return this.f6170q.bitLength();
        }
        ...
        public ECPoint importPoint(ECPoint eCPoint) {
            ...
            return new ECPoint.C10479Fp(this, fromBigInteger(eCPoint.f6178x.toBigInteger()), fromBigInteger(eCPoint.f6179y.toBigInteger()), new ECFieldElement[]{fromBigInteger(eCPoint.f6180zs[0].toBigInteger())}, eCPoint.withCompression);
        }
    ...
    public ECPoint decodePoint(byte[] bArr) {
        ...
        if (b != 0) {
            if (b == 2 || b == 3) {
                ...
                } else if (bArr.length == (fieldSize << 1) + 1) {
