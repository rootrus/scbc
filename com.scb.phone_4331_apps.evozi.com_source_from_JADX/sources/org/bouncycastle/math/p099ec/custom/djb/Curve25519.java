...
public class Curve25519 extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f6183q = Nat256.toBigInteger(Curve25519Field.f6185P);
    protected Curve25519Point infinity = new Curve25519Point(this, (ECFieldElement) null, (ECFieldElement) null);

    public Curve25519() {
        super(f6183q);
        this.f6163a = fromBigInteger(new BigInteger(1, Hex.decode("2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA984914A144")));
        this.f6164b = fromBigInteger(new BigInteger(1, Hex.decode("7B425ED097B425ED097B425ED097B425ED097B425ED097B4260B5E9C7710C864")));
