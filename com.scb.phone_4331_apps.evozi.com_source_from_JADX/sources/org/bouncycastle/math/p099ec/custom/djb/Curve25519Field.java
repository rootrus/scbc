...
public class Curve25519Field {
    ...
    /* renamed from: M */
    private static final long f6184M = 4294967295L;

    /* renamed from: P */
    static final int[] f6185P = {-19, -1, -1, -1, -1, -1, -1, Integer.MAX_VALUE};

    /* renamed from: P7 */
    private static final int f6186P7 = Integer.MAX_VALUE;
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        ...
        if (Nat256.gte(iArr2, f6185P)) {
            subPFrom(iArr2);
        }
    }

    private static int addPExtTo(int[] iArr) {
        long j = (((long) iArr[0]) & f6184M) + (((long) PExt[0]) & f6184M);
        iArr[0] = (int) j;
        long j2 = j >> 32;
        if (j2 != 0) {
            j2 = (long) Nat.incAt(8, iArr, 1);
        }
        long j3 = j2 + ((((long) iArr[8]) & f6184M) - 19);
        iArr[8] = (int) j3;
        long j4 = j3 >> 32;
        if (j4 != 0) {
            j4 = (long) Nat.decAt(15, iArr, 9);
        }
        long j5 = j4 + (((long) iArr[15]) & f6184M) + (f6184M & ((long) (PExt[15] + 1)));
        iArr[15] = (int) j5;
        return (int) (j5 >> 32);
    }

    private static int addPTo(int[] iArr) {
        long j = (((long) iArr[0]) & f6184M) - 19;
        iArr[0] = (int) j;
        long j2 = j >> 32;
        if (j2 != 0) {
            j2 = (long) Nat.decAt(7, iArr, 1);
        }
        long j3 = j2 + (f6184M & ((long) iArr[7])) + 2147483648L;
        iArr[7] = (int) j3;
        return (int) (j3 >> 32);
    }
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        while (Nat256.gte(fromBigInteger, f6185P)) {
            Nat256.subFrom(f6185P, fromBigInteger);
        }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        int i2 = iArr2[7];
        iArr2[7] = (Integer.MAX_VALUE & i2) + Nat.addWordTo(7, ((mulByWordAddTo << 1) + ((i2 >>> 31) - (i >>> 31))) * 19, iArr2);
        if (Nat256.gte(iArr2, f6185P)) {
            subPFrom(iArr2);
        }
    }
    ...
    public static void reduce27(int i, int[] iArr) {
        int i2 = iArr[7];
        iArr[7] = (Integer.MAX_VALUE & i2) + Nat.addWordTo(7, ((i << 1) | (i2 >>> 31)) * 19, iArr);
        if (Nat256.gte(iArr, f6185P)) {
            subPFrom(iArr);
        }
    }
