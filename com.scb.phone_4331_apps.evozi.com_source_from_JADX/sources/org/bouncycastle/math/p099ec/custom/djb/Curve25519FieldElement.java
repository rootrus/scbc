...
public class Curve25519FieldElement extends ECFieldElement {
    ...
    /* renamed from: Q */
    public static final BigInteger f6187Q = Curve25519.f6183q;

    /* renamed from: x */
    protected int[] f6188x;

    public Curve25519FieldElement() {
        this.f6188x = Nat256.create();
    }

    public Curve25519FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f6187Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for Curve25519FieldElement");
        }
        this.f6188x = Curve25519Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        Curve25519Field.add(this.f6188x, ((Curve25519FieldElement) eCFieldElement).f6188x, create);
        return new Curve25519FieldElement(create);
    }

    public ECFieldElement addOne() {
        int[] create = Nat256.create();
        Curve25519Field.addOne(this.f6188x, create);
        return new Curve25519FieldElement(create);
    }

    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        Mod.invert(Curve25519Field.f6185P, ((Curve25519FieldElement) eCFieldElement).f6188x, create);
        Curve25519Field.multiply(create, this.f6188x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat256.m6289eq(this.f6188x, ((Curve25519FieldElement) obj).f6188x);
    }
    ...
    public int getFieldSize() {
        return f6187Q.bitLength();
    }

    public int hashCode() {
        return f6187Q.hashCode() ^ Arrays.hashCode(this.f6188x, 0, 8);
    }

    public ECFieldElement invert() {
        int[] create = Nat256.create();
        Mod.invert(Curve25519Field.f6185P, this.f6188x, create);
        return new Curve25519FieldElement(create);
    }

    public boolean isOne() {
        return Nat256.isOne(this.f6188x);
    }

    public boolean isZero() {
        return Nat256.isZero(this.f6188x);
    }

    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        Curve25519Field.multiply(this.f6188x, ((Curve25519FieldElement) eCFieldElement).f6188x, create);
        return new Curve25519FieldElement(create);
    }

    public ECFieldElement negate() {
        int[] create = Nat256.create();
        Curve25519Field.negate(this.f6188x, create);
        return new Curve25519FieldElement(create);
    }

    public ECFieldElement sqrt() {
        int[] iArr = this.f6188x;
        ...
        Curve25519Field.square(create, create);
        Curve25519Field.square(create, create2);
        if (Nat256.m6289eq(iArr, create2)) {
            return new Curve25519FieldElement(create);
        }
    ...
    public ECFieldElement square() {
        int[] create = Nat256.create();
        Curve25519Field.square(this.f6188x, create);
        return new Curve25519FieldElement(create);
    }

    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        Curve25519Field.subtract(this.f6188x, ((Curve25519FieldElement) eCFieldElement).f6188x, create);
        return new Curve25519FieldElement(create);
    }

    public boolean testBitZero() {
        return Nat256.getBit(this.f6188x, 0) == 1;
    }

    public BigInteger toBigInteger() {
        return Nat256.toBigInteger(this.f6188x);
    }
}
