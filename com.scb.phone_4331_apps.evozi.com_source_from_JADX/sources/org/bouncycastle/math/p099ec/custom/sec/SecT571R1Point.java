...
public class SecT571R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElement5.isZero()) {
                return new SecT571R1Point(curve, eCFieldElement5, SecT571R1Curve.SecT571R1_B_SQRT, this.withCompression);
            }
            ...
            if (multiply3.isZero()) {
                return new SecT571R1Point(curve, multiply3, SecT571R1Curve.SecT571R1_B_SQRT, this.withCompression);
            }
        ...
        return new SecT571R1Point(curve, eCFieldElement5, eCFieldElement4, new ECFieldElement[]{eCFieldElement6}, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        if (add.isZero()) {
            return new SecT571R1Point(curve, add, SecT571R1Curve.SecT571R1_B_SQRT, this.withCompression);
        }
        ...
        return new SecT571R1Point(curve, square2, eCFieldElement.squarePlusProduct(add, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2}, this.withCompression);
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (multiplyPlusProduct.isZero()) {
            return new SecT571R1Point(curve, multiplyPlusProduct, SecT571R1Curve.SecT571R1_B_SQRT, this.withCompression);
        }
        ECFieldElement multiply2 = multiplyPlusProduct.square().multiply(multiply);
        ECFieldElement multiply3 = multiplyPlusProduct.multiply(square4).multiply(square3);
        return new SecT571R1Point(curve, multiply2, multiplyPlusProduct.add(square4).square().multiplyPlusProduct(add, addOne, multiply3), new ECFieldElement[]{multiply3}, this.withCompression);
    }
}
