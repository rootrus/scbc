...
public class SecT283Field {
    ...
    protected static void implMultiply(long[] jArr, long[] jArr2, long[] jArr3) {
        ...
        implMulw(j9 ^ j11, j12 ^ j10, jArr7, 24);
        ...
        jArr3[4] = (j24 ^ (jArr6[18] ^ jArr6[23])) ^ (j15 ^ j23);
        jArr3[5] = ((j17 ^ j22) ^ j24) ^ (jArr6[21] ^ jArr6[22]);
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        jArr3[0] = jArr3[0] ^ ((unshuffle & 4294967295L) | (unshuffle2 << 32));
        jArr3[1] = jArr3[1] ^ ((unshuffle3 & 4294967295L) | (unshuffle4 << 32));
        jArr3[2] = jArr3[2] ^ (unshuffle5 & 4294967295L);
    }
