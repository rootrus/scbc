...
public class SecT571Field {
    ...
    /* renamed from: RM */
    private static final long f6257RM = -1190112520884487202L;
    ...
    protected static void implMultiply(long[] jArr, long[] jArr2, long[] jArr3) {
        ...
        while (i > 0) {
            int i3 = i2 + 18;
            Nat.shiftUpBit64(9, jArr4, i3 >>> 1, 0, jArr4, i3);
            reduce5(jArr4, i3);
            add(jArr4, 9, jArr4, i3, jArr4, i3 + 9);
            i--;
            i2 = i3;
        }
        long[] jArr5 = new long[CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA];
        Nat.shiftUpBits64(CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA, jArr4, 0, 4, 0, jArr5, 0);
