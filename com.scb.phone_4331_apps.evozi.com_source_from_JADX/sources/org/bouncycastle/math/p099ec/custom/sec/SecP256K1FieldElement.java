...
public class SecP256K1FieldElement extends ECFieldElement {
    ...
    /* renamed from: Q */
    public static final BigInteger f6232Q = SecP256K1Curve.f6229q;

    /* renamed from: x */
    protected int[] f6233x;

    public SecP256K1FieldElement() {
        this.f6233x = Nat256.create();
    }

    public SecP256K1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f6232Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP256K1FieldElement");
        }
        this.f6233x = SecP256K1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP256K1Field.add(this.f6233x, ((SecP256K1FieldElement) eCFieldElement).f6233x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement addOne() {
        int[] create = Nat256.create();
        SecP256K1Field.addOne(this.f6233x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        Mod.invert(SecP256K1Field.f6230P, ((SecP256K1FieldElement) eCFieldElement).f6233x, create);
        SecP256K1Field.multiply(create, this.f6233x, create);
        return new SecP256K1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat256.m6289eq(this.f6233x, ((SecP256K1FieldElement) obj).f6233x);
    }
    ...
    public int getFieldSize() {
        return f6232Q.bitLength();
    }

    public int hashCode() {
        return f6232Q.hashCode() ^ Arrays.hashCode(this.f6233x, 0, 8);
    }

    public ECFieldElement invert() {
        int[] create = Nat256.create();
        Mod.invert(SecP256K1Field.f6230P, this.f6233x, create);
        return new SecP256K1FieldElement(create);
    }

    public boolean isOne() {
        return Nat256.isOne(this.f6233x);
    }

    public boolean isZero() {
        return Nat256.isZero(this.f6233x);
    }

    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SecP256K1Field.multiply(this.f6233x, ((SecP256K1FieldElement) eCFieldElement).f6233x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement negate() {
        int[] create = Nat256.create();
        SecP256K1Field.negate(this.f6233x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement sqrt() {
        int[] iArr = this.f6233x;
    ...
    public ECFieldElement square() {
        int[] create = Nat256.create();
        SecP256K1Field.square(this.f6233x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SecP256K1Field.subtract(this.f6233x, ((SecP256K1FieldElement) eCFieldElement).f6233x, create);
        return new SecP256K1FieldElement(create);
    }

    public boolean testBitZero() {
        return Nat256.getBit(this.f6233x, 0) == 1;
    }

    public BigInteger toBigInteger() {
        return Nat256.toBigInteger(this.f6233x);
    }
}
