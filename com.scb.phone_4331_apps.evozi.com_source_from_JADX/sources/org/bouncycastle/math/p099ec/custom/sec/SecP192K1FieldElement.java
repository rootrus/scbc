...
public class SecP192K1FieldElement extends ECFieldElement {
    ...
    /* renamed from: Q */
    public static final BigInteger f6210Q = SecP192K1Curve.f6207q;

    /* renamed from: x */
    protected int[] f6211x;

    public SecP192K1FieldElement() {
        this.f6211x = Nat192.create();
    }

    public SecP192K1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f6210Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP192K1FieldElement");
        }
        this.f6211x = SecP192K1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP192K1Field.add(this.f6211x, ((SecP192K1FieldElement) eCFieldElement).f6211x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement addOne() {
        int[] create = Nat192.create();
        SecP192K1Field.addOne(this.f6211x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        Mod.invert(SecP192K1Field.f6208P, ((SecP192K1FieldElement) eCFieldElement).f6211x, create);
        SecP192K1Field.multiply(create, this.f6211x, create);
        return new SecP192K1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat192.m6287eq(this.f6211x, ((SecP192K1FieldElement) obj).f6211x);
    }
    ...
    public int getFieldSize() {
        return f6210Q.bitLength();
    }

    public int hashCode() {
        return f6210Q.hashCode() ^ Arrays.hashCode(this.f6211x, 0, 6);
    }

    public ECFieldElement invert() {
        int[] create = Nat192.create();
        Mod.invert(SecP192K1Field.f6208P, this.f6211x, create);
        return new SecP192K1FieldElement(create);
    }

    public boolean isOne() {
        return Nat192.isOne(this.f6211x);
    }

    public boolean isZero() {
        return Nat192.isZero(this.f6211x);
    }

    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        SecP192K1Field.multiply(this.f6211x, ((SecP192K1FieldElement) eCFieldElement).f6211x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement negate() {
        int[] create = Nat192.create();
        SecP192K1Field.negate(this.f6211x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement sqrt() {
        int[] iArr = this.f6211x;
        ...
        SecP192K1Field.square(create, create2);
        if (Nat192.m6287eq(iArr, create2)) {
            return new SecP192K1FieldElement(create);
        }
        return null;
    }
    ...
    public ECFieldElement square() {
        int[] create = Nat192.create();
        SecP192K1Field.square(this.f6211x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        SecP192K1Field.subtract(this.f6211x, ((SecP192K1FieldElement) eCFieldElement).f6211x, create);
        return new SecP192K1FieldElement(create);
    }

    public boolean testBitZero() {
        return Nat192.getBit(this.f6211x, 0) == 1;
    }

    public BigInteger toBigInteger() {
        return Nat192.toBigInteger(this.f6211x);
    }
}
