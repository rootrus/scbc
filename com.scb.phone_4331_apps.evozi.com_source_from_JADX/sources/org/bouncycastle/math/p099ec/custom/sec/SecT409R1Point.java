...
public class SecT409R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        return new SecT409R1Point(curve, multiply2, multiplyPlusProduct.add(square4).square().multiplyPlusProduct(add, addOne, multiply3), new ECFieldElement[]{multiply3}, this.withCompression);
    }
}
