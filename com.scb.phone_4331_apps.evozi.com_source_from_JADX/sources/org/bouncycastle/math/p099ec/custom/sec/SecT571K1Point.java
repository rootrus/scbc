    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElement5.isZero()) {
                return new SecT571K1Point(curve, eCFieldElement5, curve.getB(), this.withCompression);
            }
            ...
            if (multiply3.isZero()) {
                return new SecT571K1Point(curve, multiply3, curve.getB(), this.withCompression);
            }
        ...
        return new SecT571K1Point(curve, eCFieldElement5, eCFieldElement4, new ECFieldElement[]{eCFieldElement6}, this.withCompression);
    }
