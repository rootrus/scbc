...
public class SecT163Field {
    ...
    protected static void implMultiply(long[] jArr, long[] jArr2, long[] jArr3) {
        ...
        long j22 = ((((j15 << 1) ^ j17) ^ j19) ^ (jArr4[2] << 4)) ^ (jArr4[2] << 1);
        long j23 = (((((j15 ^ (j16 << 1)) ^ j18) ^ j20) ^ (jArr4[3] << 4)) ^ (jArr4[3] << 1)) ^ (j22 >>> 55);
        long j24 = (j21 ^ j16) ^ (j23 >>> 55);
        long j25 = j23 & M55;
        long j26 = ((j22 & M55) >>> 1) ^ ((j25 & 1) << 54);
        long j27 = j26 ^ (j26 << 1);
        long j28 = j27 ^ (j27 << 2);
        long j29 = j28 ^ (j28 << 4);
        long j30 = j29 ^ (j29 << 8);
    ...
    public static void reduce29(long[] jArr, int i) {
        ...
        long j = jArr[i2];
        long j2 = j >>> 35;
        jArr[i] = (((j2 << 6) ^ ((j2 << 3) ^ j2)) ^ (j2 << 7)) ^ jArr[i];
        jArr[i2] = j & M35;
    }
