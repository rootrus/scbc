...
public class SecP192R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP192R1FieldElement secP192R1FieldElement = (SecP192R1FieldElement) this.f6178x;
        SecP192R1FieldElement secP192R1FieldElement2 = (SecP192R1FieldElement) this.f6179y;
        ...
        SecP192R1FieldElement secP192R1FieldElement5 = (SecP192R1FieldElement) this.f6180zs[0];
        ...
        if (isOne) {
            iArr2 = secP192R1FieldElement3.f6217x;
            iArr = secP192R1FieldElement4.f6217x;
        } else {
            SecP192R1Field.square(secP192R1FieldElement5.f6217x, create2);
            SecP192R1Field.multiply(create2, secP192R1FieldElement3.f6217x, create);
            SecP192R1Field.multiply(create2, secP192R1FieldElement5.f6217x, create2);
            SecP192R1Field.multiply(create2, secP192R1FieldElement4.f6217x, create2);
            iArr2 = create;
            iArr = create2;
        }
        boolean isOne2 = secP192R1FieldElement6.isOne();
        if (isOne2) {
            iArr4 = secP192R1FieldElement.f6217x;
            iArr3 = secP192R1FieldElement2.f6217x;
        } else {
            SecP192R1Field.square(secP192R1FieldElement6.f6217x, create3);
            SecP192R1Field.multiply(create3, secP192R1FieldElement.f6217x, createExt);
            SecP192R1Field.multiply(create3, secP192R1FieldElement6.f6217x, create3);
            SecP192R1Field.multiply(create3, secP192R1FieldElement2.f6217x, create3);
            iArr4 = createExt;
            iArr3 = create3;
        }
        ...
        SecP192R1Field.square(create, secP192R1FieldElement7.f6217x);
        SecP192R1Field.subtract(secP192R1FieldElement7.f6217x, create5, secP192R1FieldElement7.f6217x);
        SecP192R1FieldElement secP192R1FieldElement8 = new SecP192R1FieldElement(create5);
        SecP192R1Field.subtract(create2, secP192R1FieldElement7.f6217x, secP192R1FieldElement8.f6217x);
        SecP192R1Field.multiplyAddToExt(secP192R1FieldElement8.f6217x, create, createExt);
        SecP192R1Field.reduce(createExt, secP192R1FieldElement8.f6217x);
        SecP192R1FieldElement secP192R1FieldElement9 = new SecP192R1FieldElement(create4);
        if (!isOne) {
            SecP192R1Field.multiply(secP192R1FieldElement9.f6217x, secP192R1FieldElement5.f6217x, secP192R1FieldElement9.f6217x);
        }
        if (!isOne2) {
            SecP192R1Field.multiply(secP192R1FieldElement9.f6217x, secP192R1FieldElement6.f6217x, secP192R1FieldElement9.f6217x);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP192R1Point(this.curve, this.f6178x, this.f6179y.negate(), this.f6180zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP192R1FieldElement secP192R1FieldElement = (SecP192R1FieldElement) this.f6179y;
        if (secP192R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP192R1FieldElement secP192R1FieldElement2 = (SecP192R1FieldElement) this.f6178x;
        SecP192R1FieldElement secP192R1FieldElement3 = (SecP192R1FieldElement) this.f6180zs[0];
        int[] create = Nat192.create();
        int[] create2 = Nat192.create();
        int[] create3 = Nat192.create();
        SecP192R1Field.square(secP192R1FieldElement.f6217x, create3);
        int[] create4 = Nat192.create();
        SecP192R1Field.square(create3, create4);
        boolean isOne = secP192R1FieldElement3.isOne();
        int[] iArr = secP192R1FieldElement3.f6217x;
        if (!isOne) {
            SecP192R1Field.square(secP192R1FieldElement3.f6217x, create2);
            iArr = create2;
        }
        SecP192R1Field.subtract(secP192R1FieldElement2.f6217x, iArr, create);
        SecP192R1Field.add(secP192R1FieldElement2.f6217x, iArr, create2);
        ...
        SecP192R1Field.square(create2, secP192R1FieldElement4.f6217x);
        SecP192R1Field.subtract(secP192R1FieldElement4.f6217x, create3, secP192R1FieldElement4.f6217x);
        SecP192R1Field.subtract(secP192R1FieldElement4.f6217x, create3, secP192R1FieldElement4.f6217x);
        SecP192R1FieldElement secP192R1FieldElement5 = new SecP192R1FieldElement(create3);
        SecP192R1Field.subtract(create3, secP192R1FieldElement4.f6217x, secP192R1FieldElement5.f6217x);
        SecP192R1Field.multiply(secP192R1FieldElement5.f6217x, create2, secP192R1FieldElement5.f6217x);
        SecP192R1Field.subtract(secP192R1FieldElement5.f6217x, create, secP192R1FieldElement5.f6217x);
        SecP192R1FieldElement secP192R1FieldElement6 = new SecP192R1FieldElement(create2);
        SecP192R1Field.twice(secP192R1FieldElement.f6217x, secP192R1FieldElement6.f6217x);
        if (!isOne) {
            SecP192R1Field.multiply(secP192R1FieldElement6.f6217x, secP192R1FieldElement3.f6217x, secP192R1FieldElement6.f6217x);
        }
