...
public class SecT239Field {
    ...
    protected static void implMulwAcc(long j, long j2, long[] jArr, int i) {
        ...
        while (true) {
            int i5 = (int) (j3 >>> i4);
            long j6 = jArr2[i5 & 7] ^ (jArr2[(i5 >>> i2) & 7] << i2);
            j4 ^= j6 << i4;
            j5 ^= j6 >>> (-i4);
            i4 -= 6;
            if (i4 <= 0) {
                ...
                int i6 = i + 1;
                jArr[i6] = ((((((j3 & 585610922974906400L) & ((j2 << 4) >> 63)) >>> 5) ^ j5) << 4) ^ (j4 >>> 60)) ^ jArr[i6];
                return;
            }
            i2 = 3;
        }
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        for (int i2 = 2; i < i2; i2 = 2) {
            int i3 = iArr[i] >>> 6;
            int i4 = iArr[i] & 63;
            createExt64[i3] = createExt64[i3] ^ (j << i4);
            int i5 = i3 + 1;
            int[] iArr2 = iArr;
            int i6 = -i4;
            createExt64[i5] = createExt64[i5] ^ ((j5 << i4) | (j >>> i6));
            int i7 = i3 + 2;
            createExt64[i7] = createExt64[i7] ^ ((j4 << i4) | (j5 >>> i6));
            int i8 = i3 + 3;
            createExt64[i8] = createExt64[i8] ^ ((j3 << i4) | (j4 >>> i6));
            int i9 = i3 + 4;
            createExt64[i9] = createExt64[i9] ^ (j3 >>> i6);
            i++;
            iArr = iArr2;
        }
        reduce(createExt64, jArr3);
