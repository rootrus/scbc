...
public class SecP192K1Field {
    ...
    /* renamed from: P */
    static final int[] f6208P = {-4553, -2, -1, -1, -1, -1};

    /* renamed from: P5 */
    private static final int f6209P5 = -1;
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat192.add(iArr, iArr2, iArr3) != 0 || (iArr3[5] == -1 && Nat192.gte(iArr3, f6208P))) {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(6, iArr, iArr2) != 0 || (iArr2[5] == -1 && Nat192.gte(iArr2, f6208P))) {
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        if (fromBigInteger[5] == -1 && Nat192.gte(fromBigInteger, f6208P)) {
            Nat192.subFrom(f6208P, fromBigInteger);
        }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(6, iArr2, Nat192.add(iArr, f6208P, iArr2));
        }
    }
    ...
    public static void negate(int[] iArr, int[] iArr2) {
        if (Nat192.isZero(iArr)) {
            ...
            Nat192.sub(f6208P, iArr, iArr2);
        }
    }

    public static void reduce(int[] iArr, int[] iArr2) {
        if (Nat192.mul33DWordAdd(PInv33, Nat192.mul33Add(PInv33, iArr, 6, iArr, 0, iArr2, 0), iArr2, 0) != 0 || (iArr2[5] == -1 && Nat192.gte(iArr2, f6208P))) {
            Nat.add33To(6, PInv33, iArr2);
        }
    }

    public static void reduce32(int i, int[] iArr) {
        if ((i != 0 && Nat192.mul33WordAdd(PInv33, i, iArr, 0) != 0) || (iArr[5] == -1 && Nat192.gte(iArr, f6208P))) {
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(6, iArr, 0, iArr2) != 0 || (iArr2[5] == -1 && Nat192.gte(iArr2, f6208P))) {
            Nat.add33To(6, PInv33, iArr2);
        }
    }
}
