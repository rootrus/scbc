...
public class SecP224R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP224R1FieldElement secP224R1FieldElement = (SecP224R1FieldElement) this.f6178x;
        SecP224R1FieldElement secP224R1FieldElement2 = (SecP224R1FieldElement) this.f6179y;
        ...
        SecP224R1FieldElement secP224R1FieldElement5 = (SecP224R1FieldElement) this.f6180zs[0];
        ...
        if (isOne) {
            iArr2 = secP224R1FieldElement3.f6228x;
            iArr = secP224R1FieldElement4.f6228x;
        } else {
            SecP224R1Field.square(secP224R1FieldElement5.f6228x, create2);
            SecP224R1Field.multiply(create2, secP224R1FieldElement3.f6228x, create);
            SecP224R1Field.multiply(create2, secP224R1FieldElement5.f6228x, create2);
            SecP224R1Field.multiply(create2, secP224R1FieldElement4.f6228x, create2);
            iArr2 = create;
            iArr = create2;
        }
        boolean isOne2 = secP224R1FieldElement6.isOne();
        if (isOne2) {
            iArr4 = secP224R1FieldElement.f6228x;
            iArr3 = secP224R1FieldElement2.f6228x;
        } else {
            SecP224R1Field.square(secP224R1FieldElement6.f6228x, create3);
            SecP224R1Field.multiply(create3, secP224R1FieldElement.f6228x, createExt);
            SecP224R1Field.multiply(create3, secP224R1FieldElement6.f6228x, create3);
            SecP224R1Field.multiply(create3, secP224R1FieldElement2.f6228x, create3);
            iArr4 = createExt;
            iArr3 = create3;
        }
        ...
        SecP224R1Field.square(create, secP224R1FieldElement7.f6228x);
        SecP224R1Field.subtract(secP224R1FieldElement7.f6228x, create5, secP224R1FieldElement7.f6228x);
        SecP224R1FieldElement secP224R1FieldElement8 = new SecP224R1FieldElement(create5);
        SecP224R1Field.subtract(create2, secP224R1FieldElement7.f6228x, secP224R1FieldElement8.f6228x);
        SecP224R1Field.multiplyAddToExt(secP224R1FieldElement8.f6228x, create, createExt);
        SecP224R1Field.reduce(createExt, secP224R1FieldElement8.f6228x);
        SecP224R1FieldElement secP224R1FieldElement9 = new SecP224R1FieldElement(create4);
        if (!isOne) {
            SecP224R1Field.multiply(secP224R1FieldElement9.f6228x, secP224R1FieldElement5.f6228x, secP224R1FieldElement9.f6228x);
        }
        if (!isOne2) {
            SecP224R1Field.multiply(secP224R1FieldElement9.f6228x, secP224R1FieldElement6.f6228x, secP224R1FieldElement9.f6228x);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP224R1Point(this.curve, this.f6178x, this.f6179y.negate(), this.f6180zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP224R1FieldElement secP224R1FieldElement = (SecP224R1FieldElement) this.f6179y;
        if (secP224R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP224R1FieldElement secP224R1FieldElement2 = (SecP224R1FieldElement) this.f6178x;
        SecP224R1FieldElement secP224R1FieldElement3 = (SecP224R1FieldElement) this.f6180zs[0];
        int[] create = Nat224.create();
        int[] create2 = Nat224.create();
        int[] create3 = Nat224.create();
        SecP224R1Field.square(secP224R1FieldElement.f6228x, create3);
        int[] create4 = Nat224.create();
        SecP224R1Field.square(create3, create4);
        boolean isOne = secP224R1FieldElement3.isOne();
        int[] iArr = secP224R1FieldElement3.f6228x;
        if (!isOne) {
            SecP224R1Field.square(secP224R1FieldElement3.f6228x, create2);
            iArr = create2;
        }
        SecP224R1Field.subtract(secP224R1FieldElement2.f6228x, iArr, create);
        SecP224R1Field.add(secP224R1FieldElement2.f6228x, iArr, create2);
        ...
        SecP224R1Field.square(create2, secP224R1FieldElement4.f6228x);
        SecP224R1Field.subtract(secP224R1FieldElement4.f6228x, create3, secP224R1FieldElement4.f6228x);
        SecP224R1Field.subtract(secP224R1FieldElement4.f6228x, create3, secP224R1FieldElement4.f6228x);
        SecP224R1FieldElement secP224R1FieldElement5 = new SecP224R1FieldElement(create3);
        SecP224R1Field.subtract(create3, secP224R1FieldElement4.f6228x, secP224R1FieldElement5.f6228x);
        SecP224R1Field.multiply(secP224R1FieldElement5.f6228x, create2, secP224R1FieldElement5.f6228x);
        SecP224R1Field.subtract(secP224R1FieldElement5.f6228x, create, secP224R1FieldElement5.f6228x);
        SecP224R1FieldElement secP224R1FieldElement6 = new SecP224R1FieldElement(create2);
        SecP224R1Field.twice(secP224R1FieldElement.f6228x, secP224R1FieldElement6.f6228x);
        if (!isOne) {
            SecP224R1Field.multiply(secP224R1FieldElement6.f6228x, secP224R1FieldElement3.f6228x, secP224R1FieldElement6.f6228x);
        }
