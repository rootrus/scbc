...
public abstract class Nat {
    ...
    /* renamed from: M */
    private static final long f6263M = 4294967295L;

    public static int add(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = j + (((long) iArr[i2]) & f6263M) + (f6263M & ((long) iArr2[i2]));
            iArr3[i2] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int add33At(int i, int i2, int[] iArr, int i3) {
        long j = (((long) iArr[i3]) & f6263M) + (((long) i2) & f6263M);
        iArr[i3] = (int) j;
        int i4 = i3 + 1;
        long j2 = (j >>> 32) + (f6263M & ((long) iArr[i4])) + 1;
        iArr[i4] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int add33At(int i, int i2, int[] iArr, int i3, int i4) {
        int i5 = i3 + i4;
        long j = (((long) iArr[i5]) & f6263M) + (((long) i2) & f6263M);
        iArr[i5] = (int) j;
        int i6 = i5 + 1;
        long j2 = (j >>> 32) + (f6263M & ((long) iArr[i6])) + 1;
        iArr[i6] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int add33To(int i, int i2, int[] iArr) {
        long j = (((long) iArr[0]) & f6263M) + (((long) i2) & f6263M);
        iArr[0] = (int) j;
        long j2 = (j >>> 32) + (f6263M & ((long) iArr[1])) + 1;
        iArr[1] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addBothTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i6 = 0; i6 < i5; i6++) {
            int i7 = i4 + i6;
            long j2 = j + (((long) iArr[i2 + i6]) & f6263M) + (((long) iArr2[i3 + i6]) & f6263M) + (((long) iArr3[i7]) & f6263M);
            iArr3[i7] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addBothTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = j + (((long) iArr[i2]) & f6263M) + (((long) iArr2[i2]) & f6263M) + (f6263M & ((long) iArr3[i2]));
            iArr3[i2] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addDWordAt(int i, long j, int[] iArr, int i2) {
        long j2 = (((long) iArr[i2]) & f6263M) + (j & f6263M);
        iArr[i2] = (int) j2;
        int i3 = i2 + 1;
        long j3 = (j2 >>> 32) + (f6263M & ((long) iArr[i3])) + (j >>> 32);
        iArr[i3] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addDWordAt(int i, long j, int[] iArr, int i2, int i3) {
        int i4 = i2 + i3;
        long j2 = (((long) iArr[i4]) & f6263M) + (j & f6263M);
        iArr[i4] = (int) j2;
        int i5 = i4 + 1;
        long j3 = (j2 >>> 32) + (f6263M & ((long) iArr[i5])) + (j >>> 32);
        iArr[i5] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addDWordTo(int i, long j, int[] iArr) {
        long j2 = (((long) iArr[0]) & f6263M) + (j & f6263M);
        iArr[0] = (int) j2;
        long j3 = (j2 >>> 32) + (f6263M & ((long) iArr[1])) + (j >>> 32);
        iArr[1] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addTo(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            int i5 = i3 + i4;
            long j2 = j + (((long) iArr[i2 + i4]) & f6263M) + (f6263M & ((long) iArr2[i5]));
            iArr2[i5] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addWordAt(int i, int i2, int[] iArr, int i3) {
        long j = (((long) i2) & f6263M) + (f6263M & ((long) iArr[i3]));
        iArr[i3] = (int) j;
        if ((j >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addWordAt(int i, int i2, int[] iArr, int i3, int i4) {
        long j = (long) i2;
        int i5 = i3 + i4;
        long j2 = (j & f6263M) + (f6263M & ((long) iArr[i5]));
        iArr[i5] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addWordTo(int i, int i2, int[] iArr) {
        long j = (((long) i2) & f6263M) + (f6263M & ((long) iArr[0]));
        iArr[0] = (int) j;
        if ((j >>> 32) == 0) {
            return 0;
        }
    ...
    /* renamed from: eq */
    public static boolean m6284eq(int i, int[] iArr, int[] iArr2) {
        do {
            i--;
            if (i < 0) {
                return true;
    ...
    public static int mul31BothAdd(int i, int i2, int[] iArr, int i3, int[] iArr2, int[] iArr3, int i4) {
        ...
        do {
            int i6 = i4 + i5;
            long j4 = j3 + ((((long) iArr[i5]) & f6263M) * (j & f6263M)) + ((((long) iArr2[i5]) & f6263M) * (j2 & f6263M)) + (((long) iArr3[i6]) & f6263M);
            iArr3[i6] = (int) j4;
            j3 = j4 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i7 = 0; i7 < i5; i7++) {
            int i8 = i6 + i5;
            long mulWordAddTo = (((long) mulWordAddTo(i, iArr[i2 + i7], iArr2, i3, iArr3, i6)) & f6263M) + j + (f6263M & ((long) iArr3[i8]));
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            int i3 = i2 + i;
            long mulWordAddTo = (((long) mulWordAddTo(i, iArr[i2], iArr2, 0, iArr3, i2)) & f6263M) + j + (f6263M & ((long) iArr3[i3]));
    ...
    public static int mulWord(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i5 = 0;
        do {
            long j3 = j2 + ((((long) iArr[i3 + i5]) & f6263M) * (f6263M & j));
            iArr2[i4 + i5] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulWord(int i, int i2, int[] iArr, int[] iArr2) {
        ...
        int i3 = 0;
        do {
            long j3 = j2 + ((((long) iArr[i3]) & f6263M) * (f6263M & j));
            iArr2[i3] = (int) j3;
            j2 = j3 >>> 32;
            i3++;
        } while (i3 < i);
    ...
    public static int mulWordAddTo(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        do {
            int i6 = i4 + i5;
            long j3 = j2 + ((((long) iArr[i3 + i5]) & f6263M) * (j & f6263M)) + (f6263M & ((long) iArr2[i6]));
            iArr2[i6] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulWordDwordAddAt(int i, int i2, long j, int[] iArr, int i3) {
        long j2 = ((long) i2) & f6263M;
        long j3 = ((j & f6263M) * j2) + (((long) iArr[i3]) & f6263M);
        iArr[i3] = (int) j3;
        int i4 = i3 + 1;
        long j4 = (j3 >>> 32) + (j2 * (j >>> 32)) + (((long) iArr[i4]) & f6263M);
        iArr[i4] = (int) j4;
        int i5 = i3 + 2;
        long j5 = (j4 >>> 32) + (((long) iArr[i5]) & f6263M);
        iArr[i5] = (int) j5;
        if ((j5 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int squareWordAdd(int[] iArr, int i, int i2, int[] iArr2, int i3) {
        int i4 = i2;
        long j = (long) iArr[i + i4];
        int i5 = 0;
        long j2 = 0;
        int i6 = i3;
        do {
            int i7 = i4 + i6;
            long j3 = j2 + ((((long) iArr[i + i5]) & f6263M) * (j & f6263M)) + (f6263M & ((long) iArr2[i7]));
            iArr2[i7] = (int) j3;
            j2 = j3 >>> 32;
            i6++;
            i5++;
    ...
    public static int squareWordAdd(int[] iArr, int i, int[] iArr2) {
        ...
        do {
            int i3 = i + i2;
            long j3 = j2 + ((((long) iArr[i2]) & f6263M) * (j & f6263M)) + (f6263M & ((long) iArr2[i3]));
            iArr2[i3] = (int) j3;
            j2 = j3 >>> 32;
            i2++;
        } while (i2 < i);
    ...
    public static int sub(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            long j2 = j + ((((long) iArr[i2 + i5]) & f6263M) - (f6263M & ((long) iArr2[i3 + i5])));
            iArr3[i4 + i5] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subBothFrom(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i6 = 0; i6 < i5; i6++) {
            int i7 = i4 + i6;
            long j2 = j + (((((long) iArr3[i7]) & f6263M) - (((long) iArr[i2 + i6]) & f6263M)) - (f6263M & ((long) iArr2[i3 + i6])));
            iArr3[i7] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subBothFrom(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = j + (((((long) iArr3[i2]) & f6263M) - (((long) iArr[i2]) & f6263M)) - (f6263M & ((long) iArr2[i2])));
            iArr3[i2] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subFrom(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            int i5 = i3 + i4;
            long j2 = j + ((((long) iArr2[i5]) & f6263M) - (f6263M & ((long) iArr[i2 + i4])));
            iArr2[i5] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subFrom(int i, int[] iArr, int[] iArr2) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = j + ((((long) iArr2[i2]) & f6263M) - (f6263M & ((long) iArr[i2])));
            iArr2[i2] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subWordAt(int i, int i2, int[] iArr, int i3) {
        long j = (((long) iArr[i3]) & f6263M) - (f6263M & ((long) i2));
        iArr[i3] = (int) j;
        if ((j >> 32) == 0) {
            return 0;
        }
    ...
    public static int subWordAt(int i, int i2, int[] iArr, int i3, int i4) {
        int i5 = i3 + i4;
        long j = (((long) iArr[i5]) & f6263M) - (f6263M & ((long) i2));
        iArr[i5] = (int) j;
        if ((j >> 32) == 0) {
            return 0;
        }
    ...
    public static int subWordFrom(int i, int i2, int[] iArr) {
        long j = (((long) iArr[0]) & f6263M) - (f6263M & ((long) i2));
        iArr[0] = (int) j;
        if ((j >> 32) == 0) {
            return 0;
        }
