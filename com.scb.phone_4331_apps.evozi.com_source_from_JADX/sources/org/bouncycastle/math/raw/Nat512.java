...
public abstract class Nat512 {
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        int addTo = Nat256.addTo(iArr4, 24, iArr4, 16, Nat256.addTo(iArr4, 0, iArr4, 8, 0) + addToEachOther);
        ...
        Nat.addWordAt(32, addToEachOther + addTo + (z ? Nat.addTo(16, createExt, 0, iArr4, 8) : Nat.subFrom(16, createExt, 0, iArr4, 8)), iArr4, 24);
    }
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        Nat.addWordAt(32, addToEachOther + addTo + Nat.subFrom(16, createExt, 0, iArr2, 8), iArr2, 24);
    }
}
