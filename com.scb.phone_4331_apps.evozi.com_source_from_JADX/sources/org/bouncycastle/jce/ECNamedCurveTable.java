...
public class ECNamedCurveTable {
    public static Enumeration getNames() {
        return org.bouncycastle.asn1.p061x9.ECNamedCurveTable.getNames();
    }
    ...
    public static ECNamedCurveParameterSpec getParameterSpec(String str) {
        ...
        if (byName == null) {
            ...
            if (byName == null && (byName = org.bouncycastle.asn1.p061x9.ECNamedCurveTable.getByName(str)) == null) {
                try {
                    byName = org.bouncycastle.asn1.p061x9.ECNamedCurveTable.getByOID(new ASN1ObjectIdentifier(str));
