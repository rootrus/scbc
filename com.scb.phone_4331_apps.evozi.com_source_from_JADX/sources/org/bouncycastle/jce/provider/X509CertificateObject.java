...
public class X509CertificateObject extends X509Certificate implements PKCS12BagAttributeCarrier {
    ...
    private void checkSignature(PublicKey publicKey, Signature signature) throws CertificateException, NoSuchAlgorithmException, SignatureException, InvalidKeyException {
        if (isAlgIdEqual(this.f6142c.getSignatureAlgorithm(), this.f6142c.getTBSCertificate().getSignature())) {
            X509SignatureUtil.setSignatureParameters(signature, this.f6142c.getSignatureAlgorithm().getParameters());
    ...
    private byte[] getExtensionBytes(String str) {
        Extension extension;
        Extensions extensions = this.f6142c.getTBSCertificate().getExtensions();
    ...
    public void checkValidity(Date date) throws CertificateExpiredException, CertificateNotYetValidException {
        if (date.getTime() > getNotAfter().getTime()) {
            ...
            sb.append(this.f6142c.getEndDate().getTime());
            ...
            sb2.append(this.f6142c.getStartDate().getTime());
    ...
    public byte[] getEncoded() throws CertificateEncodingException {
        try {
            return this.f6142c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public Principal getIssuerDN() {
        try {
            return new X509Principal(X500Name.getInstance(this.f6142c.getIssuer().getEncoded()));
    ...
    public boolean[] getIssuerUniqueID() {
        DERBitString issuerUniqueId = this.f6142c.getTBSCertificate().getIssuerUniqueId();
    ...
    public X500Principal getIssuerX500Principal() {
        try {
            ...
            new ASN1OutputStream(byteArrayOutputStream).writeObject(this.f6142c.getIssuer());
    ...
    public Date getNotAfter() {
        return this.f6142c.getEndDate().getDate();
    }

    public Date getNotBefore() {
        return this.f6142c.getStartDate().getDate();
    }

    public PublicKey getPublicKey() {
        try {
            return BouncyCastleProvider.getPublicKey(this.f6142c.getSubjectPublicKeyInfo());
        } catch (IOException unused) {
            return null;
        }
    }
    ...
    public BigInteger getSerialNumber() {
        return this.f6142c.getSerialNumber().getValue();
    }
    ...
    public String getSigAlgOID() {
        return this.f6142c.getSignatureAlgorithm().getAlgorithm().getId();
    }

    public byte[] getSigAlgParams() {
        if (this.f6142c.getSignatureAlgorithm().getParameters() == null) {
            return null;
        }
        try {
            return this.f6142c.getSignatureAlgorithm().getParameters().toASN1Primitive().getEncoded(ASN1Encoding.DER);
        } catch (IOException unused) {
            return null;
        }
    }
    ...
    public byte[] getSignature() {
        return this.f6142c.getSignature().getOctets();
    }
    ...
    public Principal getSubjectDN() {
        return new X509Principal(X500Name.getInstance(this.f6142c.getSubject().toASN1Primitive()));
    }

    public boolean[] getSubjectUniqueID() {
        DERBitString subjectUniqueId = this.f6142c.getTBSCertificate().getSubjectUniqueId();
    ...
    public X500Principal getSubjectX500Principal() {
        try {
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            new ASN1OutputStream(byteArrayOutputStream).writeObject(this.f6142c.getSubject());
            return new X500Principal(byteArrayOutputStream.toByteArray());
        } catch (IOException unused) {
            throw new IllegalStateException("can't encode issuer DN");
        }
    ...
    public byte[] getTBSCertificate() throws CertificateEncodingException {
        try {
            return this.f6142c.getTBSCertificate().getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            throw new CertificateEncodingException(e.toString());
        }
    }
    ...
    public int getVersion() {
        return this.f6142c.getVersionNumber();
    }

    public boolean hasUnsupportedCriticalExtension() {
        Extensions extensions;
        if (getVersion() != 3 || (extensions = this.f6142c.getTBSCertificate().getExtensions()) == null) {
            return false;
        }
        Enumeration oids = extensions.oids();
        while (oids.hasMoreElements()) {
    ...
    public final void verify(PublicKey publicKey) throws CertificateException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException {
        Signature signature;
        String signatureName = X509SignatureUtil.getSignatureName(this.f6142c.getSignatureAlgorithm());
        try {
