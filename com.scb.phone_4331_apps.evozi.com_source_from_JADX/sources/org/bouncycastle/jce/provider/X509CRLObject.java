...
public class X509CRLObject extends X509CRL {
    ...
    /* renamed from: c */
    private CertificateList f3219c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) throws CRLException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        if (this.f3219c.getSignatureAlgorithm().equals(this.f3219c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z) {
        ...
        if (getVersion() != 2 || (extensions = this.f3219c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f3219c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.isHashCodeSet || !x509CRLObject.isHashCodeSet || x509CRLObject.hashCodeValue == this.hashCodeValue) {
            return this.f3219c.equals(x509CRLObject.f3219c);
        }
        return false;
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f3219c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f3219c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f3219c.getIssuer().toASN1Primitive()));
    }

    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f3219c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f3219c.getNextUpdate() != null) {
            return this.f3219c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f3219c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f3219c.getSignature().getOctets();
    }

    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f3219c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            throw new CRLException(e.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f3219c.getThisUpdate().getDate();
    }

    public int getVersion() {
        return this.f3219c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        if (certificate.getType().equals("X.509")) {
            Enumeration revokedCertificateEnumeration = this.f3219c.getRevokedCertificateEnumeration();
            X500Name issuer = this.f3219c.getIssuer();
    ...
    public java.lang.String toString() {
        ...
        L_0x0093:
            ...
            goto L_0x0072
        L_0x009c:
            org.bouncycastle.asn1.x509.CertificateList r3 = r11.f3219c
