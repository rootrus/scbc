...
public class PKIXNameConstraintValidator {
    ...
    private Set intersectIPRange(byte[] bArr, byte[] bArr2) {
        ...
        return compareTo(max(minMaxIPs[0], minMaxIPs[2]), min(minMaxIPs[1], minMaxIPs[3])) == 1 ? Collections.EMPTY_SET : Collections.singleton(ipWithSubnetMask(m3589or(minMaxIPs[0], minMaxIPs[2]), m3589or(bArr4, bArr6)));
    }
    ...
    /* renamed from: or */
    private static byte[] m3589or(byte[] bArr, byte[] bArr2) {
    ...
    public String toString() {
        ...
        if (this.permittedSubtreesIP != null) {
            ...
            sb10.append(obj5);
            sb10.append(stringifyIPCollection(this.permittedSubtreesIP));
            sb10.append("\n");
            str = sb10.toString();
        }
        ...
        sb21.append(obj11);
        sb21.append(stringifyIPCollection(this.excludedSubtreesIP));
        sb21.append("\n");
