...
public class ComputeInField {
    ...
    private void substitute() throws RuntimeException {
        ...
        if (invElem != 0) {
            short[] sArr2 = this.f6356x;
            short[][] sArr3 = this.f6355A;
            sArr2[sArr3.length - 1] = GF2Field.multElem(sArr3[sArr3.length - 1][sArr3.length], invElem);
            int length = this.f6355A.length - 2;
            while (length >= 0) {
                short[][] sArr4 = this.f6355A;
                short s = sArr4[length][sArr4.length];
                for (int length2 = sArr4.length - 1; length2 > length; length2--) {
                    s = GF2Field.addElem(s, GF2Field.multElem(this.f6355A[length][length2], this.f6356x[length2]));
                }
                short invElem2 = GF2Field.invElem(this.f6355A[length][length]);
                if (invElem2 != 0) {
                    this.f6356x[length] = GF2Field.multElem(s, invElem2);
                    length--;
                } else {
    ...
    public short[][] inverse(short[][] sArr) {
        try {
            ...
            iArr[0] = length;
            this.f6355A = (short[][]) Array.newInstance(Short.TYPE, iArr);
            if (sArr.length == sArr[0].length) {
                for (int i = 0; i < sArr.length; i++) {
                    for (int i2 = 0; i2 < sArr.length; i2++) {
                        this.f6355A[i][i2] = sArr[i][i2];
                    }
                    for (int length2 = sArr.length; length2 < (sArr.length << 1); length2++) {
                        this.f6355A[i][length2] = 0;
                    }
                    this.f6355A[i][this.f6355A.length + i] = 1;
                }
                computeZerosUnder(true);
                for (int i3 = 0; i3 < this.f6355A.length; i3++) {
                    short invElem = GF2Field.invElem(this.f6355A[i3][i3]);
                    for (int i4 = i3; i4 < (this.f6355A.length << 1); i4++) {
                        short[] sArr2 = this.f6355A[i3];
                        sArr2[i4] = GF2Field.multElem(sArr2[i4], invElem);
                    }
                }
                computeZerosAbove();
                int length3 = this.f6355A.length;
                int[] iArr2 = new int[2];
                iArr2[1] = this.f6355A.length;
                iArr2[0] = length3;
                short[][] sArr3 = (short[][]) Array.newInstance(Short.TYPE, iArr2);
                for (int i5 = 0; i5 < this.f6355A.length; i5++) {
                    for (int length4 = this.f6355A.length; length4 < (this.f6355A.length << 1); length4++) {
                        sArr3[i5][length4 - this.f6355A.length] = this.f6355A[i5][length4];
                    }
                }
                return sArr3;
            }
    ...
    public short[] solveEquation(short[][] sArr, short[] sArr2) {
        try {
            if (sArr.length == sArr2.length) {
                ...
                iArr[0] = length;
                this.f6355A = (short[][]) Array.newInstance(Short.TYPE, iArr);
                this.f6356x = new short[sArr.length];
                for (int i = 0; i < sArr.length; i++) {
                    for (int i2 = 0; i2 < sArr[0].length; i2++) {
                        this.f6355A[i][i2] = sArr[i][i2];
                    }
                ...
                for (int i3 = 0; i3 < sArr2.length; i3++) {
                    this.f6355A[i3][sArr2.length] = GF2Field.addElem(sArr2[i3], this.f6355A[i3][sArr2.length]);
                }
