...
public class SPHINCS256Signer implements MessageSigner {
    ...
    static void compute_authpath_wots(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2, int i, Tree.leafaddr leafaddr, byte[] bArr3, byte[] bArr4, int i2) {
        ...
        while (leafaddr3.subleaf < 32) {
            Seed.get_seed(hashFunctions2, bArr6, (int) (leafaddr3.subleaf << 5), bArr3, leafaddr3);
            leafaddr3.subleaf++;
        }
        ...
        leafaddr3.subleaf = 0;
        while (leafaddr3.subleaf < 32) {
            wots.wots_pkgen(hashFunctions2, bArr7, (int) ((leafaddr3.subleaf * 67) << 5), bArr6, (int) (leafaddr3.subleaf << 5), bArr4, 0);
            leafaddr3.subleaf++;
            HashFunctions hashFunctions4 = hashFunctions2;
        }
        leafaddr3.subleaf = 0;
        while (leafaddr3.subleaf < 32) {
            Tree.l_tree(hashFunctions2, bArr5, (int) ((leafaddr3.subleaf << 5) + 1024), bArr7, (int) ((leafaddr3.subleaf * 67) << 5), bArr4, 0);
            leafaddr3.subleaf++;
        }
        int i3 = 0;
        for (int i4 = 32; i4 > 0; i4 >>>= 1) {
            for (int i5 = 0; i5 < i4; i5 += 2) {
                hashFunctions2.hash_2n_n_mask(bArr5, ((i4 >>> 1) << 5) + ((i5 >>> 1) << 5), bArr5, (i4 << 5) + (i5 << 5), bArr4, ((i3 + 7) << 1) << 5);
            }
            i3++;
        }
        ...
        for (int i8 = 0; i8 < i7; i8++) {
            System.arraycopy(bArr5, ((32 >>> i8) << 5) + (((i6 >>> i8) ^ 1) << 5), bArr2, i + (i8 << 5), 32);
        }
    ...
    static void validate_authpath(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2, int i, byte[] bArr3, int i2, byte[] bArr4, int i3) {
        ...
        while (i9 < i3 - 1) {
            int i11 = i10 >>> 1;
            if ((i11 & 1) != 0) {
                hashFunctions2.hash_2n_n_mask(bArr5, 32, bArr5, 0, bArr4, ((i9 + 7) << 1) << 5);
                for (int i12 = 0; i12 < 32; i12++) {
                    bArr5[i12] = bArr3[i8 + i12];
                }
            } else {
                hashFunctions2.hash_2n_n_mask(bArr5, 0, bArr5, 0, bArr4, ((i9 + 7) << 1) << 5);
        ...
        hashFunctions2.hash_2n_n_mask(bArr, 0, bArr5, 0, bArr4, (((i3 + 7) - 1) << 1) << 5);
    }
    ...
    public byte[] crypto_sign(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2) {
        ...
        for (int i2 = 0; i2 != 8; i2++) {
            jArr[i2] = Pack.littleEndianToLong(bArr11, i2 << 3);
        }
        ...
        for (int i4 = 0; i4 < 8; i4++) {
            bArr4[i4 + 32] = (byte) ((int) ((j >>> (i4 << 3)) & 255));
        }
        byte[] bArr19 = bArr15;
        Seed.get_seed(hashFunctions3, bArr19, 0, bArr17, leafaddr2);
        new Horst();
        byte[] bArr20 = bArr17;
        int horst_sign = Horst.horst_sign(hashFunctions2, bArr4, 40, bArr16, bArr19, bArr18, bArr6);
        Wots wots = new Wots();
        ...
        for (int i7 = 12; i6 < i7; i7 = 12) {
            ...
            int i8 = i5;
            byte[] bArr22 = bArr18;
            wots.wots_sign(hashFunctions2, bArr21, i5, bArr16, bArr19, bArr22);
            int i9 = i8 + 2144;
            compute_authpath_wots(hashFunctions2, bArr16, bArr21, i9, leafaddr2, bArr20, bArr22, 5);
            i5 = i9 + 160;
