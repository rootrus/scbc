...
public class McElieceCCA2PublicKey extends ASN1Object {
    ...
    /* renamed from: g */
    private final GF2Matrix f6271g;

    /* renamed from: n */
    private final int f6272n;

    /* renamed from: t */
    private final int f6273t;

    public McElieceCCA2PublicKey(int i, int i2, GF2Matrix gF2Matrix, AlgorithmIdentifier algorithmIdentifier) {
        this.f6272n = i;
        this.f6273t = i2;
        this.f6271g = new GF2Matrix(gF2Matrix.getEncoded());
        this.digest = algorithmIdentifier;
    }

    private McElieceCCA2PublicKey(ASN1Sequence aSN1Sequence) {
        this.f6272n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).getValue().intValue();
        this.f6273t = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
        this.f6271g = new GF2Matrix(((ASN1OctetString) aSN1Sequence.getObjectAt(2)).getOctets());
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer((long) this.f6272n));
        aSN1EncodableVector.add(new ASN1Integer((long) this.f6273t));
        aSN1EncodableVector.add(new DEROctetString(this.f6271g.getEncoded()));
