...
public class McEliecePrivateKey extends ASN1Object {
    ...
    private McEliecePrivateKey(ASN1Sequence aSN1Sequence) {
        this.f6275n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).getValue().intValue();
        this.f6274k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer((long) this.f6275n));
        aSN1EncodableVector.add(new ASN1Integer((long) this.f6274k));
