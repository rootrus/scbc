...
public class GMSSPrivateKey extends ASN1Object {
    ...
    private ASN1Primitive encode(int[] iArr, byte[][] bArr, byte[][] bArr2, byte[][][] bArr3, byte[][][] bArr4, byte[][][] bArr5, Treehash[][] treehashArr, Treehash[][] treehashArr2, Vector[] vectorArr, Vector[] vectorArr2, Vector[][] vectorArr3, Vector[][] vectorArr4, GMSSLeaf[] gMSSLeafArr, GMSSLeaf[] gMSSLeafArr2, GMSSLeaf[] gMSSLeafArr3, int[] iArr2, byte[][] bArr6, GMSSRootCalc[] gMSSRootCalcArr, byte[][] bArr7, GMSSRootSig[] gMSSRootSigArr, GMSSParameters gMSSParameters, AlgorithmIdentifier[] algorithmIdentifierArr) {
        ...
        while (i29 < gMSSRootCalcArr2.length) {
            ...
            ASN1EncodableVector aSN1EncodableVector59 = aSN1EncodableVector52;
            ASN1EncodableVector aSN1EncodableVector60 = aSN1EncodableVector53;
            ...
            if (gMSSRootCalcArr2[i29].getRetain() != null) {
                for (int i40 = 0; i40 < gMSSRootCalcArr2[i29].getRetain().length; i40++) {
                    for (int i41 = 0; i41 < gMSSRootCalcArr2[i29].getRetain()[i40].size(); i41++) {
                        aSN1EncodableVector61.add(new DEROctetString((byte[]) gMSSRootCalcArr2[i29].getRetain()[i40].elementAt(i41)));
                    }
                    aSN1EncodableVector51.add(new DERSequence(aSN1EncodableVector61));
            ...
            i29++;
            aSN1EncodableVector48 = aSN1EncodableVector59;
            aSN1EncodableVector49 = aSN1EncodableVector60;
            algorithmIdentifierArr3 = algorithmIdentifierArr;
        }
        aSN1EncodableVector43.add(new DERSequence(aSN1EncodableVector46));
        ASN1EncodableVector aSN1EncodableVector62 = new ASN1EncodableVector();
        byte[][] bArr18 = bArr7;
        for (byte[] dEROctetString7 : bArr18) {
            aSN1EncodableVector62.add(new DEROctetString(dEROctetString7));
        }
        aSN1EncodableVector43.add(new DERSequence(aSN1EncodableVector62));
        ...
        for (int i42 = 0; i42 < gMSSRootSigArr2.length; i42++) {
            aSN1EncodableVector64.add(new DERSequence((ASN1Encodable) algorithmIdentifierArr[0]));
            new ASN1EncodableVector();
            aSN1EncodableVector65.add(new DEROctetString(gMSSRootSigArr2[i42].getStatByte()[0]));
            aSN1EncodableVector65.add(new DEROctetString(gMSSRootSigArr2[i42].getStatByte()[1]));
            aSN1EncodableVector65.add(new DEROctetString(gMSSRootSigArr2[i42].getStatByte()[2]));
            aSN1EncodableVector65.add(new DEROctetString(gMSSRootSigArr2[i42].getStatByte()[3]));
            aSN1EncodableVector65.add(new DEROctetString(gMSSRootSigArr2[i42].getStatByte()[4]));
            aSN1EncodableVector64.add(new DERSequence(aSN1EncodableVector65));
            aSN1EncodableVector65 = new ASN1EncodableVector();
            aSN1EncodableVector66.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[0]));
            aSN1EncodableVector66.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[1]));
            aSN1EncodableVector66.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[2]));
            aSN1EncodableVector66.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[3]));
            aSN1EncodableVector66.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[4]));
            aSN1EncodableVector66.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[5]));
            aSN1EncodableVector66.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[6]));
            aSN1EncodableVector66.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[7]));
            aSN1EncodableVector66.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[8]));
        ...
        aSN1EncodableVector43.add(new DERSequence(aSN1EncodableVector63));
        ...
        for (int i43 = 0; i43 < gMSSParameters.getHeightOfTrees().length; i43++) {
            aSN1EncodableVector68.add(new ASN1Integer((long) gMSSParameters.getHeightOfTrees()[i43]));
            aSN1EncodableVector69.add(new ASN1Integer((long) gMSSParameters.getWinternitzParameter()[i43]));
            aSN1EncodableVector70.add(new ASN1Integer((long) gMSSParameters.getK()[i43]));
        }
        aSN1EncodableVector67.add(new ASN1Integer((long) gMSSParameters.getNumOfLayers()));
        ...
        aSN1EncodableVector67.add(new DERSequence(aSN1EncodableVector70));
        aSN1EncodableVector43.add(new DERSequence(aSN1EncodableVector67));
        ASN1EncodableVector aSN1EncodableVector71 = new ASN1EncodableVector();
        for (AlgorithmIdentifier add : algorithmIdentifierArr4) {
            aSN1EncodableVector71.add(add);
        }
        aSN1EncodableVector43.add(new DERSequence(aSN1EncodableVector71));
        return new DERSequence(aSN1EncodableVector43);
    }
