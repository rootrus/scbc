...
public final class BigEndianConversions {
    ...
    public static int OS2IP(byte[] bArr, int i) {
        int i2 = i + 1;
        int i3 = i2 + 1;
        return (bArr[i3 + 1] & 255) | ((bArr[i] & 255) << Ascii.CAN) | ((bArr[i2] & 255) << 16) | ((bArr[i3] & 255) << 8);
    }
    ...
    public static long OS2LIP(byte[] bArr, int i) {
        ...
        int i7 = i6 + 1;
        long j5 = (long) ((bArr[i6] & 255) << 16);
        long j6 = (long) ((bArr[i7] & 255) << 8);
        return ((((long) bArr[i]) & 255) << 56) | ((j & 255) << 48) | ((j2 & 255) << 40) | ((j3 & 255) << 32) | ((j4 & 255) << 24) | j5 | j6 | ((long) (bArr[i7 + 1] & 255));
    }
