...
public final class LittleEndianConversions {
    ...
    public static int OS2IP(byte[] bArr, int i) {
        int i2 = i + 1;
        int i3 = i2 + 1;
        return ((bArr[i3 + 1] & 255) << Ascii.CAN) | (bArr[i] & 255) | ((bArr[i2] & 255) << 8) | ((bArr[i3] & 255) << 16);
    }
    ...
    public static long OS2LIP(byte[] bArr, int i) {
        int i2 = i + 1;
        int i3 = i2 + 1;
        long j = (long) ((bArr[i2] & 255) << 8);
        int i4 = i3 + 1;
        long j2 = (long) ((bArr[i3] & 255) << 16);
        int i5 = i4 + 1;
        long j3 = (long) bArr[i4];
        int i6 = i5 + 1;
        long j4 = (long) bArr[i5];
        int i7 = i6 + 1;
        return ((long) (bArr[i] & 255)) | j | j2 | ((j3 & 255) << 24) | ((j4 & 255) << 32) | ((((long) bArr[i6]) & 255) << 40) | ((((long) bArr[i7]) & 255) << 48) | ((((long) bArr[i7 + 1]) & 255) << 56);
    }
