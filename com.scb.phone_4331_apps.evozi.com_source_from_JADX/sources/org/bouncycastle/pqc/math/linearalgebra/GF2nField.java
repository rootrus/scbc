            ...
            if (i < i3) {
                ...
                while (i3 > 0) {
                    for (int i9 = i3 - 1; i9 >= 0; i9--) {
                        if (gF2PolynomialArr2[i9].testBit((this.mDegree - 1) - i3)) {
                            gF2PolynomialArr2[i9].addToThis(gF2PolynomialArr2[i3]);
                            gF2PolynomialArr3[i9].addToThis(gF2PolynomialArr3[i3]);
                        }
                    }
                    i3--;
                }
