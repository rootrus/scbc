                ...
                if (i3 == bArr.length - 8) {
                    ...
                    for (int i8 = 0; i8 < this.numRows; i8++) {
                        ...
                        while (i10 < (i7 & 31)) {
                            ...
                            iArr2[i6] = iArr2[i6] ^ ((bArr[i4] & 255) << i10);
                            i10 += 8;
                            i4++;
                        }
                    }
                ...
                for (int i11 = i2 - 1; i11 >= 0; i11--) {
                    if ((gF2Matrix2.matrix[i11][i10] & (1 << (i2 & 31))) != 0) {
                        for (int i12 = i10; i12 < i3; i12++) {
                            ...
                            int[] iArr6 = iArr5[i11];
                            iArr6[i12] = iArr5[i2][i12] ^ iArr6[i12];
                        }
                    }
                }
            } else {
        ...
        if (this.numColumns > this.numRows) {
            ...
            for (int i4 = this.numRows - 1; i4 >= 0; i4--) {
                ...
                if (i3 != 0) {
                    ...
                    int i8 = i6 + 1;
                    iArr4[i] = iArr5[i4][i6] >>> i3;
                    if (i8 < this.length) {
                        int[] iArr6 = iArr3[i4];
                        iArr6[i] = iArr6[i] | (iArr5[i4][i8] << (32 - i3));
                    }
                } else {
        ...
        if (!(vector2 instanceof GF2Vector)) {
            ...
            for (int i3 = 0; i3 < this.numRows; i3++) {
                ...
                if (i2 != 0) {
                    ...
                    i6 ^= i11 & this.matrix[i3][this.length - 1];
                } else {
                    while (i8 < this.length) {
                        i6 ^= this.matrix[i3][i8] & vecArray[i7];
                        i8++;
                        i7++;
                    }
                }
