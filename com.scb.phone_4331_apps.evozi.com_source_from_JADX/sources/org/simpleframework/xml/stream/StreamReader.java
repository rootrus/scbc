...
class StreamReader implements EventReader {
    ...
    static class Entry extends EventAttribute {
    ...
    static class Start extends EventElement {
    ...
    static class Text extends EventToken {
    ...
    static class End extends EventToken {
