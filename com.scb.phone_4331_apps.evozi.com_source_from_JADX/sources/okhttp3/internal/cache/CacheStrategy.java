        ...
        public Factory(long j, Request request2, Response response) {
            ...
            if (response != null) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (GoodToKnowActivity.MediaBrowserCompat$CustomActionResultReceiver(name, "Date", true)) {
                        this.servedDate = DatesKt.toHttpDateOrNull(value);
                        this.servedDateString = value;
                    } else if (GoodToKnowActivity.MediaBrowserCompat$CustomActionResultReceiver(name, "Expires", true)) {
                        this.expires = DatesKt.toHttpDateOrNull(value);
                    } else if (GoodToKnowActivity.MediaBrowserCompat$CustomActionResultReceiver(name, "Last-Modified", true)) {
                        this.lastModified = DatesKt.toHttpDateOrNull(value);
                        this.lastModifiedString = value;
                    } else if (GoodToKnowActivity.MediaBrowserCompat$CustomActionResultReceiver(name, "ETag", true)) {
                        this.etag = value;
                    } else if (GoodToKnowActivity.MediaBrowserCompat$CustomActionResultReceiver(name, "Age", true)) {
