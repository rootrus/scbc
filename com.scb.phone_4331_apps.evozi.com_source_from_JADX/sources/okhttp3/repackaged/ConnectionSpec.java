...
public final class ConnectionSpec {
    ...
    static {
        ConnectionSpec build = new Builder(true).cipherSuites(ahq).tlsVersions(TlsVersion.TLS_1_2, TlsVersion.TLS_1_1, TlsVersion.TLS_1_0).supportsTlsExtensions(true).build();
        MODERN_TLS = build;
    ...
    public final void apply(SSLSocket sSLSocket, boolean z) {
        ConnectionSpec a = m5808a(sSLSocket, z);
    ...
    /* renamed from: a */
    private ConnectionSpec m5808a(SSLSocket sSLSocket, boolean z) {
        String[] strArr;
        String[] strArr2;
    ...
    public final boolean isCompatible(SSLSocket sSLSocket) {
        ...
        String[] strArr = this.tlsVersions;
        if (strArr != null && !m5810a(strArr, sSLSocket.getEnabledProtocols())) {
            return false;
        }
        String[] strArr2 = this.cipherSuites;
        if (strArr2 == null || m5810a(strArr2, sSLSocket.getEnabledCipherSuites())) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: a */
    private static boolean m5810a(String[] strArr, String[] strArr2) {
