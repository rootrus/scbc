...
public final class ScriptGroup extends BaseObj {
    ...
    static class C5532IO {
        Allocation mAllocation;
        Script.KernelID mKID;

        C5532IO(Script.KernelID kernelID) {
            this.mKID = kernelID;
        }
    }
    ...
    public static final class Closure extends BaseObj {
        ...
        public final Future getGlobal(Script.FieldID fieldID) {
        ...
        public final void setArg(int i, Object obj) {
            if (obj instanceof Future) {
                obj = ((Future) obj).getValue();
            }
            this.mArgs[i] = obj;
        ...
        /* access modifiers changed from: package-private */
        public final void setGlobal(Script.FieldID fieldID, Object obj) {
            if (obj instanceof Future) {
                obj = ((Future) obj).getValue();
            }
    ...
    public static final class Future {
        ...
        /* access modifiers changed from: package-private */
        public final Script.FieldID getFieldID() {
    ...
    public static final class Input {
        ...
        /* access modifiers changed from: package-private */
        public final void addReference(Closure closure, int i) {
            this.mArgIndex.add(Pair.create(closure, Integer.valueOf(i)));
        }

        /* access modifiers changed from: package-private */
        public final void addReference(Closure closure, Script.FieldID fieldID) {
            ...
            if (this.mNodes.size() != 0) {
                ...
                for (int i3 = 0; i3 < this.mNodes.size(); i3++) {
                    ...
                    while (i4 < node.mKernels.size()) {
                        ...
                        boolean z = false;
                        for (int i5 = 0; i5 < node.mInputs.size(); i5++) {
                            if (node.mInputs.get(i5).mToK == kernelID) {
                                z = true;
                            }
                        }
                        boolean z2 = false;
                        for (int i6 = 0; i6 < node.mOutputs.size(); i6++) {
                            if (node.mOutputs.get(i6).mFrom == kernelID) {
                                z2 = true;
                            }
                        }
                        if (!z) {
                            arrayList.add(new C5532IO(kernelID));
                        }
                        if (!z2) {
                            arrayList2.add(new C5532IO(kernelID));
                        }
                        i4++;
                        i2++;
                    }
                ...
                if (i2 == this.mKernelCount) {
                    ...
                    if (!this.mUseIncSupp) {
                        ...
                        for (int i7 = 0; i7 < this.mLines.size(); i7++) {
                            ConnectLine connectLine = this.mLines.get(i7);
                    ...
                    scriptGroup.mOutputs = new C5532IO[arrayList2.size()];
                    for (int i8 = 0; i8 < arrayList2.size(); i8++) {
                        scriptGroup.mOutputs[i8] = (C5532IO) arrayList2.get(i8);
                    }
                    scriptGroup.mInputs = new C5532IO[arrayList.size()];
                    for (int i9 = 0; i9 < arrayList.size(); i9++) {
                        scriptGroup.mInputs[i9] = (C5532IO) arrayList.get(i9);
                    }
    ...
    public static final class Binding {
        ...
        public final Script.FieldID getField() {
            return this.mField;
        }
    ...
    public static final class Builder2 {
        ...
        public final Closure addKernel(Script.KernelID kernelID, Type type, Object... objArr) {
            ArrayList arrayList = new ArrayList();
        ...
        public final Closure addInvoke(Script.InvokeID invokeID, Object... objArr) {
            ArrayList arrayList = new ArrayList();
            HashMap hashMap = new HashMap();
            if (!seperateArgsAndBindings(objArr, arrayList, hashMap)) {
                return null;
