...
public class Script extends BaseObj {
    ...
    public void forEach(int i, Allocation allocation, Allocation allocation2, FieldPacker fieldPacker) {
        ...
        this.mRS.nScriptForEach(getID(this.mRS), i, id, j, bArr2, this.mUseIncSupp);
    }
    ...
    public void forEach(int i, Allocation allocation, Allocation allocation2, FieldPacker fieldPacker, LaunchOptions launchOptions) {
        ...
        if (allocation3 == null && allocation4 == null) {
            ...
            this.mRS.nScriptForEachClipped(getID(this.mRS), i, id, j, bArr2, launchOptions.xstart, launchOptions.xend, launchOptions.ystart, launchOptions.yend, launchOptions.zstart, launchOptions.zend, this.mUseIncSupp);
        }
    }
