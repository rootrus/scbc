...
/* renamed from: o.setSupportAllCaps */
public class setSupportAllCaps<K, V> {
    ...
    public setSupportAllCaps(int i) {
        if (i > 0) {
            this.maxSize = i;
    ...
    public final V get(K r5) {
        ...
        L_0x0054:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: p040o.setSupportAllCaps.get(java.lang.Object):java.lang.Object");
    }
    ...
    public void trimToSize(int r5) {
        ...
        L_0x0071:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: p040o.setSupportAllCaps.trimToSize(int):void");
    }
    ...
    public final String toString() {
        ...
        synchronized (this) {
            ...
            format = String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(i != 0 ? (this.hitCount * 100) / i : 0)});
        }
        return format;
    }
}
