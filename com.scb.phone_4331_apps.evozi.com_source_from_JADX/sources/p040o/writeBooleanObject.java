...
/* renamed from: o.writeBooleanObject */
public final /* synthetic */ class writeBooleanObject implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ EasycashCommonReviewFragment.IconCompatParcelizer IconCompatParcelizer;

    public /* synthetic */ writeBooleanObject(EasycashCommonReviewFragment.IconCompatParcelizer iconCompatParcelizer) {
        this.IconCompatParcelizer = iconCompatParcelizer;
    }

    public final Object write(Object obj) {
        EasycashCommonReviewFragment.IconCompatParcelizer iconCompatParcelizer = this.IconCompatParcelizer;
        zzsj zzsj = (zzsj) obj;
        show show = new show(zzsj.MediaBrowserCompat$CustomActionResultReceiver);
        zzsj.MediaBrowserCompat$CustomActionResultReceiver = (List) new show(show.write, new getNextTransition(show.IconCompatParcelizer, new MyECouponViewHolder.write(iconCompatParcelizer))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
