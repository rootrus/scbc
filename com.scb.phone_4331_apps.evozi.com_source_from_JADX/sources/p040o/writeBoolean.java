...
import com.scb.phone.view.activity.search.C5713xefa25e3;
...
/* renamed from: o.writeBoolean */
public final /* synthetic */ class writeBoolean implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ zzvf MediaBrowserCompat$ItemReceiver;
    private final /* synthetic */ String read;
    private final /* synthetic */ EasycashCommonReviewFragment.IconCompatParcelizer write;

    public /* synthetic */ writeBoolean(EasycashCommonReviewFragment.IconCompatParcelizer iconCompatParcelizer, String str, zzvf zzvf) {
    ...
    public final Object write(Object obj) {
        EasycashCommonReviewFragment.IconCompatParcelizer iconCompatParcelizer = this.write;
        String str = this.read;
        zzvf zzvf = this.MediaBrowserCompat$ItemReceiver;
        show show = new show(((zzsj) obj).MediaBrowserCompat$CustomActionResultReceiver);
        show show2 = new show(show.write, new getNextTransition(show.IconCompatParcelizer, new C5713xefa25e3(iconCompatParcelizer, str)));
        return (List) new show(show2.write, new getSharedElementEnterTransition(show2.IconCompatParcelizer, new ExportCardStatementSelectionAdapter.write(iconCompatParcelizer, zzvf))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
