...
/* renamed from: o.CoreComponentFactory */
final class CoreComponentFactory {
    private static final boolean IconCompatParcelizer;
    private static final boolean MediaBrowserCompat$CustomActionResultReceiver = (Build.VERSION.SDK_INT >= 18);
    private static final boolean read = (Build.VERSION.SDK_INT >= 19);
    ...
    static android.view.View MediaBrowserCompat$ItemReceiver(android.view.ViewGroup r17, android.view.View r18, android.view.View r19) {
        /*
            r0 = r17
            r1 = r18
            ...
            p040o.setFillViewport.write((android.view.View) r1, (android.graphics.Matrix) r2)
            p040o.setFillViewport.MediaBrowserCompat$ItemReceiver(r0, r2)
        ...
        L_0x006b:
            ...
            r11 = r9
        L_0x006d:
            boolean r12 = MediaBrowserCompat$CustomActionResultReceiver
            r13 = 0
        ...
        L_0x0090:
            ...
            boolean r3 = IconCompatParcelizer
        ...
        L_0x00e3:
            ...
            r1.draw(r3)
        L_0x00f4:
            boolean r2 = MediaBrowserCompat$CustomActionResultReceiver
        ...
        L_0x0109:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: p040o.CoreComponentFactory.MediaBrowserCompat$ItemReceiver(android.view.ViewGroup, android.view.View, android.view.View):android.view.View");
    }

    static Animator read(Animator animator, Animator animator2) {
        if (animator == null) {
            return animator2;
        }
        if (animator2 == null) {
