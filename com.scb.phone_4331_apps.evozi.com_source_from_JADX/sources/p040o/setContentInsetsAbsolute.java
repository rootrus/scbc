...
/* renamed from: o.setContentInsetsAbsolute */
public final class setContentInsetsAbsolute {
    public static void write(ListView listView, int i) {
        View childAt;
    ...
    public static boolean MediaBrowserCompat$ItemReceiver(ListView listView, int i) {
        if (Build.VERSION.SDK_INT >= 19) {
