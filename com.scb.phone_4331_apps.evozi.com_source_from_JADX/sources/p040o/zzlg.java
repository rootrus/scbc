...
/* renamed from: o.zzlg */
public final /* synthetic */ class zzlg implements DirectDebitDeepLinkActivity {
    public static final /* synthetic */ zzlg MediaBrowserCompat$CustomActionResultReceiver = new zzlg();

    private /* synthetic */ zzlg() {
    }

    public final Object write(Object obj) {
        show show = new show(((PieChart) ((SingleDataEntity) obj).getData()).read);
        return (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, zzlb.write)).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
