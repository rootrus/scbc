...
/* renamed from: o.zzet */
public final /* synthetic */ class zzet implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ AccountTransferClient.zza read;

    public /* synthetic */ zzet(AccountTransferClient.zza zza) {
        this.read = zza;
    }

    public final Object write(Object obj) {
        AccountTransferClient.zza zza = this.read;
        setHasDashPattern sethasdashpattern = (setHasDashPattern) obj;
        show show = new show(sethasdashpattern.MediaBrowserCompat$SearchResultReceiver);
        Serialization.C37651.IconCompatParcelizer iconCompatParcelizer = new Serialization.C37651.IconCompatParcelizer(zza);
        isDraggable isdraggable = new isDraggable();
        isdraggable.write = sethasdashpattern.IconCompatParcelizer;
        isdraggable.read = sethasdashpattern.write;
        isdraggable.MediaBrowserCompat$ItemReceiver = sethasdashpattern.MediaBrowserCompat$MediaItem;
        isdraggable.MediaMetadataCompat = sethasdashpattern.MediaDescriptionCompat.IconCompatParcelizer();
        isdraggable.MediaBrowserCompat$CustomActionResultReceiver = (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, iconCompatParcelizer)).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        isdraggable.MediaSessionCompat$QueueItem = sethasdashpattern.MediaBrowserCompat$CustomActionResultReceiver;
        isdraggable.ParcelableVolumeInfo = sethasdashpattern.read;
        isdraggable.MediaSessionCompat$ResultReceiverWrapper = sethasdashpattern.MediaBrowserCompat$ItemReceiver;
        return isdraggable;
    }
}
