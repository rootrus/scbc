...
/* renamed from: o.getTokenWithNotification */
public final class getTokenWithNotification extends FragmentBuilder_BindSummaryFragment {
    private clearToken MediaBrowserCompat$CustomActionResultReceiver = new clearToken();

    public final setGeodesic IconCompatParcelizer(setComposition setcomposition) {
        setGeodesic write = setGeodesic.write();
        write.MediaBrowserCompat$CustomActionResultReceiver = setcomposition.MediaBrowserCompat$ItemReceiver;
        write.read = setcomposition.MediaBrowserCompat$CustomActionResultReceiver;
        clearToken cleartoken = this.MediaBrowserCompat$CustomActionResultReceiver;
        show show = new show(setcomposition.IconCompatParcelizer);
        write.MediaBrowserCompat$ItemReceiver = (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new findMinGrandChild$MediaBrowserCompat$CustomActionResultReceiver(cleartoken))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
