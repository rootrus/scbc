...
/* renamed from: o.isSuccess */
public final class isSuccess extends FragmentBuilder_BindSummaryFragment {
    public boolean MediaBrowserCompat$ItemReceiver;

    public final List<GeofencingRequest.Builder> read(List<MergePaths> list, boolean z) {
        this.MediaBrowserCompat$ItemReceiver = z;
        if (list == null) {
            list = new ArrayList<>();
        }
        show show = new show(list);
        return (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new closeLogFile$MediaBrowserCompat$CustomActionResultReceiver(this))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
