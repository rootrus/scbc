...
/* renamed from: o.gV */
public final /* synthetic */ class C9949gV implements DebitCardMarketConductDeepLinkActivity {
    ...
    public /* synthetic */ C9949gV(C4746he heVar, int i) {
    ...
    public final void IconCompatParcelizer(Object obj) {
        ...
        List<isSimulator> list = heVar.IconCompatParcelizer.MediaBrowserCompat$CustomActionResultReceiver((C5718x9357954a) obj).MediaBrowserCompat$CustomActionResultReceiver;
        show show = new show(list);
        C10000gu guVar = new C10000gu(heVar);
        heVar.MediaBrowserCompat$ItemReceiver = list.get(i);
        C9950gY gYVar = new C9950gY(heVar, (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, guVar)).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        if (heVar.RatingCompat != null) {
            gYVar.IconCompatParcelizer(heVar.RatingCompat);
        }
        if ("MCARD".equalsIgnoreCase(heVar.MediaBrowserCompat$ItemReceiver.f2878x50fd9e4a)) {
            heVar.IconCompatParcelizer(list);
        }
    }
}
