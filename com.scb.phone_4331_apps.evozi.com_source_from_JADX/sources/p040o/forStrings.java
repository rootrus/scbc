...
/* renamed from: o.forStrings */
public final /* synthetic */ class forStrings implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ C6150x69d72700 write;

    public /* synthetic */ forStrings(C6150x69d72700 remittanceCountrySelectionFragment$MediaBrowserCompat$ItemReceiver) {
        this.write = remittanceCountrySelectionFragment$MediaBrowserCompat$ItemReceiver;
    }

    public final Object write(Object obj) {
        Iterable iterable;
        PreLoadCheckActivity preLoadCheckActivity = this.write.ParcelableVolumeInfo;
        applyInvertedAddMask applyinvertedaddmask = (applyInvertedAddMask) ((SingleDataEntity) obj).getData();
        if (applyinvertedaddmask.IconCompatParcelizer != null) {
            iterable = applyinvertedaddmask.IconCompatParcelizer;
        } else {
            iterable = new ArrayList();
        }
        addAllLocationRequests addalllocationrequests = new addAllLocationRequests();
        show show = new show(iterable);
        addalllocationrequests.read = (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new C9989x990b9991(preLoadCheckActivity))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        return DebitCardResetOtpActivity.just(addalllocationrequests);
    }
}
