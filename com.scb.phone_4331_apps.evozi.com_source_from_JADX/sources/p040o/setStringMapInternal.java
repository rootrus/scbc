...
/* renamed from: o.setStringMapInternal */
public final /* synthetic */ class setStringMapInternal implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ C6150x69d72700 write;

    public /* synthetic */ setStringMapInternal(C6150x69d72700 remittanceCountrySelectionFragment$MediaBrowserCompat$ItemReceiver) {
        this.write = remittanceCountrySelectionFragment$MediaBrowserCompat$ItemReceiver;
    }

    public final Object write(Object obj) {
        Iterable iterable;
        Feature feature = this.write.MediaSessionCompat$QueueItem;
        getPreCompHeight getprecompheight = ((getPreCompWidth) obj).read;
        if (getprecompheight.MediaBrowserCompat$CustomActionResultReceiver != null) {
            iterable = getprecompheight.MediaBrowserCompat$CustomActionResultReceiver;
        } else {
            iterable = new ArrayList();
        }
        AutocompleteFilter autocompleteFilter = new AutocompleteFilter();
        show show = new show(iterable);
        autocompleteFilter.write = (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new C9778x802d794(feature))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        return DebitCardResetOtpActivity.just(autocompleteFilter);
    }
}
