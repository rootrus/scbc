...
/* renamed from: o.getLocalVersion */
public final /* synthetic */ class getLocalVersion implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ FragmentBuilder_BindSuccessQuickOperationFragment.IconCompatParcelizer MediaBrowserCompat$ItemReceiver;

    public /* synthetic */ getLocalVersion(FragmentBuilder_BindSuccessQuickOperationFragment.IconCompatParcelizer iconCompatParcelizer) {
        this.MediaBrowserCompat$ItemReceiver = iconCompatParcelizer;
    }

    public final Object write(Object obj) {
        GoogleApiManager.zab zab = this.MediaBrowserCompat$ItemReceiver.MediaBrowserCompat$CustomActionResultReceiver;
        show show = new show(((setAlignItems) ((SingleDataEntity) obj).getData()).MediaBrowserCompat$ItemReceiver);
        return DebitCardResetOtpActivity.just(new OnStreetViewPanoramaReadyCallback((List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new setUserLoggedIn$MediaBrowserCompat$CustomActionResultReceiver(zab))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
