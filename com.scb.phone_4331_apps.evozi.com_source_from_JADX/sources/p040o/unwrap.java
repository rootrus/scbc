...
/* renamed from: o.unwrap */
public final /* synthetic */ class unwrap implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ FragmentBuilder_BindSCBSRiskLevelFragment.read IconCompatParcelizer;

    public /* synthetic */ unwrap(FragmentBuilder_BindSCBSRiskLevelFragment.read read) {
        this.IconCompatParcelizer = read;
    }

    public final Object write(Object obj) {
        zaat zaat = this.IconCompatParcelizer.IconCompatParcelizer;
        setWebLineWidth setweblinewidth = (setWebLineWidth) ((SingleDataEntity) obj).getData();
        onExitAmbient MediaBrowserCompat$ItemReceiver = onExitAmbient.MediaBrowserCompat$ItemReceiver();
        GoogleApiManager.zaa zaa = zaat.MediaBrowserCompat$ItemReceiver;
        Iterable iterable = setweblinewidth.MediaBrowserCompat$CustomActionResultReceiver;
        if (iterable == null) {
            iterable = new ArrayList();
        }
        show show = new show(iterable);
        MediaBrowserCompat$ItemReceiver.read = (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new md5Hash.IconCompatParcelizer(zaa))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        MediaBrowserCompat$ItemReceiver.write = setweblinewidth.write;
        MediaBrowserCompat$ItemReceiver.MediaBrowserCompat$CustomActionResultReceiver = setweblinewidth.MediaBrowserCompat$ItemReceiver;
