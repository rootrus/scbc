...
/* renamed from: o.nAllocationSetSurface$MediaBrowserCompat$ItemReceiver */
public final class nAllocationSetSurface$MediaBrowserCompat$ItemReceiver implements getCarbonStrip {
    ...
    public final Iterable<setItemAnimator> MediaBrowserCompat$ItemReceiver() {
        return Collections.singletonList(setItemAnimator.COM);
    }
    ...
    public final void IconCompatParcelizer(Iterable<byte[]> iterable, getSubElementOffsetBytes getsubelementoffsetbytes, setItemAnimator setitemanimator) {
        for (byte[] createfrombitmap : iterable) {
            U64_3 u64_3 = new U64_3();
            getsubelementoffsetbytes.IconCompatParcelizer.add(u64_3);
            u64_3.IconCompatParcelizer(0, new createFromBitmap(createfrombitmap, (Charset) null));
        }
    }
}
