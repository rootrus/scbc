...
/* renamed from: o.zzfm */
public final /* synthetic */ class zzfm implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ dumpAll MediaBrowserCompat$CustomActionResultReceiver;

    public /* synthetic */ zzfm(dumpAll dumpall) {
        this.MediaBrowserCompat$CustomActionResultReceiver = dumpall;
    }

    public final Object write(Object obj) {
        dumpAll dumpall = this.MediaBrowserCompat$CustomActionResultReceiver;
        show show = new show((List) obj);
        return (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new C4826x70b9ed5f(dumpall))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
