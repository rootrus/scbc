...
/* renamed from: o.getSupplier */
public final class getSupplier extends constrainedListMultimap {
    private toShortArray read;

    @HmlPinActivity
    public getSupplier(Resources resources, SharedPreferences sharedPreferences, toShortArray toshortarray) {
        super(resources, sharedPreferences);
        this.read = toshortarray;
    }

    public final List<CrashlyticsReport.Session.Event.Application.Builder> IconCompatParcelizer(List<onInfoWindowLongClick> list, String str) {
        if (list == null || list.isEmpty()) {
            return new ArrayList();
        }
        show show = new show(list);
        show show2 = new show(show.write, new getNextTransition(show.IconCompatParcelizer, new getFile(str)));
        return (List) new show(show2.write, new getSharedElementEnterTransition(show2.IconCompatParcelizer, new openStream(this.read))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
