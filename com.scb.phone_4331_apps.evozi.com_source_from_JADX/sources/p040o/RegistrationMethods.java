...
/* renamed from: o.RegistrationMethods */
public class RegistrationMethods extends FragmentBuilder_BindSummaryFragment {

    /* renamed from: o.RegistrationMethods$Builder */
    public final class Builder extends FragmentBuilder_BindSummaryFragment {
        public final List<setMyLocationButtonEnabled> write(List<setExceptionParser> list) {
            if (list == null) {
                return new ArrayList();
            }
            show show = new show(list);
            return (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new C3033xccb9cca4(this))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
