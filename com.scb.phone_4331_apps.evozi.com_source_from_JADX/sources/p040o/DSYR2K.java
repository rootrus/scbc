...
/* renamed from: o.DSYR2K */
public class DSYR2K implements IdWorkflowActivity {
    ...
    private DSYR2K(byte b) {
        Bitmap.Config IconCompatParcelizer2 = SubsamplingScaleImageView.IconCompatParcelizer();
        if (IconCompatParcelizer2 != null) {
            this.IconCompatParcelizer = IconCompatParcelizer2;
        } else {
            this.IconCompatParcelizer = Bitmap.Config.RGB_565;
        }
    }

    /* JADX WARNING: Removed duplicated region for block: B:42:0x00c9 A[SYNTHETIC, Splitter:B:42:0x00c9] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final android.graphics.Bitmap IconCompatParcelizer(android.content.Context r9, android.net.Uri r10) throws java.lang.Exception {
        /*
            r8 = this;
            java.lang.String r0 = r10.toString()
            android.graphics.BitmapFactory$Options r1 = new android.graphics.BitmapFactory$Options
            r1.<init>()
            android.graphics.Bitmap$Config r2 = r8.IconCompatParcelizer
        ...
        L_0x00cc:
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: p040o.DSYR2K.IconCompatParcelizer(android.content.Context, android.net.Uri):android.graphics.Bitmap");
    }
}
