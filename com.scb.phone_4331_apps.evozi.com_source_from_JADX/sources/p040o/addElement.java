...
/* renamed from: o.addElement */
public final /* synthetic */ class addElement implements dump {
    private final /* synthetic */ nativeConfigure MediaBrowserCompat$CustomActionResultReceiver;

    public /* synthetic */ addElement(nativeConfigure nativeconfigure) {
    ...
    public final void MediaBrowserCompat$ItemReceiver(Object obj) {
        ...
        List<getCenter> list = ((getFadeIn) obj).IconCompatParcelizer;
        nativeconfigure.MediaSessionCompat$ResultReceiverWrapper = new ArrayList();
        show show = new show(list);
        show show2 = new show(show.write, new getNextTransition(show.IconCompatParcelizer, nativeSetName.IconCompatParcelizer));
        show show3 = new show(show2.write, new getTag(show2.IconCompatParcelizer, setCancelable.write(getPageImageFileName.MediaBrowserCompat$CustomActionResultReceiver)));
        show show4 = new show(show3.write, new getString(show3.IconCompatParcelizer, new nativeSetValue(nativeconfigure.MediaSessionCompat$ResultReceiverWrapper)));
        getFields getfields = new getFields((List) new show(show4.write, new getSharedElementEnterTransition(show4.IconCompatParcelizer, new getNumPages(nativeconfigure))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        if (nativeconfigure.RatingCompat != null) {
            getfields.IconCompatParcelizer(nativeconfigure.RatingCompat);
        }
    }
}
