...
/* renamed from: o.zzbh */
public final /* synthetic */ class zzbh implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ BankingAgentReviewActivity IconCompatParcelizer;

    public /* synthetic */ zzbh(BankingAgentReviewActivity bankingAgentReviewActivity) {
        this.IconCompatParcelizer = bankingAgentReviewActivity;
    }

    public final Object write(Object obj) {
        isSidewinderDevice issidewinderdevice = this.IconCompatParcelizer.MediaSessionCompat$QueueItem;
        List<LayerParser> list = ((MaskParser) ((SingleDataEntity) obj).getData()).MediaBrowserCompat$ItemReceiver;
        if (list == null) {
            return new ArrayList();
        }
        show read = new show(list).read(new SettingsController$MediaBrowserCompat$ItemReceiver(issidewinderdevice));
        return (List) new show(read.write, new getSharedElementEnterTransition(read.IconCompatParcelizer, new AutoCrashlyticsReportEncoder.write(issidewinderdevice))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
