...
/* renamed from: o.forBoolean */
public final /* synthetic */ class forBoolean implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ C6150x69d72700 MediaBrowserCompat$ItemReceiver;

    public /* synthetic */ forBoolean(C6150x69d72700 remittanceCountrySelectionFragment$MediaBrowserCompat$ItemReceiver) {
        this.MediaBrowserCompat$ItemReceiver = remittanceCountrySelectionFragment$MediaBrowserCompat$ItemReceiver;
    }

    public final Object write(Object obj) {
        Iterable iterable;
        ensurePlayServicesAvailable ensureplayservicesavailable = this.MediaBrowserCompat$ItemReceiver.f3097x50fd9e4a;
        applyInvertedIntersectMask applyinvertedintersectmask = (applyInvertedIntersectMask) ((SingleDataEntity) obj).getData();
        if (applyinvertedintersectmask.MediaBrowserCompat$CustomActionResultReceiver != null) {
            iterable = applyinvertedintersectmask.MediaBrowserCompat$CustomActionResultReceiver;
        } else {
            iterable = new ArrayList();
        }
        addLocationRequest addlocationrequest = new addLocationRequest();
        show show = new show(iterable);
        addlocationrequest.MediaBrowserCompat$ItemReceiver = (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new getLogString$MediaBrowserCompat$CustomActionResultReceiver(ensureplayservicesavailable))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        return DebitCardResetOtpActivity.just(addlocationrequest);
    }
}
