...
/* renamed from: o.getRuntimeTypeIfMoreSpecific */
public class getRuntimeTypeIfMoreSpecific extends writeUInt64NoTag<IdCaptureModule_GetIExceptionResponseDeserializerRttiFactory.write> {
    private final String MediaBrowserCompat$ItemReceiver;
    private final List<AutoCrashlyticsReportEncoder.CrashlyticsReportSessionEventApplicationEncoder> read;
    public final SharedPreferences write;

    public getRuntimeTypeIfMoreSpecific(SharedPreferences sharedPreferences, String str, List<AutoCrashlyticsReportEncoder.CrashlyticsReportSessionEventApplicationEncoder> list) {
        super((RegularImmutableBiMap) null);
        this.write = sharedPreferences;
        this.MediaBrowserCompat$ItemReceiver = str;
        this.read = list;
    }

    public List<Integer> MediaBrowserCompat$CustomActionResultReceiver() {
        show read2 = new show(this.read).read(new TreeTypeAdapter.GsonContextImpl(this.write.getStringSet(this.MediaBrowserCompat$ItemReceiver, new LinkedHashSet())));
        return (List) new show(read2.write, new getSharedElementEnterTransition(read2.IconCompatParcelizer, newFactoryWithMatchRawType.write)).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
    ...
    public final void write() {
        ...
        TreeTypeAdapter treeTypeAdapter = TreeTypeAdapter.read;
        this.write.edit().putStringSet(this.MediaBrowserCompat$ItemReceiver, (Set) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, treeTypeAdapter)).write(new setupDialog.IconCompatParcelizer(new getArguments<Set<T>>() {
            /*  JADX ERROR: Method generation error
