...
import p040o.Registrar;
import p040o.proxyGetICheckDeserializerRtti;
import p040o.setupDialog;

/* renamed from: o.withClearedAuthToken */
public class withClearedAuthToken extends writeUInt64NoTag<proxyGetICheckDeserializerRtti.RatingCompat> {
    public setDaemon IconCompatParcelizer;
    private final newConcurrentMap MediaBrowserCompat$ItemReceiver;
    public logEventNoInterceptor read;
    final filterValues write;

    @HmlPinActivity
    public withClearedAuthToken(logEventNoInterceptor logeventnointerceptor, RegularImmutableBiMap regularImmutableBiMap, filterValues filtervalues, newConcurrentMap newconcurrentmap) {
        super(regularImmutableBiMap);
        this.read = logeventnointerceptor;
        this.write = filtervalues;
        this.MediaBrowserCompat$ItemReceiver = newconcurrentmap;
    }

    public final void write(boolean z) {
        show show = new show(this.IconCompatParcelizer.MediaMetadataCompat);
        show show2 = new show(show.write, new getNextTransition(show.IconCompatParcelizer, Registrar.zza.MediaBrowserCompat$ItemReceiver));
        GetAuthTokenListener getAuthTokenListener = new GetAuthTokenListener(this.MediaBrowserCompat$ItemReceiver.IconCompatParcelizer(this.IconCompatParcelizer, z), (List) new show(show2.write, new getSharedElementEnterTransition(show2.IconCompatParcelizer, new GetIdListener(this, z))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        if (this.RatingCompat != null) {
            getAuthTokenListener.IconCompatParcelizer(this.RatingCompat);
        }
    }
}
