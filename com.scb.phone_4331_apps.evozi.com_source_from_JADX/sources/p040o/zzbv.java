...
import com.scb.phone.view.custom.CustomDoubleCircleBorderView$MediaBrowserCompat$ItemReceiver;
import com.scb.phone.view.custom.MonthYearPickerDialog$MediaBrowserCompat$ItemReceiver;
import java.util.List;
import p040o.getMortgageTopupOffers;
import p040o.setupDialog;

/* renamed from: o.zzbv */
public final /* synthetic */ class zzbv implements DirectDebitDeepLinkActivity {
    ...
    private final /* synthetic */ zzvf write;

    public /* synthetic */ zzbv(clickShareSlip clickshareslip, String str, zzvf zzvf) {
    ...
    public final Object write(Object obj) {
        ...
        clickShareSlip clickshareslip = this.MediaBrowserCompat$ItemReceiver;
        String str = this.IconCompatParcelizer;
        zzvf zzvf = this.write;
        zzsj zzsj = (zzsj) obj;
        show show = new show(zzsj.MediaBrowserCompat$CustomActionResultReceiver);
        show show2 = new show(show.write, new getNextTransition(show.IconCompatParcelizer, new CustomDoubleCircleBorderView$MediaBrowserCompat$ItemReceiver(str)));
        ...
        boolean z = issupportfragmentclass.IconCompatParcelizer != null;
        show show3 = new show(zzsj.MediaBrowserCompat$CustomActionResultReceiver);
        show show4 = new show(show3.write, new getNextTransition(show3.IconCompatParcelizer, new MonthYearPickerDialog$MediaBrowserCompat$ItemReceiver(clickshareslip, str, z)));
        return (List) new show(show4.write, new getSharedElementEnterTransition(show4.IconCompatParcelizer, new getMortgageTopupOffers.IconCompatParcelizer(clickshareslip, zzvf))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
