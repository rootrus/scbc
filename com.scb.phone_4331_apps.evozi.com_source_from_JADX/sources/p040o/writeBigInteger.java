...
import com.scb.phone.view.activity.privacymanagement.C5705xbf27d648;
import com.scb.phone.view.fragment.easycash.EasycashCommonReviewFragment;
import java.util.List;
import p040o.setupDialog;

/* renamed from: o.writeBigInteger */
public final /* synthetic */ class writeBigInteger implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ EasycashCommonReviewFragment.IconCompatParcelizer read;

    public /* synthetic */ writeBigInteger(EasycashCommonReviewFragment.IconCompatParcelizer iconCompatParcelizer) {
        this.read = iconCompatParcelizer;
    }

    public final Object write(Object obj) {
        EasycashCommonReviewFragment.IconCompatParcelizer iconCompatParcelizer = this.read;
        zzsj zzsj = (zzsj) obj;
        show show = new show(zzsj.MediaBrowserCompat$CustomActionResultReceiver);
        zzsj.MediaBrowserCompat$CustomActionResultReceiver = (List) new show(show.write, new getNextTransition(show.IconCompatParcelizer, new C5705xbf27d648(iconCompatParcelizer))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
