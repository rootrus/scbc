...
/* renamed from: o.I32 */
public final class I32 extends createCubemapFromCubeFaces<I16_3> {
    public I32(I16_3 i16_3) {
        super(i16_3);
    }
    ...
    public final String MediaBrowserCompat$CustomActionResultReceiver(int i) {
        ...
        if (i == 2) {
            Integer MediaBrowserCompat$CustomActionResultReceiver = ((I16_3) this.write).MediaBrowserCompat$CustomActionResultReceiver(2);
            ...
            return String.format("Unknown (%d)", new Object[]{MediaBrowserCompat$CustomActionResultReceiver});
        } else if (i == 3) {
            Integer MediaBrowserCompat$CustomActionResultReceiver2 = ((I16_3) this.write).MediaBrowserCompat$CustomActionResultReceiver(3);
            ...
            switch (MediaBrowserCompat$CustomActionResultReceiver2.intValue()) {
                ...
                case 655519746:
                    return "SMX - C20N";
                default:
                    return String.format("Unknown (%d)", new Object[]{MediaBrowserCompat$CustomActionResultReceiver2});
            }
        } else if (i == 67) {
            return read(67, "%d C");
        } else {
            if (i == 256) {
                return MediaBrowserCompat$CustomActionResultReceiver(256, "Off", "On");
            }
            if (i != 288) {
                return super.MediaBrowserCompat$CustomActionResultReceiver(i);
            }
            return MediaBrowserCompat$CustomActionResultReceiver(288, "Off", "On");
        }
    }
}
