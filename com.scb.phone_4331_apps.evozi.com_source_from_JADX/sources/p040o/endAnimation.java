...
public final class endAnimation {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof endAnimation)) {
            return false;
        }
        endAnimation endanimation = (endAnimation) obj;
        return this.MediaSessionCompat$QueueItem == endanimation.MediaSessionCompat$QueueItem && onGetStartedClick.MediaBrowserCompat$ItemReceiver((Object) this.MediaBrowserCompat$SearchResultReceiver, (Object) endanimation.MediaBrowserCompat$SearchResultReceiver) && onGetStartedClick.MediaBrowserCompat$ItemReceiver((Object) this.MediaSessionCompat$Token, (Object) endanimation.MediaSessionCompat$Token) && onGetStartedClick.MediaBrowserCompat$ItemReceiver((Object) this.MediaBrowserCompat$CustomActionResultReceiver, (Object) endanimation.MediaBrowserCompat$CustomActionResultReceiver) && onGetStartedClick.MediaBrowserCompat$ItemReceiver((Object) this.MediaSessionCompat$ResultReceiverWrapper, (Object) endanimation.MediaSessionCompat$ResultReceiverWrapper) && onGetStartedClick.MediaBrowserCompat$ItemReceiver((Object) this.RatingCompat, (Object) endanimation.RatingCompat) && this.MediaBrowserCompat$ItemReceiver == endanimation.MediaBrowserCompat$ItemReceiver && this.MediaBrowserCompat$MediaItem == endanimation.MediaBrowserCompat$MediaItem && this.MediaDescriptionCompat == endanimation.MediaDescriptionCompat && onGetStartedClick.MediaBrowserCompat$ItemReceiver((Object) this.read, (Object) endanimation.read) && onGetStartedClick.MediaBrowserCompat$ItemReceiver((Object) this.IconCompatParcelizer, (Object) endanimation.IconCompatParcelizer) && this.write == endanimation.write && onGetStartedClick.MediaBrowserCompat$ItemReceiver((Object) this.MediaMetadataCompat, (Object) endanimation.MediaMetadataCompat);
    }
    ...
    public final int hashCode() {
        ...
        return (((((((((((((((((((((((i * 31) + hashCode) * 31) + hashCode2) * 31) + hashCode3) * 31) + hashCode4) * 31) + hashCode5) * 31) + (z ? 1 : 0)) * 31) + (z3 ? 1 : 0)) * 31) + (z4 ? 1 : 0)) * 31) + hashCode6) * 31) + hashCode7) * 31) + (z2 ? 1 : 0)) * 31) + i2;
    }

    public final String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("CreditPowerTileEntity(sortSequence=");
    ...
    /* renamed from: o.endAnimation$IconCompatParcelizer */
    ...
    public static List<setDataCollectionEnabled> MediaBrowserCompat$CustomActionResultReceiver(List<? extends LottieDrawable.C36224> list) {
        if (list == null) {
            return null;
        }
        show show = new show(list);
        return (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, IconCompatParcelizer.MediaBrowserCompat$ItemReceiver)).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
