...
import p040o.hasPublicSuffix;
import p040o.setupDialog;
import p040o.zzbt;

/* renamed from: o.zzgu$MediaBrowserCompat$CustomActionResultReceiver */
final class zzgu$MediaBrowserCompat$CustomActionResultReceiver<T, R> implements DirectDebitDeepLinkActivity<T, R> {
    private /* synthetic */ zzgu write;

    zzgu$MediaBrowserCompat$CustomActionResultReceiver(zzgu zzgu) {
        this.write = zzgu;
    }
    ...
    public final /* synthetic */ Object write(Object obj) {
        ...
        getAccountTypesSet getaccounttypesset = this.write.write;
        zzbt.zzf.zzb.IconCompatParcelizer iconCompatParcelizer = new zzbt.zzf.zzb.IconCompatParcelizer();
        show show = new show(((LottieCompositionFactory.C36075) singleDataEntity.getData()).MediaBrowserCompat$CustomActionResultReceiver);
        iconCompatParcelizer.read = (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new hasPublicSuffix.IconCompatParcelizer(getaccounttypesset))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        return new zzbt.zzf.zzb(iconCompatParcelizer, (byte) 0);
    }
}
