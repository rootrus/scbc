...
/* renamed from: o.zzby */
public final /* synthetic */ class zzby implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ clickShareSlip write;

    public /* synthetic */ zzby(clickShareSlip clickshareslip) {
        this.write = clickshareslip;
    }

    /* renamed from: o.zzby$zza */
    public final class zza {
        ...
        private zza(write write2) {
            ...
            this.MediaDescriptionCompat = write2.MediaBrowserCompat$MediaItem;
            this.MediaBrowserCompat$ItemReceiver = write2.MediaBrowserCompat$ItemReceiver;
            this.MediaMetadataCompat = write2.MediaMetadataCompat;
            this.MediaBrowserCompat$SearchResultReceiver = write2.MediaBrowserCompat$SearchResultReceiver;
            this.read = write2.read;
        }

        /* renamed from: o.zzby$zza$zza  reason: collision with other inner class name */
        public final class C10762zza extends TypeAdapter implements addKernel {
            private validateCycle MediaBrowserCompat$ItemReceiver;
            private validateDAGRecurse read;
            private Gson write;

            public C10762zza(Gson gson, validateCycle validatecycle, validateDAGRecurse validatedagrecurse) {
                this.write = gson;
            ...
            public final void write(JsonWriter jsonWriter, Object obj) throws IOException {
                ...
                zzb.zza zza = (zzb.zza) obj;
                Gson gson = this.write;
                validateDAGRecurse validatedagrecurse = this.read;
                jsonWriter.beginObject();
                if (zza != zza.write) {
                    validatedagrecurse.read(jsonWriter, 349);
                    String str = zza.write;
                    findNode.MediaBrowserCompat$ItemReceiver(gson, String.class, (Object) str).write(jsonWriter, str);
                }
                zza.MediaBrowserCompat$ItemReceiver(gson, jsonWriter, validatedagrecurse);
            ...
            public final Object read(JsonReader jsonReader) throws IOException {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    if (write2 != 258) {
                        zza.read(gson, jsonReader, write2);
                    } else if (z) {
        ...
        public final boolean equals(Object obj) {
            ...
            if (str == null ? zza.write == null : str.equals(zza.write)) {
                String str2 = this.IconCompatParcelizer;
                if (str2 == null ? zza.IconCompatParcelizer == null : str2.equals(zza.IconCompatParcelizer)) {
                    String str3 = this.MediaBrowserCompat$CustomActionResultReceiver;
                    if (str3 == null ? zza.MediaBrowserCompat$CustomActionResultReceiver == null : str3.equals(zza.MediaBrowserCompat$CustomActionResultReceiver)) {
                        read read2 = this.MediaMetadataCompat;
                        if (read2 == null ? zza.MediaMetadataCompat == null : read2.equals(zza.MediaMetadataCompat)) {
                            String str4 = this.MediaBrowserCompat$SearchResultReceiver;
                            if (str4 == null ? zza.MediaBrowserCompat$SearchResultReceiver == null : str4.equals(zza.MediaBrowserCompat$SearchResultReceiver)) {
                                String str5 = this.read;
                                if (str5 != null) {
                                    if (str5.equals(zza.read)) {
                                        return true;
                                    }
                                } else if (zza.read == null) {
                                    return true;
                                }
                            }
                        }
    ...
    /* renamed from: o.zzby$zzc */
    public final class zzc {
        public final List<zzcb.zzb> MediaBrowserCompat$ItemReceiver;

        public final boolean equals(Object obj) {
            if (this != obj) {
                return (obj instanceof zzc) && onGetStartedClick.MediaBrowserCompat$ItemReceiver((Object) this.MediaBrowserCompat$ItemReceiver, (Object) ((zzc) obj).MediaBrowserCompat$ItemReceiver);
            }
            return true;
        }

        public final int hashCode() {
            List<zzcb.zzb> list = this.MediaBrowserCompat$ItemReceiver;
            if (list != null) {
        ...
        public final String toString() {
            ...
            sb.append("EasycashBusinessAndMaritalInfo(component=");
            sb.append(this.MediaBrowserCompat$ItemReceiver);
            sb.append(")");
            return sb.toString();
        }

        public zzc(List<zzcb.zzb> list) {
            onGetStartedClick.write((Object) list, "component");
            this.MediaBrowserCompat$ItemReceiver = list;
        }

        /* renamed from: o.zzby$zzc$zza */
        public final class zza {
            public final int hashCode() {
                return 0;
            }
            ...
            public final boolean equals(Object obj) {
                return this == obj || (obj instanceof zza);
            }
        }
    }

    /* renamed from: o.zzby$zzb */
    public class zzb {
        @SerializedName("documentCode")
        public List<zza> MediaBrowserCompat$ItemReceiver;

        /* renamed from: o.zzby$zzb$read */
        public static final class read {
            public List<zza> IconCompatParcelizer;
        }

        public /* synthetic */ zzb(read read2, byte b) {
            this(read2);
        }

        /* renamed from: o.zzby$zzb$zza */
        public class zza extends zzrm {
        ...
        public boolean equals(Object obj) {
            ...
            zzb zzb = (zzb) obj;
            List<zza> list = this.MediaBrowserCompat$ItemReceiver;
            if (list != null) {
                return list.equals(zzb.MediaBrowserCompat$ItemReceiver);
            }
            if (zzb.MediaBrowserCompat$ItemReceiver != null) {
                return false;
            }
            return true;
        }
    ...
    public final Object write(Object obj) {
        ...
        show show = new show(((setPageMargin) obj).MediaBrowserCompat$CustomActionResultReceiver);
        return (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new CustomTwoPicker.read(clickshareslip.IconCompatParcelizer))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
