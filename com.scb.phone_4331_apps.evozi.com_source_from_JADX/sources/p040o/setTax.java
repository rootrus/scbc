...
/* renamed from: o.setTax */
public final class setTax extends FragmentBuilder_BindSummaryFragment {
    public List<TouchPointInstructionActivity.IconCompatParcelizer> MediaBrowserCompat$ItemReceiver(List<SingleDataEntity<encodedHost>> list) {
        show show = new show(list);
        return (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new construct.write(this))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
