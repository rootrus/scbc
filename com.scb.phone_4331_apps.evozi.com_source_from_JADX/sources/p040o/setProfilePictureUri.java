...
import p040o.readLine;
import p040o.setCurrentScreen;
import p040o.setupDialog;

/* renamed from: o.setProfilePictureUri */
public class setProfilePictureUri extends FragmentBuilder_BindSummaryFragment {
    public static setCurrentScreen IconCompatParcelizer(setResult setresult) {
        setCurrentScreen.write write = new setCurrentScreen.write();
        write.MediaBrowserCompat$ItemReceiver = setresult.write;
        write.MediaBrowserCompat$CustomActionResultReceiver = setresult.MediaBrowserCompat$CustomActionResultReceiver;
        write.read = setresult.read;
        return new setCurrentScreen(write, (byte) 0);
    }

    public final List<logEvent> read(List<LottieListener> list) {
        show show = new show(list);
        return (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new readLine.read(this))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
