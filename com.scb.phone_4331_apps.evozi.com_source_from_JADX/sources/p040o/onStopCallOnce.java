...
/* renamed from: o.onStopCallOnce */
public final class onStopCallOnce extends GoogleAnalytics {
    public final List<zzrt> write(List<Registry$NoSourceEncoderAvailableException> list) {
        if (list == null) {
            return Collections.emptyList();
        }
        show show = new show(list);
        return (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new C3959x5a14f1ef(this))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
    ...
    public static zzuk read(setCurrentItemInternal setcurrentiteminternal) {
        return new zzuk().read(IconCompatParcelizer(setcurrentiteminternal));
    }

    public final List<zzur> IconCompatParcelizer(List<ImageHeaderParser$ImageType> list) {
        show show = new show(list);
        return (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new XVrsPhaseDetector.write(this))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
            /*  JADX ERROR: Method generation error
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: o.setupDialog.1.read():java.lang.Object, class status: UNLOADED
                	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
