...
/* renamed from: o.setForNewAccount */
public final class setForNewAccount extends FragmentBuilder_BindSummaryFragment {
    public final zzdq.zza MediaBrowserCompat$ItemReceiver(setSystemAnimationsAreEnabled setsystemanimationsareenabled) {
        zzdq.zza.write write = new zzdq.zza.write();
        show show = new show(setsystemanimationsareenabled.MediaBrowserCompat$CustomActionResultReceiver);
        write.read = (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new toStringBuilder.read(this))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        return new zzdq.zza(write, (byte) 0);
    }
}
