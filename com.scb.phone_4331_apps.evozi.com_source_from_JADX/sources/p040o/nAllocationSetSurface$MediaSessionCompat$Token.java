...
/* renamed from: o.nAllocationSetSurface$MediaSessionCompat$Token */
public final class nAllocationSetSurface$MediaSessionCompat$Token implements getCarbonStrip {
    ...
    public static void MediaBrowserCompat$CustomActionResultReceiver(copy1DRangeFromUnchecked copy1drangefromunchecked, int i, getSubElementOffsetBytes getsubelementoffsetbytes) {
        int i2;
        createVector createvector = new createVector();
        getsubelementoffsetbytes.IconCompatParcelizer.add(createvector);
        int i3 = 0;
        while (i3 < i) {
            try {
                ...
                short MediaBrowserCompat$ItemReceiver = (short) (copy1drangefromunchecked.MediaBrowserCompat$ItemReceiver() & 255);
                if (MediaBrowserCompat$ItemReceiver < 0 || (i2 = i3 + 4 + 2 + 1 + MediaBrowserCompat$ItemReceiver) > i) {
                    throw new ImageProcessingException("Invalid string length");
                }
                copy1drangefromunchecked.write((long) MediaBrowserCompat$ItemReceiver);
                if (i2 % 2 != 0) {
                ...
                byte[] IconCompatParcelizer = copy1drangefromunchecked.IconCompatParcelizer(MediaBrowserCompat$CustomActionResultReceiver);
                i3 = i2 + 4 + MediaBrowserCompat$CustomActionResultReceiver;
                if (i3 % 2 != 0) {
                    copy1drangefromunchecked.write(1);
                    i3++;
                }
                if (str.equals("8BIM")) {
                    if (RatingCompat == 1028) {
                        nAllocationSetSurface.read.write(new copyTo(IconCompatParcelizer), getsubelementoffsetbytes, (long) IconCompatParcelizer.length);
                    } else if (RatingCompat == 1039) {
                        nAllocationSetSurface.MediaBrowserCompat$CustomActionResultReceiver((C10820Allocation) new StaggeredGridLayoutManager(IconCompatParcelizer), getsubelementoffsetbytes);
                    } else if (RatingCompat == 1058 || RatingCompat == 1059) {
                        nClosureCreate.IconCompatParcelizer.IconCompatParcelizer(new StaggeredGridLayoutManager(IconCompatParcelizer), getsubelementoffsetbytes, 0, createvector);
                    } else if (RatingCompat == 1060) {
                        nScriptIntrinsicCreate.IconCompatParcelizer(IconCompatParcelizer, IconCompatParcelizer.length, getsubelementoffsetbytes);
                    } else {
                        createvector.MediaBrowserCompat$ItemReceiver(RatingCompat, IconCompatParcelizer);
                    }
                    if (RatingCompat >= 4000 && RatingCompat <= 4999) {
                        createVector.write.put(Integer.valueOf(RatingCompat), String.format("Plug-in %d Data", new Object[]{Integer.valueOf((RatingCompat - 4000) + 1)}));
                    }
                }
            } catch (Exception e) {
                createvector.IconCompatParcelizer.add(e.getMessage());
                return;
            }
        }
    }
    ...
    public final Iterable<setItemAnimator> MediaBrowserCompat$ItemReceiver() {
        return Collections.singletonList(setItemAnimator.APPD);
    }
    ...
    public final void IconCompatParcelizer(Iterable<byte[]> iterable, getSubElementOffsetBytes getsubelementoffsetbytes, setItemAnimator setitemanimator) {
        for (byte[] next : iterable) {
            if (next.length >= 14 && "Photoshop 3.0".equals(new String(next, 0, 13))) {
                MediaBrowserCompat$CustomActionResultReceiver(new copyTo(next, 14), (next.length - 13) - 1, getsubelementoffsetbytes);
            }
        }
    }
}
