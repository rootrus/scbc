...
/* renamed from: o.zabl */
public final class zabl extends FragmentBuilder_BindSummaryFragment {
    public static LocationSource.OnLocationChangedListener read(SingleDataEntity<setDrawWeb> singleDataEntity) {
        setDrawWeb data = singleDataEntity.getData();
        show show = new show(data.write);
        zabd zabd = zabd.read;
        show show2 = new show(data.IconCompatParcelizer);
        zabb zabb = zabb.MediaBrowserCompat$CustomActionResultReceiver;
        LocationSource.OnLocationChangedListener read = LocationSource.OnLocationChangedListener.read();
        read.MediaBrowserCompat$CustomActionResultReceiver = MapFragment.IconCompatParcelizer(data.MediaBrowserCompat$CustomActionResultReceiver);
        read.write = (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, zabd)).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        read.MediaBrowserCompat$ItemReceiver = (List) new show(show2.write, new getSharedElementEnterTransition(show2.IconCompatParcelizer, zabb)).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
            /*  JADX ERROR: Method generation error
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: o.setupDialog.1.read():java.lang.Object, class status: UNLOADED
                	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
...
*/
        ...
        read.read = data.MediaBrowserCompat$ItemReceiver;
        return read;
    }
}
