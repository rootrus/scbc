...
import p040o.exactMatchFound;
import p040o.setupDialog;

/* renamed from: o.writeByte */
public final /* synthetic */ class writeByte implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ EBillSubscriptionBillerListFragment.IconCompatParcelizer MediaBrowserCompat$ItemReceiver;

    public /* synthetic */ writeByte(EBillSubscriptionBillerListFragment.IconCompatParcelizer iconCompatParcelizer) {
        this.MediaBrowserCompat$ItemReceiver = iconCompatParcelizer;
    }

    public final Object write(Object obj) {
        AccountTransferClient.zzc zzc = this.MediaBrowserCompat$ItemReceiver.write;
        show show = new show(((LottieCompositionFactory) obj).MediaBrowserCompat$ItemReceiver);
        return DebitCardResetOtpActivity.just((List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new exactMatchFound.read(zzc))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
