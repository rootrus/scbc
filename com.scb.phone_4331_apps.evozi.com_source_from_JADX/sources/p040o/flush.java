...
/* renamed from: o.flush */
public final /* synthetic */ class flush implements DirectDebitDeepLinkActivity {
    public static final /* synthetic */ flush MediaBrowserCompat$ItemReceiver = new flush();

    private /* synthetic */ flush() {
    }

    public final Object write(Object obj) {
        show show = new show(((zzvf) obj).MediaBrowserCompat$ItemReceiver);
        Scope scope = Scope.read;
        ArrayList arrayList = new ArrayList();
        arrayList.addAll((List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, scope)).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
