...
/* renamed from: o.zzav */
public final class zzav extends FragmentBuilder_BindSummaryFragment {
    public final getLastLocation read(getPerformanceTracker getperformancetracker) {
        getLastLocation write = getLastLocation.write();
        write.MediaBrowserCompat$ItemReceiver = getperformancetracker.read;
        write.MediaBrowserCompat$CustomActionResultReceiver = getperformancetracker.write;
        write.write = getperformancetracker.MediaBrowserCompat$CustomActionResultReceiver;
        show show = new show(getperformancetracker.IconCompatParcelizer);
        write.read = (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new Iterables.C35306.IconCompatParcelizer(this))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
