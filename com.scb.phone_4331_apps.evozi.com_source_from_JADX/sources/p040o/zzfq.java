...
/* renamed from: o.zzfq */
public final /* synthetic */ class zzfq implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ blockingConnect IconCompatParcelizer;

    public /* synthetic */ zzfq(blockingConnect blockingconnect) {
        this.IconCompatParcelizer = blockingconnect;
    }

    public final Object write(Object obj) {
        blockingConnect blockingconnect = this.IconCompatParcelizer;
        setInstance setinstance = (setInstance) obj;
        if (setinstance == null || setinstance.read == null) {
            return null;
        }
        show show = new show(setinstance.read);
        show show2 = new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new nativeIsTargetRectangleFilled.IconCompatParcelizer(blockingconnect)));
        return (List) new show(show2.write, new getTag(show2.IconCompatParcelizer, setCancelable.write(getMessage.MediaBrowserCompat$CustomActionResultReceiver))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
