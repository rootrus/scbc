...
/* renamed from: o.safeGet */
public final class safeGet {
    public final checkElement read(chain chain, normalize normalize) {
        String str;
        List list;
        String str2 = normalize.MediaBrowserCompat$MediaItem;
        if (!(str2 == null || str2.length() == 0)) {
            str = normalize.MediaBrowserCompat$MediaItem;
        } else {
            str = normalize.setContentView;
        }
        String str3 = str;
        String str4 = normalize.MediaSessionCompat$ResultReceiverWrapper;
        List<FirebaseException> list2 = normalize.PlaybackStateCompat;
        if (list2 != null) {
            show show = new show(list2);
            list = (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new newHashMapWithExpectedSize(this))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        return new checkElement(chain.MediaDescriptionCompat, str3, str4, list, normalize.MediaMetadataCompat);
    }
}
