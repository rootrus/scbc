...
/* renamed from: o.newRttiExceptionResponseDeserializer */
public final /* synthetic */ class newRttiExceptionResponseDeserializer implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ RttiBillExtractor MediaBrowserCompat$ItemReceiver;

    public /* synthetic */ newRttiExceptionResponseDeserializer(RttiBillExtractor rttiBillExtractor) {
        this.MediaBrowserCompat$ItemReceiver = rttiBillExtractor;
    }

    public final Object write(Object obj) {
        RttiBillExtractor rttiBillExtractor = this.MediaBrowserCompat$ItemReceiver;
        show show = new show((List) obj);
        return (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new BillExtractActivity_MembersInjector(rttiBillExtractor))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
