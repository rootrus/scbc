...
/* renamed from: o.UTCStringToDate */
public final /* synthetic */ class UTCStringToDate implements writeUInt64NoTag.IconCompatParcelizer {
    private final /* synthetic */ setDomain read;

    public /* synthetic */ UTCStringToDate(setDomain setdomain) {
        this.read = setdomain;
    }

    public final void IconCompatParcelizer(Object obj) {
        setDomain setdomain = this.read;
        ExtractionParameters_Factory extractionParameters_Factory = (ExtractionParameters_Factory) obj;
        show show = new show(setdomain.MediaSessionCompat$QueueItem.IconCompatParcelizer);
        extractionParameters_Factory.IconCompatParcelizer((List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, getMin.MediaBrowserCompat$ItemReceiver)).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        })), setdomain.MediaSessionCompat$QueueItem.IconCompatParcelizer.indexOf(setdomain.MediaSessionCompat$QueueItem.write));
        if (setdomain.MediaSessionCompat$QueueItem.read != null) {
            show show2 = new show(setdomain.MediaSessionCompat$QueueItem.read);
            extractionParameters_Factory.read((List) new show(show2.write, new getSharedElementEnterTransition(show2.IconCompatParcelizer, getMin.MediaBrowserCompat$ItemReceiver)).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
                /*  JADX ERROR: Method generation error
                    jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: o.setupDialog.1.read():java.lang.Object, class status: UNLOADED
                    	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                    	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
...
*/
            })), setdomain.MediaSessionCompat$QueueItem.read.indexOf(setdomain.MediaSessionCompat$QueueItem.MediaBrowserCompat$CustomActionResultReceiver));
        }
        extractionParameters_Factory.setChecked();
        extractionParameters_Factory.MediaBrowserCompat$ItemReceiver();
        setdomain.write(new setDomain.write());
    }
}
