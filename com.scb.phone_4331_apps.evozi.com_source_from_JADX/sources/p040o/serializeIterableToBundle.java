...
/* renamed from: o.serializeIterableToBundle */
public final /* synthetic */ class serializeIterableToBundle implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ ActivityBuilder_ContributeECouponRedemptionDetailActivity.IconCompatParcelizer write;

    public /* synthetic */ serializeIterableToBundle(ActivityBuilder_ContributeECouponRedemptionDetailActivity.IconCompatParcelizer iconCompatParcelizer) {
        this.write = iconCompatParcelizer;
    }

    public final Object write(Object obj) {
        getChimeraLifecycleFragmentImpl getchimeralifecyclefragmentimpl = this.write.read;
        KeyPathElementContent keyPathElementContent = ((addPaths) ((SingleDataEntity) obj).getData()).MediaBrowserCompat$ItemReceiver;
        StreetViewPanorama.OnStreetViewPanoramaClickListener onStreetViewPanoramaClickListener = new StreetViewPanorama.OnStreetViewPanoramaClickListener();
        onStreetViewPanoramaClickListener.read = keyPathElementContent.MediaBrowserCompat$CustomActionResultReceiver;
        onStreetViewPanoramaClickListener.MediaBrowserCompat$ItemReceiver = keyPathElementContent.IconCompatParcelizer;
        show show = new show(keyPathElementContent.write);
        onStreetViewPanoramaClickListener.write = (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new C3324xa2fb9101(getchimeralifecyclefragmentimpl))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        return DebitCardResetOtpActivity.just(onStreetViewPanoramaClickListener);
    }
}
