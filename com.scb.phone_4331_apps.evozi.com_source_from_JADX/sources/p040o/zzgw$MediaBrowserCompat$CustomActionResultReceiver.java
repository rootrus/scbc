...
import p040o.Tables;
import p040o.setConditionalUserProperty;
import p040o.setupDialog;

/* renamed from: o.zzgw$MediaBrowserCompat$CustomActionResultReceiver */
final class zzgw$MediaBrowserCompat$CustomActionResultReceiver<T, R> implements DirectDebitDeepLinkActivity<T, R> {
    private /* synthetic */ zzgw MediaBrowserCompat$CustomActionResultReceiver;

    zzgw$MediaBrowserCompat$CustomActionResultReceiver(zzgw zzgw) {
        this.MediaBrowserCompat$CustomActionResultReceiver = zzgw;
    }

    public final /* synthetic */ Object write(Object obj) {
        SingleDataEntity singleDataEntity = (SingleDataEntity) obj;
        onGetStartedClick.write((Object) singleDataEntity, "it");
        setProfilePictureUri setprofilepictureuri = this.MediaBrowserCompat$CustomActionResultReceiver.write;
        setConditionalUserProperty.IconCompatParcelizer iconCompatParcelizer = new setConditionalUserProperty.IconCompatParcelizer();
        show show = new show(((LottieLogger) singleDataEntity.getData()).MediaBrowserCompat$ItemReceiver);
        List<? extends getUserProperties> list = (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new Tables.TransposeTable.C38381.IconCompatParcelizer(setprofilepictureuri))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        onGetStartedClick.write((Object) list, "easycashLoanOffers");
        iconCompatParcelizer.MediaBrowserCompat$ItemReceiver = list;
        return new setConditionalUserProperty(iconCompatParcelizer);
    }
}
