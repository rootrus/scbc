...
/* renamed from: o.zzgm */
public final /* synthetic */ class zzgm implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ zzai MediaBrowserCompat$CustomActionResultReceiver;

    public /* synthetic */ zzgm(zzai zzai) {
        this.MediaBrowserCompat$CustomActionResultReceiver = zzai;
    }

    public final Object write(Object obj) {
        zzai zzai = this.MediaBrowserCompat$CustomActionResultReceiver;
        LottieAnimationView lottieAnimationView = (LottieAnimationView) obj;
        show show = new show(lottieAnimationView.IconCompatParcelizer);
        getOnlyElement getonlyelement = new getOnlyElement(zzai);
        setCompositionTask setcompositiontask = lottieAnimationView.MediaBrowserCompat$CustomActionResultReceiver;
        zzrc.zzb zzb = new zzrc.zzb();
        zzb.MediaBrowserCompat$ItemReceiver = setcompositiontask.IconCompatParcelizer;
        zzb.read = setcompositiontask.MediaBrowserCompat$ItemReceiver;
        zzb.MediaBrowserCompat$CustomActionResultReceiver = setcompositiontask.MediaBrowserCompat$CustomActionResultReceiver;
        zzb.write = setcompositiontask.write;
        zzb.IconCompatParcelizer = setcompositiontask.read;
        return new zzrc.zze((List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, getonlyelement)).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
