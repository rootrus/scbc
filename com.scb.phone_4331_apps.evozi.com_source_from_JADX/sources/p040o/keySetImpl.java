...
/* renamed from: o.keySetImpl */
public final class keySetImpl extends SignedBytes.LexicographicalComparator {
    @HmlPinActivity
    public keySetImpl(Resources resources, SharedPreferences sharedPreferences, @HmlRepaymentMethodAboutActivity(MediaBrowserCompat$ItemReceiver = "baseAssetsURL") String str) {
        super(resources, sharedPreferences, str);
    }

    public List<UncaughtExceptionHandlers> write(List<UncaughtExceptionHandlers> list, List<zzxp> list2) {
        show show = new show(list);
        privateValueEquivalence privatevalueequivalence = new privateValueEquivalence(this, list2);
        while (show.IconCompatParcelizer.hasNext()) {
            privatevalueequivalence.MediaBrowserCompat$ItemReceiver(show.IconCompatParcelizer.next());
        }
        return list;
    }

    public List<UncaughtExceptionHandlers> MediaBrowserCompat$ItemReceiver(List<FundSwitchLandingActivity> list, boolean z) {
        show show = new show(list);
        show show2 = new show(show.write, new getTag(show.IconCompatParcelizer, setCancelable.write(setValueStrength.read)));
        return (List) new show(show2.write, new getSharedElementEnterTransition(show2.IconCompatParcelizer, new findFragmentByWho(z) {
            private final /* synthetic */ boolean read;

            public final java.lang.Object IconCompatParcelizer(
/*
Method generation error in method: o.MapMaker.2.IconCompatParcelizer(java.lang.Object):java.lang.Object, dex: classes2.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: o.MapMaker.2.IconCompatParcelizer(java.lang.Object):java.lang.Object, class status: UNLOADED
