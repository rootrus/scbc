...
/* renamed from: o.getMaxNumFocusAreas */
public final /* synthetic */ class getMaxNumFocusAreas implements writeUInt64NoTag.IconCompatParcelizer {
    private final /* synthetic */ C4128bz.write read;

    public /* synthetic */ getMaxNumFocusAreas(C4128bz.write write) {
        this.read = write;
    }

    public final void IconCompatParcelizer(Object obj) {
        C4128bz.write write = this.read;
        show show = new show(C4128bz.this.write);
        show show2 = new show(show.write, new getTag(show.IconCompatParcelizer, new getPictureFormat(write)));
        ((getFrontImage) obj).IconCompatParcelizer((List<String>) (List) new show(show2.write, new getSharedElementEnterTransition(show2.IconCompatParcelizer, C4113bt.write)).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
