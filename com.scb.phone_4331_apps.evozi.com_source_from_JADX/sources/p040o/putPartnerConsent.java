...
import com.scb.phone.view.custom.common.C5806x52de8268;
import com.scb.phone.view.fragment.bond.BondInputFragment;
import java.util.List;
import p040o.setupDialog;

/* renamed from: o.putPartnerConsent */
public final /* synthetic */ class putPartnerConsent implements C5806x52de8268 {
    private final /* synthetic */ BondInputFragment IconCompatParcelizer;

    public /* synthetic */ putPartnerConsent(BondInputFragment bondInputFragment) {
        this.IconCompatParcelizer = bondInputFragment;
    }

    public final void IconCompatParcelizer() {
        DefaultHeartBeatInfo defaultHeartBeatInfo = this.IconCompatParcelizer.presenter;
        show show = new show(defaultHeartBeatInfo.MediaBrowserCompat$SearchResultReceiver);
        List list = (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, Subscriber.MediaBrowserCompat$ItemReceiver)).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        ValueEncoder valueEncoder = new ValueEncoder(defaultHeartBeatInfo, list, new String[list.size()]);
        if (defaultHeartBeatInfo.RatingCompat != null) {
            valueEncoder.IconCompatParcelizer(defaultHeartBeatInfo.RatingCompat);
        }
    }
}
