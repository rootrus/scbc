...
/* renamed from: o.zak */
public final class zak extends FragmentBuilder_BindSummaryFragment {
    public final List<EasycashHeaderAdapter$LoanHeaderViewHolder> write(Response<SingleDataEntity<addWarning>> response, count$MediaBrowserCompat$CustomActionResultReceiver count_mediabrowsercompat_customactionresultreceiver) {
    ...
    public final List<EasycashHeaderAdapter$LoanHeaderViewHolder> write(SingleDataEntity<addWarning> singleDataEntity) {
        if (singleDataEntity.getData() == null || singleDataEntity.getData().MediaBrowserCompat$ItemReceiver == null) {
            return Collections.emptyList();
        }
        show show = new show(singleDataEntity.getData().MediaBrowserCompat$ItemReceiver);
        return (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new isGuidanceAvailable.write(this))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
