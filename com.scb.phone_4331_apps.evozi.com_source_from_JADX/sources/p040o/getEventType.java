...
/* renamed from: o.getEventType */
public final /* synthetic */ class getEventType implements DirectDebitDeepLinkActivity {
    ...
    public /* synthetic */ getEventType(FragmentBuilder_BindDeejungTransferMinMaxReviewFragment fragmentBuilder_BindDeejungTransferMinMaxReviewFragment) {
        this.MediaBrowserCompat$CustomActionResultReceiver = fragmentBuilder_BindDeejungTransferMinMaxReviewFragment;
    }

    public final Object write(Object obj) {
        ScaleXYParser scaleXYParser = (ScaleXYParser) obj;
        SignInButton.ColorScheme colorScheme = this.MediaBrowserCompat$CustomActionResultReceiver.MediaBrowserCompat$CustomActionResultReceiver;
        zzvt read = zzvt.read();
        read.RatingCompat = scaleXYParser.MediaBrowserCompat$SearchResultReceiver;
        FragmentBuilder_BindSummaryFragment.write(scaleXYParser.MediaBrowserCompat$ItemReceiver, (OffsetDateTime) null);
        read.MediaBrowserCompat$CustomActionResultReceiver = scaleXYParser.IconCompatParcelizer;
        read.MediaBrowserCompat$ItemReceiver = DiskLruCache.VERSION_1.equals(scaleXYParser.read);
        show show = new show(scaleXYParser.MediaBrowserCompat$CustomActionResultReceiver);
        read.write = (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new FirebaseInstanceId.IconCompatParcelizer(colorScheme))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
