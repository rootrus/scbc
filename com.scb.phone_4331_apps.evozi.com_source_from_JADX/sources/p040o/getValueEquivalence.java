...
/* renamed from: o.getValueEquivalence */
public final class getValueEquivalence extends constrainedSetMultimap<zzxc.zzd, Service> {
    private final getTicker IconCompatParcelizer;

    @HmlPinActivity
    public getValueEquivalence(Resources resources, SharedPreferences sharedPreferences, getTicker getticker) {
        super(resources, sharedPreferences);
        this.IconCompatParcelizer = getticker;
    }

    /* renamed from: read */
    public final Service MediaBrowserCompat$ItemReceiver(zzxc.zzd zzd) {
        show show = new show(zzd.write);
        show show2 = new show(show.write, new getTag(show.IconCompatParcelizer, setCancelable.write(makeCache.read)));
        return new Service((List) new show(show2.write, new getSharedElementEnterTransition(show2.IconCompatParcelizer, new getEvictionListener(this.IconCompatParcelizer))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        })), zzd.read, zzd.IconCompatParcelizer);
    }
}
