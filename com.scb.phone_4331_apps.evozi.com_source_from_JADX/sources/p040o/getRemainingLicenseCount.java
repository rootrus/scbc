...
/* renamed from: o.getRemainingLicenseCount */
public final /* synthetic */ class getRemainingLicenseCount implements writeUInt64NoTag.IconCompatParcelizer {
    private final /* synthetic */ C10829Sizeof.C37931 read;

    public /* synthetic */ getRemainingLicenseCount(C10829Sizeof.C37931 r1) {
        this.read = r1;
    }

    public final void IconCompatParcelizer(Object obj) {
        C10829Sizeof.C37931 r0 = this.read;
        getPayee getpayee = (getPayee) obj;
        r0.IconCompatParcelizer = (List) new show(r0.IconCompatParcelizer).read(setMobileSDKLicenseServer.IconCompatParcelizer).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        licenseOperationSucceeded licenseoperationsucceeded = new licenseOperationSucceeded(r0);
        if (r0.RatingCompat != null) {
            licenseoperationsucceeded.IconCompatParcelizer(r0.RatingCompat);
        }
