...
/* renamed from: o.isInRange */
public final /* synthetic */ class isInRange implements setDefaultBorder {
    private final /* synthetic */ MwSearchMarketMallActivity MediaBrowserCompat$CustomActionResultReceiver;

    public /* synthetic */ isInRange(MwSearchMarketMallActivity mwSearchMarketMallActivity) {
        this.MediaBrowserCompat$CustomActionResultReceiver = mwSearchMarketMallActivity;
    }

    public final void MediaBrowserCompat$ItemReceiver(Object obj) {
        MwSearchMarketMallActivity mwSearchMarketMallActivity = this.MediaBrowserCompat$CustomActionResultReceiver;
        String str = (String) obj;
        TaskRunner.C3841a aVar = mwSearchMarketMallActivity.presenter;
        Iterable iterable = mwSearchMarketMallActivity.MediaDescriptionCompat;
        Resources resources = mwSearchMarketMallActivity.getResources();
        if (iterable == null) {
            iterable = new ArrayList();
        }
        show show = new show(iterable);
        List list = (List) new show(show.write, new getNextTransition(show.IconCompatParcelizer, new setFieldname(str))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        if (list.isEmpty()) {
            AutoCrashlyticsReportEncoder.CrashlyticsReportFilesPayloadEncoder crashlyticsReportFilesPayloadEncoder = r5;
            AutoCrashlyticsReportEncoder.CrashlyticsReportFilesPayloadEncoder crashlyticsReportFilesPayloadEncoder2 = new AutoCrashlyticsReportEncoder.CrashlyticsReportFilesPayloadEncoder("", "MD99999", 0, "", "", resources.getString(Iterables$3$MediaBrowserCompat$MediaItem.mw_shop_address_other), "", "", "", "", "");
            list.add(crashlyticsReportFilesPayloadEncoder);
        }
        getSessionEventID getsessioneventid = new getSessionEventID(list);
        if (aVar.RatingCompat != null) {
            getsessioneventid.IconCompatParcelizer(aVar.RatingCompat);
        }
    }
}
