...
import com.scb.phone.view.activity.prepaid.PrepaidTravelCoachMarkActivity$MediaBrowserCompat$ItemReceiver;
import com.scb.phone.view.fragment.hml.C5995xd770688e;
import java.util.List;
import p040o.setupDialog;

/* renamed from: o.writeTypedSparseArray */
public final /* synthetic */ class writeTypedSparseArray implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ C5995xd770688e read;

    public /* synthetic */ writeTypedSparseArray(C5995xd770688e hmlNTBDocumentUploadFragment$MediaBrowserCompat$CustomActionResultReceiver) {
        this.read = hmlNTBDocumentUploadFragment$MediaBrowserCompat$CustomActionResultReceiver;
    }

    public final Object write(Object obj) {
        C5995xd770688e hmlNTBDocumentUploadFragment$MediaBrowserCompat$CustomActionResultReceiver = this.read;
        show show = new show(((BaseLottieAnimator) obj).MediaBrowserCompat$ItemReceiver);
        return (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new PrepaidTravelCoachMarkActivity$MediaBrowserCompat$ItemReceiver(hmlNTBDocumentUploadFragment$MediaBrowserCompat$CustomActionResultReceiver.write))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
