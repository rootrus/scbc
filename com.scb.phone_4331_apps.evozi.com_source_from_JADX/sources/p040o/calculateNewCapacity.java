...
/* renamed from: o.calculateNewCapacity */
public final class calculateNewCapacity extends MapConstraints.C36312.C36321 {
    private final String MediaBrowserCompat$ItemReceiver;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    @HmlPinActivity
    public calculateNewCapacity(Resources resources, SharedPreferences sharedPreferences, @HmlRepaymentMethodAboutActivity(MediaBrowserCompat$ItemReceiver = "baseAssetsURL") String str) {
...
*/
    ...
    public final List<ForwardingFuture> write(setOfProvider setofprovider) {
        String str;
        String str2;
        String str3;
        String str4;
        ...
        this.read.clear();
        boolean MediaBrowserCompat$CustomActionResultReceiver = GoodToKnowActivity.MediaBrowserCompat$CustomActionResultReceiver(setofprovider.RatingCompat, CrashlyticsReportJsonTransform$$Lambda$9.CREDIT_CARD_INSTALLMENT_PAYMENT_PLAN.code, false);
        ...
        String str7 = null;
        if (r3 != null) {
            str = r3.MediaBrowserCompat$ItemReceiver;
        } else {
            str = null;
        }
        ...
        if (r32 != null) {
            str2 = r32.MediaBrowserCompat$CustomActionResultReceiver;
        } else {
            str2 = null;
        }
        ComponentDiscovery.C31871 r5 = setofprovider.MediaBrowserCompat$SearchResultReceiver;
        if (r5 != null) {
            str3 = r5.read;
        } else {
            str3 = null;
        ...
        ComponentDiscovery.C31871 r52 = setofprovider.MediaBrowserCompat$SearchResultReceiver;
        if (r52 != null) {
            str4 = r52.IconCompatParcelizer;
        } else {
            str4 = null;
        }
        iconCompatParcelizer2.MediaBrowserCompat$ItemReceiver = write(str4, Iterables$3$MediaBrowserCompat$ItemReceiver.ic_bill_credit_card);
        ...
        if (forcontext3 != null) {
            str7 = forcontext3.write;
        }
        iconCompatParcelizer4.MediaBrowserCompat$ItemReceiver = write(str7, Iterables$3$MediaBrowserCompat$ItemReceiver.biller_place_holder);
        ...
        read2.MediaMetadataCompat = write(setofprovider.IconCompatParcelizer);
        read(read2.read());
        if (MediaBrowserCompat$CustomActionResultReceiver && (registrarNameRetriever = setofprovider.read) != null) {
            ...
            MediaBrowserCompat$ItemReceiver2.ParcelableVolumeInfo = true;
            ...
            IconCompatParcelizer((ForwardingFuture) MediaBrowserCompat$ItemReceiver3.read(), false);
        ...
        if (setofprovider.MediaBrowserCompat$CustomActionResultReceiver != null) {
            ...
            MediaBrowserCompat$CustomActionResultReceiver2.MediaMetadataCompat = this.MediaBrowserCompat$CustomActionResultReceiver.getString(Iterables$3$MediaBrowserCompat$MediaItem.auto_ccsof_review_email);
            MediaBrowserCompat$CustomActionResultReceiver2.MediaSessionCompat$Token = true;
            MediaBrowserCompat$CustomActionResultReceiver2.MediaBrowserCompat$ItemReceiver = setofprovider.MediaBrowserCompat$CustomActionResultReceiver;
            read(new capFileCount(MediaBrowserCompat$CustomActionResultReceiver2, (byte) 0));
        }
        if (setofprovider.MediaBrowserCompat$MediaItem != null) {
            ...
            MediaBrowserCompat$CustomActionResultReceiver3.MediaMetadataCompat = this.MediaBrowserCompat$CustomActionResultReceiver.getString(Iterables$3$MediaBrowserCompat$MediaItem.purchase_remark);
            MediaBrowserCompat$CustomActionResultReceiver3.MediaSessionCompat$Token = true;
            MediaBrowserCompat$CustomActionResultReceiver3.MediaBrowserCompat$ItemReceiver = setofprovider.MediaBrowserCompat$MediaItem;
            read(new capFileCount(MediaBrowserCompat$CustomActionResultReceiver3, (byte) 0));
        }
        if (setofprovider.MediaMetadataCompat != null) {
            ...
            MediaBrowserCompat$CustomActionResultReceiver4.MediaMetadataCompat = this.MediaBrowserCompat$CustomActionResultReceiver.getString(Iterables$3$MediaBrowserCompat$MediaItem.prepaid_cash_out_note);
            MediaBrowserCompat$CustomActionResultReceiver4.MediaSessionCompat$Token = true;
            MediaBrowserCompat$CustomActionResultReceiver4.MediaBrowserCompat$ItemReceiver = setofprovider.MediaMetadataCompat;
            MediaBrowserCompat$CustomActionResultReceiver(new capFileCount(MediaBrowserCompat$CustomActionResultReceiver4, (byte) 0));
        }
    ...
    private final String write(String str, int i) {
        String str2;
        ...
        return charSequence == null || charSequence.length() == 0 ? str2 : MediaBrowserCompat$CustomActionResultReceiver;
    }
}
