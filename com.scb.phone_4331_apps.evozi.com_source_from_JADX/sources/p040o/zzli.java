...
/* renamed from: o.zzli */
public final /* synthetic */ class zzli implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ Suppliers.SupplierOfInstance.write IconCompatParcelizer;

    public /* synthetic */ zzli(Suppliers.SupplierOfInstance.write write) {
        this.IconCompatParcelizer = write;
    }

    public final Object write(Object obj) {
        Suppliers.SupplierOfInstance.write write = this.IconCompatParcelizer;
        show show = new show((List) obj);
        return (List) new show(show.write, new getNextTransition(show.IconCompatParcelizer, new ContactUsActivity$MediaBrowserCompat$CustomActionResultReceiver(write))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
