...
/* renamed from: o.warn */
public final class warn extends FragmentBuilder_BindSummaryFragment {
    public final List<FundSwitchLandingActivity> read(List<C1316fragment> list) {
        show show = new show(list);
        return (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new checkElementNotNull$MediaBrowserCompat$ItemReceiver(this))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
