...
/* renamed from: o.forFloat */
public final /* synthetic */ class forFloat implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ C6150x69d72700 MediaBrowserCompat$ItemReceiver;
    private final /* synthetic */ String read;

    public /* synthetic */ forFloat(C6150x69d72700 remittanceCountrySelectionFragment$MediaBrowserCompat$ItemReceiver, String str) {
    ...
    public final Object write(Object obj) {
        ...
        hasResolution hasresolution = remittanceCountrySelectionFragment$MediaBrowserCompat$ItemReceiver.MediaBrowserCompat$SearchResultReceiver;
        getInOutKeyframes getinoutkeyframes = (getInOutKeyframes) ((SingleDataEntity) obj).getData();
        if (getinoutkeyframes.MediaBrowserCompat$CustomActionResultReceiver != null) {
            list = getinoutkeyframes.MediaBrowserCompat$CustomActionResultReceiver;
        } else {
            list = new ArrayList();
        }
        if (!TextUtils.isEmpty(str)) {
            show show = new show(list);
            list = (List) new show(show.write, new getNextTransition(show.IconCompatParcelizer, new setLogFile$MediaBrowserCompat$CustomActionResultReceiver(str))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        getlatlng.IconCompatParcelizer = hasresolution.MediaBrowserCompat$CustomActionResultReceiver(list, "PURCHASED");
        getlatlng.read = hasresolution.MediaBrowserCompat$CustomActionResultReceiver(list, "IPO");
        getlatlng.MediaBrowserCompat$CustomActionResultReceiver = hasresolution.MediaBrowserCompat$CustomActionResultReceiver(list, "OTHERS");
        getlatlng.write = hasresolution.MediaBrowserCompat$CustomActionResultReceiver(list, "SSF");
        return DebitCardResetOtpActivity.just(getlatlng);
    }
}
