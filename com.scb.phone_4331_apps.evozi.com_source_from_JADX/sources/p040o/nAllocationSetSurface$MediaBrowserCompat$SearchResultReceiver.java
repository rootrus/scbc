...
/* renamed from: o.nAllocationSetSurface$MediaBrowserCompat$SearchResultReceiver */
public final class nAllocationSetSurface$MediaBrowserCompat$SearchResultReceiver implements getCarbonStrip {
    ...
    public static final int f2606xb44864b4 = 2131821190;
    ...
    public static final int f2607xc85a02f4 = 2131821192;
    ...
    private static void write(copy1DRangeFromUnchecked copy1drangefromunchecked, getSubElementOffsetBytes getsubelementoffsetbytes) {
        createUser createuser = new createUser();
        getsubelementoffsetbytes.IconCompatParcelizer.add(createuser);
        while (true) {
            try {
                ...
                if (RatingCompat != 0) {
                    ...
                    if (RatingCompat != 1) {
                        if (RatingCompat == 2 || RatingCompat == 3) {
                            copy1drangefromunchecked.write(4);
                            createuser.IconCompatParcelizer(RatingCompat, new createFromBitmap(copy1drangefromunchecked.IconCompatParcelizer(RatingCompat2 - 4), setViewCacheExtension.MediaBrowserCompat$ItemReceiver));
                        } else {
                            createuser.MediaBrowserCompat$ItemReceiver(RatingCompat, copy1drangefromunchecked.IconCompatParcelizer(RatingCompat2));
                        }
                    } else if (RatingCompat2 != 4) {
                        createuser.IconCompatParcelizer.add("Unexpected length for the quality tag");
                        return;
                    } else {
                        createuser.IconCompatParcelizer(RatingCompat, Integer.valueOf(copy1drangefromunchecked.MediaBrowserCompat$CustomActionResultReceiver()));
                    }
                } else {
                    return;
                }
            } catch (IOException e) {
                createuser.IconCompatParcelizer.add(e.getMessage());
                return;
            }
        }
    }
    ...
    public final Iterable<setItemAnimator> MediaBrowserCompat$ItemReceiver() {
        return Collections.singletonList(setItemAnimator.APPC);
    }
    ...
    public final void IconCompatParcelizer(Iterable<byte[]> iterable, getSubElementOffsetBytes getsubelementoffsetbytes, setItemAnimator setitemanimator) {
        for (byte[] next : iterable) {
            if (next.length >= 5 && "Ducky".equals(new String(next, 0, 5))) {
                write(new copyTo(next, 5), getsubelementoffsetbytes);
            }
        }
    }
}
