...
/* renamed from: o.rsnAllocationResize1D */
public final class rsnAllocationResize1D extends rsnAllocationResize2D {
    ...
    public rsnAllocationResize1D(String str) {
    ...
    public final int write(CharSequence charSequence, int i, int i2) {
        while (i < i2) {
    ...
    public final char[] read(int i) {
        ...
        if (i <= 127) {
            ...
            cArr3[0] = '%';
            cArr3[3] = '%';
            char[] cArr4 = MediaBrowserCompat$CustomActionResultReceiver;
            cArr3[5] = cArr4[i & 15];
            int i2 = i >>> 4;
            ...
            cArr5[3] = '%';
            cArr5[6] = '%';
            char[] cArr6 = MediaBrowserCompat$CustomActionResultReceiver;
            cArr5[8] = cArr6[i & 15];
            int i4 = i >>> 4;
            ...
            cArr7[6] = '%';
            cArr7[9] = '%';
            char[] cArr8 = MediaBrowserCompat$CustomActionResultReceiver;
            cArr7[11] = cArr8[i & 15];
            int i7 = i >>> 4;
