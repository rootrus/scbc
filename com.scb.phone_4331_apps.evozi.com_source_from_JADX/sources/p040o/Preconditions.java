...
/* renamed from: o.Preconditions */
public final /* synthetic */ class Preconditions implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ getAccountName IconCompatParcelizer;

    public /* synthetic */ Preconditions(getAccountName getaccountname) {
        this.IconCompatParcelizer = getaccountname;
    }

    public final Object write(Object obj) {
        getAccountName getaccountname = this.IconCompatParcelizer;
        getRepeatCount getrepeatcount = (getRepeatCount) obj;
        onLocationResult onlocationresult = new onLocationResult();
        show show = new show(getrepeatcount.read);
        onlocationresult.write = (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, new Maps.AbstractFilteredMap.Values.IconCompatParcelizer(getaccountname))).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
...
*/
        ...
        onlocationresult.IconCompatParcelizer = getrepeatcount.write;
        onlocationresult.MediaBrowserCompat$CustomActionResultReceiver = getrepeatcount.MediaBrowserCompat$ItemReceiver;
