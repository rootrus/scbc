...
/* renamed from: o.RemoteCreator */
public final /* synthetic */ class RemoteCreator implements DirectDebitDeepLinkActivity {
    private final /* synthetic */ AccountTransferClient.zzb MediaBrowserCompat$CustomActionResultReceiver;

    /* renamed from: o.RemoteCreator$RemoteCreatorException */
    public final /* synthetic */ class RemoteCreatorException implements DirectDebitDeepLinkActivity {
        public static final /* synthetic */ RemoteCreatorException write = new RemoteCreatorException();

        private /* synthetic */ RemoteCreatorException() {
        }

        public final Object write(Object obj) {
            return (LinkedHashTreeMap.AvlIterator) ((SingleDataEntity) obj).getData();
        }
    }

    public /* synthetic */ RemoteCreator(AccountTransferClient.zzb zzb) {
        this.MediaBrowserCompat$CustomActionResultReceiver = zzb;
    }

    public final Object write(Object obj) {
        AccountTransferClient.zzb zzb = this.MediaBrowserCompat$CustomActionResultReceiver;
        show show = new show(((C9877cache) obj).write);
        invert.read read = new invert.read(zzb);
        getStrokeJointType getstrokejointtype = new getStrokeJointType();
        getstrokejointtype.MediaBrowserCompat$ItemReceiver = (List) new show(show.write, new getSharedElementEnterTransition(show.IconCompatParcelizer, read)).write(new setupDialog.IconCompatParcelizer(new getArguments<List<T>>() {
